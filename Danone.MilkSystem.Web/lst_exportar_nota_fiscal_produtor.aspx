<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_nota_fiscal_produtor.aspx.vb" Inherits="lst_exportar_nota_fiscal_produtor" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Nota Fiscal Produtor</STRONG></TD>
					...
					<TD id="td_pesquisa" runat="server" style="height: 133px"><BR>
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD style="height: 25px; width: 439px;"></TD>
