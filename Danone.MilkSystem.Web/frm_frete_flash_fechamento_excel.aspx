<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_frete_flash_fechamento_excel.aspx.vb" Inherits="frm_frete_flash_fechamento_excel" %>
           ...
           <anthem:GridView id="gridResults" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="nr_veiculos_custo_mes" HeaderText="Nr.Ve&#237;culos C.Fixo M&#234;s" DataFormatString="{0:N0}" >
                                 ...
                                 <asp:BoundField DataField="nr_total_custo_rota_tipo" HeaderText="Total Custo Rota/TipoFrete/Placa" DataFormatString="{0:N2}" >
                                    <headerstyle horizontalalign="Center" />
                                    <itemstyle horizontalalign="Right" />
                                </asp:BoundField>
...
<asp:Label id="lbl_seq" runat="server" Text='<%# Bind("seq") %>' __designer:wfdid="w84"></asp:Label>
        ...
        <anthem:GridView id="gridDivergencia" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nr_valor_pedagio_eixo" HeaderText="ValorPed&#225;gioPorEixo" DataFormatString="{0:N2}" >
                    <headerstyle horizontalalign="Center" />
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>
