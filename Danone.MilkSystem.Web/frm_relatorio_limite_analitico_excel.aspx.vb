...
Imports System.Data
Imports System.Math
Partial Class frm_relatorio_limite_analitico_excel
        ...
        Try
            ...
            If Not (Request("dt_referencia") Is Nothing) Then
                ...
                If (dsRelSaldoDisponivel.Tables(0).Rows.Count > 0) Then
                    ...
                    gridResults.DataSource = Helper.getDataView(dsRelSaldoDisponivel.Tables(0), ViewState.Item("sortExpression"))
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" & "MilkSystem_RelatorioLimiteAnalitico" & ".xls")
                        Response.Charset = ""
    ...
    Protected Sub gridResults_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridResults.RowDataBound
        Try
            ...
            Else  ' Se não está editando
                ...
                'e.Row.Cells(11).Text = (Convert.ToDecimal(e.Row.Cells(7).Text.Trim()) + Convert.ToDecimal(e.Row.Cells(8).Text.Trim()) + Convert.ToDecimal(e.Row.Cells(9).Text.Trim()) + Convert.ToDecimal(e.Row.Cells(10).Text.Trim()))
                ...
                '    End If
                'End If
                'If IsNumeric(e.Row.Cells(10).Text.Trim()) Then  ' Pedidos Abrtos
