<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_conferencia_romaneio_excel.aspx.vb" Inherits="frm_relatorio_conferencia_romaneio_excel" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Relatório Conferência de Romaneios</title>
</head>
    ...
    <div>
        ...
        <asp:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="volume_densidade" DataFormatString="{0:N0}" HeaderText="Volume(lts)" />
                <asp:BoundField DataField="nr_peso_liquido_caderneta" DataFormatString="{0:N0}"
                    HeaderText="Volume Caderneta (lts)" />
                <asp:BoundField DataField="nr_peso_liquido_nota" DataFormatString="{0:N0}" HeaderText="Volume NF (lts)" />
