										...
										<TR>
											<TD width="76%">
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <strong><span style="color: #ff0000">&nbsp;</span>Placa Veículo:</strong></td>
                                                        <td>
                                                            ...
                                                            <asp:CustomValidator ID="cmv_placa" runat="server" 
                                                                ErrorMessage="Placa não cadastrada." SetFocusOnError="True" ControlToValidate="txt_placa" CssClass="texto" Font-Bold="True" ValidationGroup="vg_salvar" Visible="False">[!]</asp:CustomValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" style="height: 15px" width="23%">
