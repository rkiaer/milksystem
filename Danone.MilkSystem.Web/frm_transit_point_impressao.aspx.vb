...
Partial Class frm_transit_point_impressao
    Inherits Page
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            If Not (Request("id_transit_point") Is Nothing) Then
                ViewState.Item("id_transit_point") = Request("id_transit_point")   ' Produtor
                loadData()
            Else
    ...
    Private Sub loadData()
        ...
        Try
            ...
            transitPoint.id_transit_point = Convert.ToInt32(ViewState.Item("id_transit_point"))

            Dim ds_tp As DataSet = transitPoint.getTransitPointByFilters
            Dim usuario As New Usuario(Session("id_login"))


            If ds_tp.Tables(0).Rows.Count > 0 Then
                With ds_tp.Tables(0).Rows(0)
                    Me.lbl_nr_transit_point.Text = ViewState.Item("id_transit_point").ToString
                    Me.lbl_transit_point_unidade.Text = .Item("ds_transit_point_unidade").ToString 'adri 28/12/2009 i chamado 594
            ...
            Dim ds_tpprodutor As DataSet = transitPoint.getTransitPointCompartimentoProdutores
