<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_gold_custo_produtor_aprovar_1N.aspx.vb" Inherits="lst_gold_custo_produtor_aprovar_1N" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Aprovação Custos Produtor GOLD 1.o Nível</title>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Custos Produtor Gold 1.o Nível</STRONG></TD>
				...
				<TR>
					...
					<TD class="faixafiltro1a" style="HEIGHT: 24px; width: 1014px;" vAlign="middle" background="img/faixa_filro.gif">
                        ...
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/icone_excluir.gif" /><anthem:LinkButton
                            ...
                            ValidationGroup="vg_pesquisar">Reprovar</anthem:LinkButton>&nbsp;&nbsp;<asp:Image id="img_novo" runat="server" ImageUrl="~/img/ico_email.gif"></asp:Image><anthem:LinkButton ID="lk_email" runat="server" ValidationGroup="vg_pesquisar" OnClientClick="if (confirm('Uma notificação de que existem Custos de Produtores GOLD aprovados em 1.o Nivel será enviada aos aprovadores para aprovação 2.o Nível. Deseja realmente prosseguir?' )) return true;else return false;" CssClass="texto" Enabled="False" AutoUpdateAfterCallBack="True">Notificar Aprovadores</anthem:LinkButton></TD>
					...
					<TD style="width: 1014px">
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <headertemplate>
&nbsp;<asp:CheckBox id="ck_header" runat="server" __designer:wfdid="w8" OnCheckedChanged="ck_header_CheckedChanged" AutoPostBack="True"></asp:CheckBox> 
</headertemplate>
                                    <itemtemplate>
&nbsp;<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w7" Checked='<%# bind("st_selecao") %>'></asp:CheckBox> 
</itemtemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="nr_taxa_crescimento_ano" HeaderText="Tx Cresc(%)" ReadOnly="True" />
                                <asp:BoundField DataField="nr_volume_planejado" HeaderText="Vl Plan (lts/dia)" ReadOnly="True" />
                                <asp:BoundField DataField="nr_taxa_vacas_lactacao" HeaderText="Vacas Lac(%)" ReadOnly="True" />
                                <asp:TemplateField HeaderText="Custo Total (R$)">
                                    <itemtemplate>
<asp:HyperLink id="lh_nr_custo_operacional_total" runat="server" ForeColor="Blue" __designer:wfdid="w5" Target="_blank" NavigateUrl='<%# Eval("id_gold_custo_produtor", "~/frm_gold_custo_produtor.aspx?id_gold_custo_produtor={0}") %>' Text='<%# Eval("nr_custo_operacional_total") %>'></asp:HyperLink>
</itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Dieta Total (R$)">
                                    <itemtemplate>
<asp:HyperLink id="hl_nr_custo_dieta_total" runat="server" ForeColor="Blue" __designer:wfdid="w6" Target="_blank" NavigateUrl='<%# Eval("id_gold_custo_produtor", "~/frm_gold_custo_produtor_dieta.aspx?id_gold_custo_produtor={0}") %>' Text='<%# Eval("nr_custo_dieta_total") %>'></asp:HyperLink>
</itemtemplate>
                                </asp:TemplateField>
...
<asp:Label id="lbl_ds_anotacao_aprovador" runat="server" Text='<%# Bind("ds_anotacao_aprovador") %>' __designer:wfdid="w3"></asp:Label> 
                                ...
                                <asp:TemplateField Visible="False">
                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" __designer:wfdid="w9" Text="Button" ToolTip="Consulta Informações Custo GOLD" CommandArgument='<%# bind("id_gold_custo_produtor") %>' CommandName="selecionar" CausesValidation="False"></asp:ImageButton> 
</itemtemplate>
                                </asp:TemplateField>
                                            </Columns>
