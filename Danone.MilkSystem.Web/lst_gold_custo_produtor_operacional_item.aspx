<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_gold_custo_produtor_operacional_item.aspx.vb" Inherits="lst_gold_custo_produtor_operacional_item" %>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td style="height: 20px; width: 758px;">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_nm_gold_custo_produtor_operacional_item" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto"
                                        MaxLength="16" Width="400px"></anthem:TextBox></td>
                            </tr>
							<TR>
				...
				<TR>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="nm_gold_custo_produtor_operacional_item" HeaderText="Nome do Item" SortExpression="nm_gold_custo_produtor_operacional_item" />
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" CommandArgument='<%# Bind("id_gold_custo_produtor_operacional_item") %>' CommandName="edit" __designer:wfdid="w3"></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" AutoUpdateAfterCallBack="True" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" CommandArgument='<%# Bind("id_gold_custo_produtor_operacional_item") %>' CommandName="delete" OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;" __designer:wfdid="w4"></anthem:ImageButton> 
</itemtemplate>
