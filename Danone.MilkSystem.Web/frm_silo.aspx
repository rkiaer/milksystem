<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_silo.aspx.vb" Inherits="frm_silo" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>Silos</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px" ></TD>
												...
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
													...
													<TR id="CodigoTecnico" runat="server">
														<TD class="texto" align="right" width="23%"><STRONG>
                                                            <anthem:Label ID="lbl_cd_silo" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto"
                                                                UpdateAfterCallBack="True">Código:</anthem:Label></STRONG></TD>
														<TD width="77%">&nbsp;<anthem:TextBox ID="txt_cd_silo" runat="server" AutoUpdateAfterCallBack="True"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;<anthem:TextBox ID="txt_nm_silo" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto"
                                                                Width="39%" MaxLength="50"></anthem:TextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_nm_silo"
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <strong><span style="color: #ff0000">* </span>Nr. Silo:</strong></td>
                                                        <td>
                                                            &nbsp;<cc3:OnlyNumbersTextBox ID="txt_nr_silo" runat="server" CssClass="texto" MaxLength="2"
                                                                Width="32px"></cc3:OnlyNumbersTextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_nr_silo"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Nr. Silo para continuar." Font-Bold="True"
                                                                ValidationGroup="vg_salvar" AutoUpdateAfterCallBack="True">[!]</anthem:RequiredFieldValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%" style="height: 28px">
                                                            <strong><span style="color: #ff0000">* </span>Volume:</strong></td>
                                                        <td style="height: 28px">
                                                            &nbsp;<cc3:OnlyNumbersTextBox ID="txt_nr_volume" runat="server" CssClass="texto"
                                                                MaxLength="10"></cc3:OnlyNumbersTextBox>&nbsp;
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_nr_volume"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Volume para continuar." Font-Bold="True"
                                                                ValidationGroup="vg_salvar" AutoUpdateAfterCallBack="True">[!]</anthem:RequiredFieldValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                        ...
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_id_item_leite" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto">
                                                            </anthem:DropDownList>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cbo_id_item_leite"
