...
Partial Class lst_pessoa_contrato_aprovar_1N
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_pessoa_contrato_aprovar_1N.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_pessoa_contrato_aprovar_1N.aspx")
    ...
    Private Sub loadData()
        ...
        Try
            ...
            contrato.id_situacao_pessoa_contrato = 1 'aguardando aprovacao
    ...
    Protected Sub lk_aprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_aprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                contrato.updatePessoaContratoAprovarSelecionados1Nivel()
                'FRAN 08/12/2020 i incluir log 
                Dim usuariolog As New UsuarioLog
                usuariolog.id_usuario = Session("id_login")
                usuariolog.ds_id_session = Session.SessionID.ToString()
    ...
    Protected Sub lk_reprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_reprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                contrato.id_estabelecimento = ViewState.Item("id_estabelecimento").ToString
                contrato.id_modificador = Session("id_login")
                contrato.updatePessoaContratoNaoAprovarSelecionados1Nivel()
        ...
        Try
            If Page.IsValid = True Then
                Try
                    ...
                    Dim lAssunto As String = "Aprovação 2.o Nível de Modelo de Contrato de Produtor"
                    Dim lCorpo As String = "Existem Modelos de Contrato de Produtor aprovados em 1.o Nível pendentes para aprovação 2.o Nível."
