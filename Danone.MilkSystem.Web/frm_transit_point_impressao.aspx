<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_transit_point_impressao.aspx.vb" Inherits="frm_transit_point_impressao" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Impressão Transit Point</title>
        ...
        <div id="tudorel" style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid; vertical-align: middle; text-align: center;">
            ...
            <table width="100%" cellpadding="1" cellspacing="0" >
                <tr>
                    ...
                    <td align="center" class="textosmallbold" colspan="2" style="border-right: gray 1px solid; border-top: gray 1px solid;">
                        INFORMAÇÃO TRANSIT POINT</td>
                </tr>
                <tr>
                    <td align="center" colspan="2" class="textosmallbold" style="border-right: gray 1px solid; height: 5px;">&nbsp;&nbsp;&nbsp;Transit Point Nr:
            ...
            <table width="100%" cellspacing="0" >
                ...
                <tr>
                 ...
                 <tr>
                    <td align="center" colspan="2"><img  src="img/back_fx_transitpoint_title.gif" id="IMG1"/></td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td align="center" valign="top" style="height: 500px" >
                        &nbsp;<anthem:GridView ID="gridTransitPoint" runat="server" AutoGenerateColumns="False"
                            AutoUpdateAfterCallBack="True" CellPadding="4" CssClass="texto" DataKeyNames="id_transit_point_up"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="nm_situacao_transit_point" HeaderText="Situa&#231;&#227;o TP"
                                    Visible="False">
                                    <itemstyle horizontalalign="Center" />
                                </asp:BoundField>
                            </Columns>
