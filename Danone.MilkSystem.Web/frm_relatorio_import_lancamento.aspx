<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_import_lancamento.aspx.vb" Inherits="frm_relatorio_import_lancamento" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Relatório Importação Lançamento</title>
            ...
            <table class="texto" width="100%">
                <tr>
                    ...
                    <td align="center" class="texto" colspan="2" style="font-weight: bold; font-size: small;
                        ...
                        RELATÓRIO DE CONSISTÊNCIAS - IMPORTAÇÃO LANÇAMENTOS</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center" class="texto" colspan="3">
                                                ...
                                                <asp:BoundField DataField="nr_linha" HeaderText="Nr. Linha" />
                                                <asp:BoundField DataField="ds_referencia" HeaderText="Refer&#234;ncia" />
                                                <asp:BoundField DataField="ds_propriedade" HeaderText="Prop." />
                                                <asp:BoundField DataField="ds_conta" HeaderText="Conta" ReadOnly="True" >
