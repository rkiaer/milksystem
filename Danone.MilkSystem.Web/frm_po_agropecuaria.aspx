<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_po_agropecuaria.aspx.vb" Inherits="frm_po_agropecuaria" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>PO Agropecuária</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px" ></TD>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="cbo_estabelecimento"
                                ...
                                Font-Bold="True" ValidationGroup="vg_salvar">[!]</asp:RequiredFieldValidator></td>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" style="width: 23%">
                                                            <span class="obrigatorio">*</span><strong>Produtor Agropecuária:</strong></td>
                                                        <td >
                                                            ...
                                                            <anthem:ImageButton ID="bt_lupa_produtor" runat="server" AutoUpdateAfterCallBack="true"
                                                            ...
                                                            <anthem:CustomValidator ID="cmv_produtor" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" ErrorMessage="Produtor não cadastrado." Font-Bold="True" SetFocusOnError="True"
                                                                ValidationGroup="vg_salvar" ToolTip="Produtor não cadastrado!" ControlToValidate="txt_cd_pessoa">[!]</anthem:CustomValidator></td>
                                                    </tr>
                    <tr>
                        <td align="right" class="texto" style="width: 23%">
