<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_faixa_incentivo_fiscal.aspx.vb" Inherits="frm_faixa_incentivo_fiscal" %>
										...
										<TR>
											<TD width="76%">
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="texto">
                                                            ...
                                                            <anthem:RequiredFieldValidator ID="rfv_estabelecimento" runat="server" AutoUpdateAfterCallBack="True"
                                                                ControlToValidate="cbo_estabelecimento" CssClass="texto" ErrorMessage="Preencha o campo Estabelecimento para continuar.">[!]</anthem:RequiredFieldValidator>
                                                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" style="width: 23%">
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" style="width: 23%">
                                                            <span id="Span5" class="obrigatorio">*</span><strong>Incentivo Fiscal:</strong></td>
                                                        <td width="77%">
                                                            &nbsp;
                                                            <cc6:OnlyDecimalTextBox ID="txt_nr_incentivo_fiscal" runat="server" CssClass="texto"
                                                                MaxCaracteristica="10" MaxMantissa="4"></cc6:OnlyDecimalTextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_nr_incentivo_fiscal"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Incentivo Fiscal para continuar."
                                                                Font-Bold="True">[!]</anthem:RequiredFieldValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" style="width: 23%">
