			...
			<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;">
                        <strong>Romaneio Saída - Solicitar Nota Fiscal</strong></td>
					<td style="width: 9px;height: 25px">&nbsp;</td>
				</tr>
				<tr>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0" topmargin="0" >
                            ...
                            <tr>
                                ...
                                <td style="height: 23px">
                                 ...
                                 <td align="right">&nbsp;Nr Romaneio Saída<span style="color: #333333">:</span></td>
                                 <td>
                                    &nbsp;
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" AutoUpdateAfterCallBack="True" ToolTip="Editar" ImageUrl="~/img/icone_editar.gif" CommandArgument='<%# bind("id_romaneio_saida") %>' CommandName="edit" __designer:wfdid="w12"></anthem:ImageButton><anthem:ImageButton id="img_delete" runat="server" AutoUpdateAfterCallBack="True" ToolTip="Cancelar Solicitação de Abertura" ImageUrl="~/img/icone_excluir.gif" Visible="False" UpdateAfterCallBack="True" CommandArgument='<%# bind("id_romaneio_saida") %>' CommandName="delete" OnClientClick="if (confirm('Deseja realmente CANCELAR a solicitação de abertura do Romaneio de Saída?' )) return true;else return false;" __designer:wfdid="w13"></anthem:ImageButton> 
</itemtemplate>
