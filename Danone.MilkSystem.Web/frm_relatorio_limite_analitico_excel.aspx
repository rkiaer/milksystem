<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_limite_analitico_excel.aspx.vb" Inherits="frm_relatorio_limite_analitico_excel" %>
    ...
    <div>
        ...
        <asp:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                                                ...
                                                <asp:BoundField DataField="desconto_parcelado_danone" HeaderText="Desc. Parc.Central" DataFormatString="{0:N2}" >
                                                    <headerstyle horizontalalign="Center" />
                                                    <itemstyle horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="Pedidos Abertos" DataField="desconto_aberto"  DataFormatString="{0:N2}">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                    <itemstyle horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="Fin.Parcial" DataField="desconto_fin_parcial"  DataFormatString="{0:N2}">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                    <itemstyle horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="desconto_propriedade" DataFormatString="{0:N2}" HeaderText="Total Desconto Prop."
                                                    ReadOnly="True">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                    <itemstyle horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="volumetotal" DataFormatString="{0:N0}" HeaderText="Total Volume">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="valor_rendimento_bymatriz" DataFormatString="{0:N2}" HeaderText="Total Rend.M-1"
                                                    ReadOnly="True">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                    <itemstyle backcolor="Aquamarine" horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="limitebruto_bymatriz" DataFormatString="{0:N2}" HeaderText="Total Limite 150%">
                                                    <headerstyle horizontalalign="Center" wrap="False" />
                                                    <itemstyle backcolor="Aquamarine" horizontalalign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="Total Descontos" DataField="desconto_bymatriz" DataFormatString="{0:N2}" >
