<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_linha_detalhe.aspx.vb" Inherits="lst_linha_detalhe" %>
				...
				<TR>
					...
					<TD style="width: 934px">
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="nr_seq_coleta" HeaderText="Seq" SortExpression="nr_seq_coleta" >
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nm_produtor" HeaderText="Produtor" SortExpression="nm_produtor" >
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nm_propriedade" HeaderText="Propriedade" SortExpression="nm_propriedade" />
                                                <asp:BoundField DataField="nr_unid_producao" HeaderText="U.Produ&#231;&#227;o" SortExpression="nr_unid_producao" />
                                                <asp:BoundField DataField="nr_dist_prim_produtor" HeaderText="Dist. A" />
                                                <asp:BoundField DataField="nr_dist_produtores" HeaderText="Dist. B" />
                                                <asp:BoundField DataField="nr_dist_ult_produtor" HeaderText="Dist. C" />
