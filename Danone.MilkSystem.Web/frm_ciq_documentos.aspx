<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_ciq_documentos.aspx.vb" Inherits="frm_ciq_documentos" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Controle de Incidentes de Qualidade - Documentos</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>Controle de Incidente de Qualidade CIQ - Documentos</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 7px; " ></TD>
...
&nbsp;&nbsp; 
                                                                                                ...
                                                                                                <itemtemplate>
&nbsp;<asp:Label id="lbl_nm_documento" runat="server" CssClass="texto" Text='<%# Bind("nm_documento") %>' __designer:wfdid="w190"></asp:Label> 
</itemtemplate>
                                                                                            </asp:TemplateField>
                                                                                            <asp:BoundField DataField="nm_extensao" HeaderText="Extens&#227;o" ReadOnly="True" />
                                                                                            <asp:TemplateField HeaderText="Arquivo">
                                                                                                <itemtemplate>
&nbsp;<asp:HyperLink id="hl_download" runat="server" Text="Clique aqui para fazer o download" ForeColor="Blue" __designer:wfdid="w191" Font-Underline="True" Target="_blank"></asp:HyperLink> 
</itemtemplate>
                                                                                            </asp:TemplateField>
