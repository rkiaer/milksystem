<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_romaneio_anexos.aspx.vb" Inherits="frm_romaneio_anexos" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Romaneio - Anexar Documentos</title>
				...
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif); width: 98%;">
                        <asp:Label ID="lbl_titulo_tela" runat="server"
                            CssClass="texto" Font-Bold="False" Font-Size="XX-Small" ForeColor="White">Romaneio - Anexar Documentos</asp:Label></TD>
					<TD style="width: 1%">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 1%; " ></TD>
				...
				<tr  >
				    ...
				    <td class="texto">
						<TABLE id="Table8" cellSpacing="0" cellPadding="2" width="100%" class="texto">
							<TR>
								<TD class="titmodulo"  colSpan="6" style="height: 10px"> Dados do Romaneio</TD>
							</TR>
                            <tr>
                                <td align="right" class="texto"  style="width: 15%; height: 30px">
                                    <span class="obrigatorio"></span> Nr. Romaneio:</td>
                                <td class="texto" style="height: 30px">
                                    <asp:Label ID="lbl_id_romaneio" runat="server" CssClass="texto"></asp:Label>
                                    &nbsp; &nbsp;
                                    <asp:Label ID="lbl_nm_linha" runat="server" CssClass="texto"></asp:Label></td>
                                                ...
                                                <tr>
                                                    <td align="center" class="texto" colspan="8">
                                                        ...
                                                        <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False"
                                                            AutoUpdateAfterCallBack="True" CellPadding="4" CssClass="texto" DataKeyNames="id_romaneio_anexo"
...
&nbsp;&nbsp; 
                                                                    ...
                                                                    <itemtemplate>
&nbsp;<asp:Label id="lbl_nm_documento" runat="server" CssClass="texto" Text='<%# Bind("nm_documento") %>' __designer:wfdid="w115"></asp:Label> 
</itemtemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Download">
                                                                    <itemtemplate>
<asp:HyperLink id="hl_download" runat="server" ForeColor="Blue" __designer:wfdid="w116" Font-Underline="True">Clique aqui para fazer o download</asp:HyperLink> 
</itemtemplate>
                                                                    <headerstyle horizontalalign="Center" />
                                                                    <itemstyle horizontalalign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField ShowHeader="False">
                                                                    <edititemtemplate>
<asp:ImageButton id="btn_salvar" runat="server" ImageUrl="~/img/icone_gravar.gif" CausesValidation="True" ValidationGroup="vg_grid" Text="Update" CommandName="Update" __designer:wfdid="w79"></asp:ImageButton>&nbsp;<asp:ImageButton id="btn_voltar" runat="server" ImageUrl="~/img/icon_undo.gif" CausesValidation="False" Text="Cancel" CommandName="Cancel" __designer:wfdid="w80"></asp:ImageButton> <asp:ValidationSummary id="validatorSummary" runat="server" ValidationGroup="vg_grid" ShowSummary="False" ShowMessageBox="True" __designer:wfdid="w81"></asp:ValidationSummary> 
</edititemtemplate>
                                                                    <itemtemplate>
<asp:ImageButton id="btn_editar" runat="server" ImageUrl="~/img/icone_editar_grid.gif" CausesValidation="False" Text="Edit" Visible="False" CommandName="Edit" __designer:wfdid="w77"></asp:ImageButton> <anthem:ImageButton id="btn_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" AutoUpdateAfterCallBack="True" CommandName="delete" ToolTip="Excluir Anexo Pedido" ImageAlign="Baseline" OnClientClick="if (confirm('Deseja realmente excluir este registro?' )) return true;else return false;" CommandArgument='<%# Bind("id_romaneio_anexo") %>' __designer:wfdid="w77"></anthem:ImageButton> 
</itemtemplate>
                                                                    <itemstyle horizontalalign="Center" />
                                                                </asp:TemplateField>
...
&nbsp; 
                                                                    ...
                                                                    <itemtemplate>
<asp:Label id="lbl_id_romaneio" runat="server" Text='<%# Bind("id_romaneio") %>' __designer:wfdid="w84"></asp:Label> 
</itemtemplate>
                                                                </asp:TemplateField>
