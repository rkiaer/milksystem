<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lupa_coopertiva.aspx.vb" Inherits="lupa_cooperativa" %>
		...
		<form id="Form1" runat="server">
			<table id="Table1"  cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					...
					<td class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><StrONG>Seleção de Cooperativas</StrONG></td>
					...
					<td id="td_pesquisa" runat="server"  style="height: 127px"><br />
						<table class="borda" id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0" >
                            <tr>
                                ...
                                <td id="TD1" runat="server" style="height: 20px">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="cbo_estabelecimento"
                                        ...
                                        Font-Bold="True" Operator="NotEqual" Type="Integer" ValueToCompare="0" Visible="False">[!]</asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    &nbsp;
                                    <cc2:CNPJTextBox ID="txt_cnpj" runat="server"></cc2:CNPJTextBox>
                                </td>
                            </tr>
				...
				<tr>
					...
					<td>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="cd_cnpj" HeaderText="CNPJ" SortExpression="cd_cnpj" />
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    ...
                                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" Text="Button" CommandArgument='<%# Eval("id_pessoa") %>' CommandName="selecionar" ImageUrl="~/img/icon_ok.gif" CausesValidation="False" __designer:wfdid="w3"></asp:ImageButton> 
</itemtemplate>
                                                </asp:TemplateField>
                                            </Columns>
