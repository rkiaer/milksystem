...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Transit Point - Abertura do Pré-Romaneio</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>
                        <anthem:Label ID="lbl_titulo" runat="server" AutoUpdateAfterCallBack="True" Text="Abertura do Pré Romaneio para Transit Point"
				...
				<TR>
					...
					<TD id="td_pesquisa" runat="server" class="texto" valign="top">
                        ...
                        <anthem:DropDownList ID="cbo_estabelecimento" runat="server" CssClass="texto" AutoCallBack="True" AutoUpdateAfterCallBack="True">
                            ...
                            ControlToValidate="cbo_estabelecimento" ErrorMessage="O Estabelecimento deve ser preenchido para a abertura do Pré-Romaneio."
                            InitialValue="0" ToolTip="O Estabelecimento deve ser preenchido para a abertura do Pré-Romaneio."
							...
							<TR id="TrProdutor" runat="server">
								<TD align="right" style="height: 22px" > Placa Veículo:&nbsp;</TD>
								<TD style="height: 22px" >
					                &nbsp;
                                    ...
                                    <anthem:ImageButton
                                     ...
                                     <anthem:CustomValidator ID="cmv_placa" runat="server" AutoUpdateAfterCallBack="True"
                                                                ErrorMessage="Placa não cadastrada." ValidationGroup="vg_pesquisar" CssClass="texto" Font-Bold="True" ControlToValidate="txt_placa">[!]</anthem:CustomValidator></TD>
                                <td align="right" style="height: 22px">
                                    Nome Rota:</td>
                                <td style="height: 22px">
							...
							<TR>
								...
								<TD style="HEIGHT: 20px">&nbsp;
                                    <cc3:OnlyDateTextBox ID="txt_dt_transmissao_ini" runat="server" CssClass="texto"
                                        Width="80px"></cc3:OnlyDateTextBox>&nbsp; à &nbsp;<cc3:OnlyDateTextBox ID="txt_dt_transmissao_fim"
				...
				<TR >
					...
					<TD vAlign="bottom" style="height: 19px" class="texto">&nbsp;
                        ...
                        <anthem:RequiredFieldValidator ID="rf_transitpoint" runat="server" AutoUpdateAfterCallBack="True"
                            ControlToValidate="cbo_transit_point" ErrorMessage="A unidade de Transit Point deve ser preenchida para a abertura do Pré-Romaneio de Transit Point."
                            ToolTip="A unidade de Transit Point deve ser preenchida para a abertura do Pré-Romaneio de Transit Point."
