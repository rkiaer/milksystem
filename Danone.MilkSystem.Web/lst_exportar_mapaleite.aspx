<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_mapaleite.aspx.vb" Inherits="lst_exportar_mapaleite" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Mapa Leite Laser</STRONG></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
								...
								<TD style="height: 19px; width: 156px;" align="right">
                                    <anthem:CheckBox ID="chk_movto" runat="server" Text="Imprime sem Movto" /></TD>
