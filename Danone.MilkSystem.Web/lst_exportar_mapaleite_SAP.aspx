<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_mapaleite_SAP.aspx.vb" Inherits="lst_exportar_mapaleite_SAP" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Mapa Leite Laser SAP</STRONG></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
								...
								<TD style="height: 19px; width: 156px;" align="right">
                                    <anthem:CheckBox ID="chk_movto" runat="server" Text="Imprime sem Movto" Visible="False" /></TD>
                            ...
                            <tr>
                                <td align="right" style="height: 19px" >
                                    Rota:</td>
                                <td style="height: 19px; ">
                                    &nbsp; &nbsp;&nbsp;<anthem:TextBox ID="txt_cd_rota_ini" runat="server" CssClass="texto"
                                        Width="75px"></anthem:TextBox>
                                    à &nbsp;&nbsp;<anthem:TextBox ID="txt_cd_rota_fim" runat="server" CssClass="texto" Width="75px"></anthem:TextBox>
                                    &nbsp;
                                </td>
                                <TD style="height: 19px; width: 156px;" align="right">
                                </td>
