<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_central_pedido_abertura_contrato_old.aspx.vb" Inherits="frm_central_pedido_abertura_contrato_old" %>
...
<head id="Head1" runat="server">
    ...
    <title>Abertura Pedido por Contrato</title>
                                ...
                                <anthem:GridView ID="gridPropriedades" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ShowHeader="False">
                                            <itemtemplate>
<anthem:ImageButton id="imgselecionar" runat="server" ImageUrl="~/img/ico_triangulo_cinza.gif" CausesValidation="False" AutoUpdateAfterCallBack="True" Text="Select" CommandName="Select" __designer:wfdid="w56"></anthem:ImageButton> 
</itemtemplate>
...
<anthem:Label id="lbl_nr_valor_disponivel" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True"></anthem:Label> 
                                        ...
                                        <asp:TemplateField HeaderText="Vl M&#234;s Estimado">
                                            <itemtemplate>
                                            ...
                                            <anthem:GridView ID="gridqtdes" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Det.">
                                                        <itemtemplate>
<anthem:ImageButton id="btn_detalhe_item" runat="server" ImageUrl="~/img/icon_preview.gif" ToolTip="Visualizar Detalhes Pedido da Propriedade" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" __designer:wfdid="w88" CommandName="detalhepedido"></anthem:ImageButton> 
</itemtemplate>
                                                        <headerstyle horizontalalign="Center" />
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Janeiro">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes1" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_valor_01") %>' AutoCallBack="True" __designer:wfdid="w41" OnTextChanged="txt_mes1_TextChanged"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" wrap="False" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Fevereivo">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes2" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_valor_02") %>' AutoCallBack="True" __designer:wfdid="w39" OnTextChanged="txt_mes2_TextChanged"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" wrap="False" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Mar&#231;o">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes3" runat="server" CssClass="texto"  Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_valor_03") %>' __designer:wfdid="w15"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" wrap="False" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Abril">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes4" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_04") %>' __designer:wfdid="w16"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" wrap="False" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Maio">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes5" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_05") %>' __designer:wfdid="w17"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" wrap="False" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Junho">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes6" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_06") %>' __designer:wfdid="w18"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Julho">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes7" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_07") %>' __designer:wfdid="w19"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Agosto">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes8" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_08") %>' __designer:wfdid="w20"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Setembro">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes9" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_09") %>' __designer:wfdid="w21"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Outubro">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes10" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_10") %>' __designer:wfdid="w22"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Novembro">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes11" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_11") %>' __designer:wfdid="w23"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Dezembro">
                                                        <itemtemplate>
<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_mes12" runat="server" CssClass="texto" Width="50px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" Text='<%# bind("nr_valor_12") %>' __designer:wfdid="w24"></cc6:OnlyDecimalTextBox> 
</itemtemplate>
                                                        <itemstyle horizontalalign="Center" />
                                                    </asp:TemplateField>
...
<anthem:Label id="lbl_total_propriedade" runat="server" Text='<%# Bind("nr_total_propriedade", "{0:N2}") %>'></anthem:Label> 
                                                    ...
                                                    <asp:TemplateField InsertVisible="False" ShowHeader="False">
                                                        <itemtemplate>
&nbsp;<anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/menos_red.gif" ToolTip="Excluir Propriedade do Contrato (AtenÃ§Ã£o: todas as alteraÃ§Ãµes nÃ£o salvas de quantidade serÃ£o perdidas.)" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" CommandName="delete" __designer:wfdid="w155" CommandArgument='<%# Bind("id_propriedade") %>' OnClientClick="if (confirm('ATENÃ‡ÃƒO: ao prosseguir com esta aÃ§Ã£o, todas as alteraÃ§Ãµes em quantidade nÃ£o salvas serÃ£o perdidas. Deseja realmente retirar a propriedade do contrato? ' )) return true;else return false;"></anthem:ImageButton> 
</itemtemplate>
                                                    </asp:TemplateField>
...
<asp:Label id="lbl_id_central_contrato" runat="server" Text='<%# bind("id_central_contrato") %>'></asp:Label> 
                                                    ...
                                                    <asp:TemplateField HeaderText="id_propriedade" Visible="False">
                                                        <itemtemplate>
<asp:Label id="lbl_id_propriedade_adicionada" runat="server" Text='<%# bind("id_propriedade") %>' __designer:wfdid="w12"></asp:Label> 
</itemtemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </anthem:GridView>
                            ...
                            <td class="texto" align="center" colspan="2">
                                <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <itemtemplate>
<TABLE style="BACKGROUND-IMAGE: url(img/faixa_filro.gif)" cellSpacing=0 cellPadding=0 width="100%"><TBODY><TR style="BACKGROUND-IMAGE: url(img/avisos_topo_barra3.gif); TEXT-TRANSFORM: uppercase; HEIGHT: 19px" class="faixafiltro1"><TD style="FONT-SIZE: x-small; WIDTH: 20%; HEIGHT: 20px; TEXT-ALIGN: left" class="faixafiltro1a"><anthem:Label id="lbl_dspropriedade" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="True" UpdateAfterCallBack="True" Text='<%# bind("ds_propriedade") %>' __designer:wfdid="w247"></anthem:Label></TD><TD style="FONT-SIZE: x-small; WIDTH: 9%; HEIGHT: 20px; TEXT-ALIGN: center" class="faixafiltro1a"><anthem:Label id="lbl_dsmatriz" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" Text='<%# bind("ds_matriz") %>' __designer:wfdid="w248"></anthem:Label></TD><TD style="FONT-SIZE: x-small; WIDTH: 15%; HEIGHT: 20px; TEXT-ALIGN: left" class="faixafiltro1a"><anthem:Label id="lbl_cidade" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" Text='<%# bind("ds_cidade") %>' __designer:wfdid="w249"></anthem:Label></TD><TD style="FONT-SIZE: x-small; WIDTH: 15%; HEIGHT: 20px; TEXT-ALIGN: center" class="faixafiltro1a"><anthem:Label id="lbl_limite" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="True" UpdateAfterCallBack="True" __designer:wfdid="w250"></anthem:Label></TD><TD style="FONT-SIZE: x-small; WIDTH: 32%; HEIGHT: 20px" class="faixafiltro1a" align=center><anthem:Label id="lbl_total_item" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" __designer:wfdid="w251"></anthem:Label> &nbsp; &nbsp;<anthem:Label id="lbl_total_frete" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" __designer:wfdid="w252"></anthem:Label> &nbsp;&nbsp; <anthem:Label id="lbl_valor_total" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" __designer:wfdid="w253"></anthem:Label></TD></TR></TBODY></TABLE><TABLE style="BORDER-RIGHT: silver 1px solid; BORDER-TOP: silver 1px solid; FONT-SIZE: x-small; BORDER-LEFT: silver 1px solid; BORDER-BOTTOM: silver 1px solid; BORDER-COLLAPSE: collapse" width="100%" border=1><TBODY><TR><TD style="WIDTH: 6%; HEIGHT: 19px" align=right><SPAN style="COLOR: red">*</SPAN>Embalagem:</TD><TD style="WIDTH: 8%; HEIGHT: 19px" align=left>&nbsp;<anthem:DropDownList id="cbo_tipo_medida" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" AutoCallBack="True" __designer:wfdid="w254" OnSelectedIndexChanged="cbo_tipo_medida_SelectedIndexChanged"><asp:ListItem Value="G">Granel</asp:ListItem>
<asp:ListItem Value="S">Sacaria</asp:ListItem>
<asp:ListItem Value="O">Outros</asp:ListItem>
<asp:ListItem Selected="True">[Selecione]</asp:ListItem>
</anthem:DropDownList><asp:RequiredFieldValidator id="rqf_tipo_medida" runat="server" ValidationGroup="vg_salvar_inf" CssClass="texto" ControlToValidate="cbo_tipo_medida" ErrorMessage="O tipo de medida deve ser informado." Font-Bold="False" __designer:wfdid="w255">[!]</asp:RequiredFieldValidator></TD><TD style="WIDTH: 5%; HEIGHT: 19px" align=right><SPAN style="COLOR: #ff0000">*</SPAN>Parcelar?</TD><TD style="WIDTH: 6%; HEIGHT: 19px" align=left><anthem:DropDownList id="cbo_vai_parcelar" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" AutoCallBack="True" __designer:wfdid="w256" OnSelectedIndexChanged="cbo_vai_parcelar_SelectedIndexChanged"><asp:ListItem Selected="True" Value="N">N&#227;o</asp:ListItem>
<asp:ListItem Value="D">Danone</asp:ListItem>
<asp:ListItem Value="P">Parceiro</asp:ListItem>
</anthem:DropDownList></TD><TD style="WIDTH: 9%; HEIGHT: 19px" align=center>Parcelas:<cc3:OnlyNumbersTextBox id="txt_nr_parcelas" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Width="20px" MaxLength="2" Text='<%# bind("nr_parcelas") %>' AutoCallBack="True" __designer:wfdid="w257" OnTextChanged="txt_nr_parcelas_TextChanged"></cc3:OnlyNumbersTextBox><anthem:RequiredFieldValidator id="rfv_nr_parcelas" runat="server" ValidationGroup="vg_salvar_inf" Enabled="False" ToolTip="O nÃºmero de parcelas deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_parcelas" ErrorMessage="O nÃºmero de parcelas deve ser informado!" __designer:wfdid="w258" Display="Dynamic">[!]</anthem:RequiredFieldValidator><anthem:CompareValidator id="cv_nr_parcelas" runat="server" ValidationGroup="vg_salvar_inf" ToolTip="O nÃºmero de parcelas deve ser maio que zero (0)!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_parcelas" ErrorMessage="O nÃºmero de parcelas deve ser maio que zero (0)!" ValueToCompare="0" Type="Integer" Operator="GreaterThan" __designer:wfdid="w259">[!]</anthem:CompareValidator><anthem:RangeValidator id="rv_parcelas" runat="server" ValidationGroup="vg_salvar_inf" Visible="False" Enabled="False" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_parcelas" Type="Integer" MinimumValue="1" MaximumValue="3" __designer:wfdid="w260">[!]</anthem:RangeValidator></TD><TD style="HEIGHT: 19px" align=center><anthem:CheckBox id="chk_st_pedido_indireto" __designer:dtid="5066579645563109" runat="server" AutoUpdateAfterCallBack="True" Text="Ped.Indireto" __designer:wfdid="w261"></anthem:CheckBox></TD><TD style="WIDTH: 3%; HEIGHT: 19px" align=right>Frete:</TD><TD style="WIDTH: 6%; HEIGHT: 19px" align=left>&nbsp;<anthem:DropDownList id="cbo_tipo_frete" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" AutoCallBack="True" __designer:wfdid="w262" OnSelectedIndexChanged="cbo_tipo_frete_SelectedIndexChanged"><asp:ListItem Value="C">CIF</asp:ListItem>
<asp:ListItem Value="D">FOB-D</asp:ListItem>
<asp:ListItem Value="I">FOB-I</asp:ListItem>
<asp:ListItem Selected="True">[Selec.]</asp:ListItem>
</anthem:DropDownList></TD><TD style="HEIGHT: 19px" align=center>Transp.: <anthem:DropDownList id="cbo_transportador" runat="server" Enabled="False" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" AutoCallBack="True" __designer:wfdid="w263" OnSelectedIndexChanged="cbo_transportador_SelectedIndexChanged"></anthem:DropDownList><anthem:RequiredFieldValidator id="rf_transportador" runat="server" ValidationGroup="vg_salvar_inf" Enabled="False" ToolTip="O transportador deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="cbo_transportador" ErrorMessage="Preencha o campo Tranportador Central para continuar." InitialValue="0" __designer:wfdid="w264" Display="Dynamic">[!]</anthem:RequiredFieldValidator></TD><TD style="WIDTH: 2%; HEIGHT: 19px" align=center><anthem:ImageButton id="btn_lupa_frete_valor" onclick="btn_lupa_frete_valor_Click" runat="server" ImageUrl="~/img/lupa_desabilitada.gif" Enabled="False" ToolTip="Buscar Valores Frete Transportador" AutoUpdateAfterCallBack="true" BorderStyle="None" Width="15px" Height="15px" ImageAlign="AbsBottom" __designer:wfdid="w265" CommandName="Lupa"></anthem:ImageButton></TD><TD style="HEIGHT: 19px" align=right>Vl Frete: <cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_nr_frete" runat="server" Enabled="False" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Width="50px" MaxLength="13" MaxMantissa="2" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_valor_frete") %>' AutoCallBack="True" __designer:wfdid="w266" OnTextChanged="txt_nr_frete_TextChanged"></cc6:OnlyDecimalTextBox> <anthem:Label id="lbl_inf_frete" runat="server" Font-Size="9px" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" ForeColor="Red" Font-Italic="True" __designer:wfdid="w267"></anthem:Label> <anthem:RequiredFieldValidator id="rf_frete" runat="server" ValidationGroup="vg_salvar_inf" Enabled="False" ToolTip="O valor de frete deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_frete" ErrorMessage="O valor de frete deve ser informado." __designer:wfdid="w268" Display="Dynamic">[!]</anthem:RequiredFieldValidator> </TD></TR></TBODY></TABLE>
</itemtemplate>
                                            <itemstyle width="100%" />
                                        </asp:TemplateField>
...
<asp:Label id="lbl_st_parcelamento" runat="server" Text='<%# Bind("st_tipo_parcelamento") %>'></asp:Label> 
                                        ...
                                        <asp:TemplateField HeaderText="dt_fim_contrato" Visible="False">
                                            <itemtemplate>
<asp:Label id="lbl_ds_tipo_frete" runat="server" Text='<%# bind("ds_tipo_frete") %>' __designer:wfdid="w177"></asp:Label> 
</itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="st_pedido_indireto" Visible="False">
                                            <itemtemplate>
<asp:Label id="lbl_st_pedido_indireto" runat="server" Text='<%# bind("st_pedido_indireto") %>' __designer:wfdid="w177"></asp:Label>
</itemtemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                ...
                                <anthem:GridView ID="gridpedidos" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pedido">
                                            <itemtemplate>
<anthem:HyperLink id="hl_id_pedido" runat="server" ToolTip="Visualizar Pedido" AutoUpdateAfterCallBack="True" CssClass="textohlink" UpdateAfterCallBack="True" Text='<%# bind("id_central_pedido") %>' __designer:wfdid="w52" Target="_blank" Font-Underline="True"></anthem:HyperLink>
</itemtemplate>
                                            <headerstyle horizontalalign="Center" />
                                            <itemstyle horizontalalign="Center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Ped.Frete">
                                            <itemtemplate>
<anthem:HyperLink id="hl_id_pedido_frete" runat="server" ToolTip="Visualizar Pedido de Frete" AutoUpdateAfterCallBack="True" CssClass="textohlink" UpdateAfterCallBack="True" Text='<%# bind("id_central_pedido_frete") %>' __designer:wfdid="w48" Target="_blank" Font-Underline="True"></anthem:HyperLink>
</itemtemplate>
                                            <itemstyle horizontalalign="Center" />
                                        </asp:TemplateField>
