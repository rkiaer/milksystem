...
Partial Class frm_relatorio_import_lancamento
    Inherits Page

    Private customPage As RK.PageTools.CustomPage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_relatorio_import_lancamento.aspx")
    ...
    Private Sub loadData()
        ...
        Try
            Dim import As New ImportacaoLancamento
            import.id_importacao = ViewState.Item("id_importacao")
            Dim dsimportacaolog As DataSet = import.getImportacaoLancamentoByFilters()
