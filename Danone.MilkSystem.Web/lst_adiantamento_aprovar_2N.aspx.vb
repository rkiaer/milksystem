...
Partial Class lst_adiantamento_aprovar_2N
    ...
    Protected Sub btn_pesquisa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_pesquisa.Click
        ...
        adiantamento.updateAdiantamentoTodos2N()
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_adiantamento_aprovar_2N.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_adiantamento_aprovar_2N.aspx")
        ...
        If Not Page.IsPostBack Then
            ...
            If (Request("st_incluirlog") Is Nothing) Then 'se nao tem parametro
                ...
                usuariolog.id_menu_item = 42
                usuariolog.insertUsuarioLog()
            End If
            'FRAN 08/12/2020 f incluir log 
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            statusadiantamento.st_aprovado = "1"  ' não traz o item 1 - Pré-Aprovado
        ...
        Try
            ...
            If verificarCheckBox() = True Then
                ...
                Else
                    ...
                    adiantamento.st_aprovado = "2"   '  Aprovados 2Niv
                    adiantamento.id_modificador = Session("id_login")

                    adiantamento.updateAdiantamentoAprovarSelecionados()

                    cbo_status.SelectedValue = "2" ' Listar os Aprovados 2Niv
                    ViewState.Item("st_aprovado") = Me.cbo_status.SelectedValue

                    ' 26/11/2009 - Atualiza Saldo Disponível para considerar os adiantamentos aprovados - i
                    updateData()    ' Atualiza Volume Mensal, Valor Disponível, Valor de Descontos
                    ' 26/11/2009 - Atualiza Saldo Disponível para considerar os adiantamentos aprovados - f
    ...
    Private Sub updateData()
        Try
            ...
            adiantamento.dt_referencia = String.Concat("01/" & ViewState("dt_referencia").ToString)
            adiantamento.st_aprovado = "2" ' Atualiza somente os aprovados 2.o Nível da referência
            If Trim(ViewState.Item("id_tecnico")) <> "" Then
                adiantamento.id_tecnico = ViewState("id_tecnico").ToString
            End If
