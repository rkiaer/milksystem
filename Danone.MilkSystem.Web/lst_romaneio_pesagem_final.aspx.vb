...
Partial Class lst_romaneio_pesagem_final
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_romaneio_pesagem_final.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_romaneio_pesagem_final.aspx")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("lst_rompesfim", txt_id_romaneio.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_romaneio") = customPage.getFilterValue("lst_rompesfim", txt_id_romaneio.ID)
            txt_id_romaneio.Text = ViewState.Item("id_romaneio").ToString()
        Else
            ViewState.Item("id_romaneio") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_rompesfim", hf_id_pessoa.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_transportador") = customPage.getFilterValue("lst_rompesfim", hf_id_pessoa.ID)
        ...
        If Not (customPage.getFilterValue("lst_rompesfim", txt_placa.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("ds_placa") = customPage.getFilterValue("lst_rompesfim", txt_placa.ID)
        ...
        ' 22/01/2009 - Rls15 - i
        If Not (customPage.getFilterValue("lst_rompesfim", txt_nm_linha.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("nm_linha") = customPage.getFilterValue("lst_rompesfim", txt_nm_linha.ID)
            txt_nm_linha.Text = ViewState.Item("nm_linha").ToString()
        Else
            ViewState.Item("nm_linha") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_rompesfim", txt_dt_transmissao_ini.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_transmissao_ini") = customPage.getFilterValue("lst_rompesfim", txt_dt_transmissao_ini.ID)
            txt_dt_transmissao_ini.Text = ViewState.Item("dt_transmissao_ini").ToString()
        Else
            ViewState.Item("dt_transmissao_ini") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_rompesfim", txt_dt_transmissao_fim.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_transmissao_fim") = customPage.getFilterValue("lst_rompesfim", txt_dt_transmissao_fim.ID)
        ...
        If Not (customPage.getFilterValue("lst_rompesfim", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("lst_rompesfim", "PageIndex").ToString()
        ...
        If (hasFilters) Then
            loadData()
            customPage.clearFilters("lst_rompesfim")
        Else
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsromaneio As DataSet = romaneio.getRomaneioAbertoEmAnaliseByFilters()  ' 22/01/2009 (procedure alterada para a data de transmissao) - Rls15
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("lst_rompesfim", txt_id_romaneio.ID, ViewState.Item("id_romaneio").ToString)
            customPage.setFilter("lst_rompesfim", hf_id_pessoa.ID, ViewState.Item("id_transportador").ToString)
            customPage.setFilter("lst_rompesfim", txt_placa.ID, ViewState.Item("ds_placa").ToString)
            '22/01/2009 - Rls15 i
            customPage.setFilter("lst_rompesfim", txt_nm_linha.ID, ViewState.Item("nm_linha").ToString)
            customPage.setFilter("lst_rompesfim", txt_dt_transmissao_ini.ID, ViewState.Item("dt_transmissao_ini").ToString)
            customPage.setFilter("lst_rompesfim", txt_dt_transmissao_fim.ID, ViewState.Item("dt_transmissao_fim").ToString)
            '22/01/2009 - Rls15 f
            customPage.setFilter("lst_rompesfim", "PageIndex", gridResults.PageIndex.ToString())
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "selecionar"
                ...
                Response.Redirect("frm_romaneio_pesagem_final.aspx?id_romaneio=" + e.CommandArgument.ToString + "&nm_tela=complementar_dados")
