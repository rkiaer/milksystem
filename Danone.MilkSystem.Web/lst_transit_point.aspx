                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <itemtemplate>
<anthem:HyperLink style="TEXT-ALIGN: center" id="hl_imprimir_ciq" __designer:dtid="5066575350595681" runat="server" CssClass="texto" AutoUpdateAfterCallBack="True" ToolTip="Transit Point Fechado:  Versão para Imprimir." Enabled="False" ImageUrl="~/img/ic_impressao_desabilitado.gif" UpdateAfterCallBack="True" __designer:wfdid="w59" NavigateUrl="~/frm_transit_point_impressa.aspx" Target="_blank"></anthem:HyperLink>
</itemtemplate>
