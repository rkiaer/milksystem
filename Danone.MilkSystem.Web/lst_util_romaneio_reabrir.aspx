<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_util_romaneio_reabrir.aspx.vb" Inherits="lst_util_romaneio_reabrir" %>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Reabrir Romaneio</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
				...
				<TR>
					...
					<TD id="td_pesquisa" runat="server" style="height: 44px;"><BR>
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0" onclick="return Table2_onclick()">
							...
							<tr>
								<TD style="width: 20%; height: 26px" align="right">&nbsp;Análise Compartimento:</TD>
								<TD align="left" style="height: 26px">
                                    &nbsp;<anthem:Label ID="lbl_analisecompartimento" runat="server" AutoUpdateAfterCallBack="True"
                                        UpdateAfterCallBack="True"></anthem:Label>&nbsp;</TD>
                                <td align="left" style="height: 26px">
                                    Transit Point:
                            ...
                            <tr>
                                <td align="right" style="width: 20%; height: 26px">
                                    Exportação Frete:</td>
                                <td align="left" style="height: 26px">
                                    &nbsp;<anthem:Label ID="lbl_exportacao_frete" runat="server" AutoUpdateAfterCallBack="True"
                                        UpdateAfterCallBack="True"></anthem:Label></td>
                                <td align="left" style="height: 26px">
                                    Exportação Batch:
                                    <anthem:Label ID="lbl_exportacao_batch" runat="server" AutoUpdateAfterCallBack="True"
                                        UpdateAfterCallBack="True"></anthem:Label></td>
                                <td align="left" style="height: 26px">
                                    Última Ref. Cálculo:
                            ...
                            <tr>
                                ...
                                <anthem:imagebutton id="btn_executar" runat="server" imageurl="~/img/bnt_executar.gif" ValidationGroup="vg_pesquisar"></anthem:imagebutton></td>
                            </tr>
						</TABLE>
					</TD>
                        ...
                        <TABLE class="borda" id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0" onclick="return Table2_onclick()">
                            <tr>
                                <td align="center" style="height: 20px" colspan="2">
                                    Ao selecionar o botão "Executar", o romaneio será reaberto. Ele não participará
                                    do cálculo enquanto não estiver fechado novamente.</td>
                            </tr>
                        </table>
                    </td>
                    <TD>
