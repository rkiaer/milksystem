<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_balanca.aspx.vb" Inherits="lst_balanca" %>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td style="height: 20px; ">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_nm_balanca" runat="server" CssClass="caixaTexto" Width="224px" MaxLength="30"></anthem:TextBox></td>
                            </tr>
							<TR>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="nm_estabelecimento" HeaderText="Estabelecimento"
                                                    SortExpression="nm_estabelecimento" />
                                                <asp:BoundField DataField="nm_balanca" HeaderText="Nome" SortExpression="nm_balanca" >
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ds_end_ip" HeaderText="Endere&#231;o IP" SortExpression="ds_end_ip" >
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" __designer:wfdid="w1" CommandName="edit" CommandArgument='<%# Bind("id_balanca") %>'></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" AutoUpdateAfterCallBack="True" __designer:wfdid="w2" CommandName="delete" CommandArgument='<%# Bind("id_balanca") %>' OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;"></anthem:ImageButton> 
</itemtemplate>
