<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_gold_custo_aprovar_2N.aspx.vb" Inherits="lst_gold_custo_aprovar_2N" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Aprovação Custos GOLD 2.o Nível</title>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Custos Gold 2.o Nível</STRONG></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 14px">
                                    ...
                                    <cc3:OnlyDateTextBox ID="txt_dt_referencia_inicial" runat="server" CssClass="caixatexto"
                                        DateMask="MonthYear" Width="72px"></cc3:OnlyDateTextBox>&nbsp; à &nbsp;
				...
				<TR>
					...
					<TD style="width: 1014px">
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" AutoUpdateAfterCallBack="True" Width="100%" UpdateAfterCallBack="True" PageSize="7" DataKeyNames="id_gold_custo">
...
&nbsp;<asp:CheckBox id="ck_header" runat="server" AutoPostBack="True" OnCheckedChanged="ck_header_CheckedChanged" __designer:wfdid="w5"></asp:CheckBox> 
                                    ...
                                    <itemtemplate>
&nbsp;<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w11" Checked='<%# bind("st_selecao") %>'></asp:CheckBox> 
</itemtemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Dt Validade Inicial" DataField="dt_referencia_inicial" SortExpression="dt_referencia_inicial" ReadOnly="True" />
                                <asp:BoundField HeaderText="Dt Validade Final" DataField="dt_referencia_final" SortExpression="dt_referencia_final" ReadOnly="True" />
                                <asp:TemplateField HeaderText="Anota&#231;&#227;o Aprovador">
                                    <edititemtemplate>
<anthem:TextBox id="txt_ds_anotacao_aprovador" __designer:dtid="1970354901745708" runat="server" CssClass="texto" Width="350px" Text='<%# Bind("ds_anotacao_aprovador") %>' MaxLength="200" __designer:wfdid="w23"></anthem:TextBox> 
</edititemtemplate>
                                    <itemtemplate>
<asp:Label id="lbl_ds_anotacao_aprovador" runat="server" Text='<%# Bind("ds_anotacao_aprovador") %>' __designer:wfdid="w22"></asp:Label> 
</itemtemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Custos">
                                    <itemtemplate>
<asp:HyperLink id="hl_custo" runat="server" ForeColor="Blue" __designer:wfdid="w8" Target="_blank" NavigateUrl="~/frm_gold_custo.aspx">Visualizar</asp:HyperLink> 
</itemtemplate>
                                </asp:TemplateField>
