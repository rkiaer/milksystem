...
Partial Class lupa_transportador
    Inherits Page
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        If ViewState.Item("param_id_estabelecimento") = "0" Then
            Response.Redirect("lupa_transportador.aspx")
        Else
            Response.Redirect("lupa_transportador.aspx?id_estabelecimento=" + ViewState.Item("param_id_estabelecimento").ToString)
        End If
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsTransportador As DataSet = produtor.getTransportadorByFilters()
    ...
    Private Sub salvarLinhaSelecionada(ByVal pid_produtor As String)
        ...
        Try
            ...
            customPage.setFilter("lupa_transportador", "cd_pessoa", transportador.cd_pessoa)

            customPage.setFilter("lupa_transportador", "nm_pessoa", transportador.nm_pessoa)

            customPage.setFilter("lupa_transportador", "nm_abreviado", transportador.nm_abreviado)
