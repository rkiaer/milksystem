<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_usuario_grupo_excel.aspx.vb" Inherits="frm_relatorio_usuario_grupo_excel" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Relatório Acessos - Usuários X Grupos</title>
</head>
    ...
    <div>
        <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="dt_criacao_usuario_grupo" HeaderText="Modifica&#231;&#227;o">
                </asp:BoundField>
            </Columns>
