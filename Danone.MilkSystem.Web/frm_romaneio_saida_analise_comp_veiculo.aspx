...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Romaneio Saída - Registrar Análise dos Compartimentos do Veículo</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif);"><STRONG>Romaneio Saída - Registrar Análise dos Compartimentos</STRONG></TD>
				...
				<TR>
					...
					<TD class="texto">
                        <asp:Panel ID="Panel1" runat="server" BackColor="White" Font-Bold="False"  Width="100%" Font-Size="X-Small" CssClass="texto" GroupingText="Dados Romaneio Saída">
						<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%">
                            <tr>
                                <td align="right" class="texto" style="width: 19%; height: 20px"><strong>Nr. Romaneio Saída:</strong></td>
...
&nbsp; 
                                            ...
                                            <itemtemplate>
&nbsp;<anthem:HyperLink style="TEXT-ALIGN: center" id="hl_imprimir_ciq" __designer:dtid="5066575350595681" runat="server" ImageUrl="~/img/ic_impressao_desabilitado.gif" ToolTip="Relatório CIQ:  Versão para Imprimir." CssClass="texto" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" __designer:wfdid="w203" Target="_blank" NavigateUrl="~/frm_relatorio_CIQ.aspx" Enabled="False"></anthem:HyperLink>&nbsp; <asp:ImageButton style="TEXT-ALIGN: center" id="btn_email" __designer:dtid="5066575350595684" runat="server" ImageUrl="~/img/ico_email_desabilitado.gif" ToolTip="Relatório CIQ - Enviar Email " CssClass="texto" OnClientClick="if (confirm('O relatório CIQ será enviado à lista de emails informada nos cadastros. Deseja realmente prosseguir?' )) return true;else return false;" CommandArgument='<%# Bind("id_romaneio_saida_compartimento") %>' __designer:wfdid="w126" Enabled="False" CommandName="EmailCIQ"></asp:ImageButton> 
</itemtemplate>
                                            <headerstyle horizontalalign="Center" />
                                            <itemstyle horizontalalign="Center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="An&#225;lise Produtores" Visible="False">
                                            <itemtemplate>
<asp:ImageButton id="btn_registrar_analise_uproducao" runat="server" ImageUrl="~/img/icon_registrar_desabilitado.gif" ToolTip="Registrar Análise Unid. Produção / Produtor" CommandArgument='<%# Bind("id_romaneio_saida_compartimento") %>' __designer:wfdid="w213" Enabled="False" CommandName="Registrar_Analise_UProducao"></asp:ImageButton> 
</itemtemplate>
                                            <headerstyle horizontalalign="Center" />
                                            <itemstyle horizontalalign="Center" />
                                        </asp:TemplateField>
