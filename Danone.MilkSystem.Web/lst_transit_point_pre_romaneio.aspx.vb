...
Partial Class lst_transit_point_pre_romaneio
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_transit_point_pre_romaneio.aspx")
