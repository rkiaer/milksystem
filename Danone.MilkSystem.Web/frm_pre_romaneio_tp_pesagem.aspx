<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_pre_romaneio_tp_pesagem.aspx.vb" Inherits="frm_pre_romaneio_tp_pesagem" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Atualizar Pesagem de Pré-Romaneio para Transit Point</title>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" BackColor="White" CssClass="texto" Font-Bold="False"
                                        ...
                                        <table id="Table3" border="0" cellpadding="1" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="texto" style="width: 18%; height: 20px">
                                                    <strong>
                                                        <anthem:Label ID="lbl_unidade" runat="server">*Unidade Transit Point:</anthem:Label>:</strong></td>
                                                <td align="left" style="width: 33%; height: 20px">
                                                    &nbsp;<asp:Label ID="lbl_transit_point_unidade" runat="server" CssClass="texto" Width="100%"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="texto" style="width: 20%; height: 20px">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="middle" colspan="2">
                                                    &nbsp;<asp:Label ID="lbl_transportador" runat="server"  CssClass="texto" Width="176px"></asp:Label><strong></strong></td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="texto" style="width: 18%; height: 20px">
                                                    <strong><span style="color: #000000"> Finalizado:</span></strong></td>
                                                <td align="left" style="width: 33%; height: 20px">
