...
Partial Class lst_analise_esalq_silo_importar
    Inherits Page
    ...
    Private Sub loadData()
        Try
            ...
            Me.hl_imprimir.NavigateUrl = String.Format("frm_relatorio_analise_esalq_silo.aspx?id_importacao={0}", ViewState.Item("id_importacao").ToString)
    ...
    Private Sub importData()
        ...
        Try
            ...
            ViewState.Item("id_importacao") = analiseesalq.importAnaliseEsalqSilo
