<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_util_romaneio_tipo_leite.aspx.vb" Inherits="lst_util_romaneio_tipo_leite" %>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Trocar Tipo do Leite do Romaneio</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0" onclick="return Table2_onclick()">
                            ...
                            <tr>
                                <td align="right" style="height: 26px">
                                    &nbsp;<strong><span style="color: #ff0000">*</span></strong>Novo Tipo de Leite:</td>
                                <td style="height: 26px">
                                    &nbsp;&nbsp;<anthem:DropDownList ID="cbo_id_item" runat="server" AutoCallBack="True"
                                        ...
                                        ControlToValidate="cbo_id_item" CssClass="texto" ErrorMessage="Preencha o campo Tipo de Leite para continuar."
                                        Font-Bold="True" ToolTip="Tipo de leite deve ser preenchido." ValidationGroup="vg_pesquisar">[!]</asp:RequiredFieldValidator></td>
                            </tr>
							<tr>
