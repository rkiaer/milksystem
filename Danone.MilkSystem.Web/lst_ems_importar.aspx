<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_ems_importar.aspx.vb" Inherits="lst_ems_importar" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Importar EMS&nbsp;</STRONG></TD>
							...
							<TR>
								...
								<TD style="height: 12px; width: 439px;">
                                    <anthem:Label ID="lbl_Aguarde" runat="server" AutoUpdateAfterCallBack="True" Font-Italic="True"
                                        ForeColor="Blue" Text="Aguarde o processo terminar..." UpdateAfterCallBack="True"
