<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_tipo_equipamento.aspx.vb" Inherits="frm_tipo_equipamento" %>
											...
											<TD width="76%">
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <TD width="77%">
                                                            &nbsp;<anthem:TextBox ID="txt_cd_tipo_equipamento" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" MaxLength="10" Width="16%"></anthem:TextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_cd_tipo_equipamento"
													...
													<TR  runat="server">
														...
														<TD width="77%">&nbsp;<anthem:TextBox ID="txt_nm_tipo_equipamento" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" Width="39%" MaxLength="12"></anthem:TextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_nm_tipo_equipamento"
													...
													<TR>
														<TD class="titmodulo" width="25%" colSpan="2"> Parâmetros</TD>
													</TR>
                                                    <tr>
                                                        <TD class="texto" align="right" width="23%">
                                                            <span class="obrigatorio">*</span> <STRONG>Nr. de Eixos:</strong></td>
                                                        <TD width="77%">
                                                            &nbsp;<cc3:OnlyNumbersTextBox ID="txt_nr_eixo" runat="server" CssClass="texto" MaxLength="2"
                                                                Width="40px"></cc3:OnlyNumbersTextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_nr_eixo"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Número de Eixos  para continuar." Font-Bold="True"
                                                                ValidationGroup="vg_salvar" ToolTip="O número de eixos deve ser preenchido." AutoUpdateAfterCallBack="True" InitialValue="1">[!]</anthem:RequiredFieldValidator></td>
                                                    </tr>
													<TR id="TR1"  runat="server">
														<TD class="texto" align="right" width="23%"><span class="obrigatorio">*</span>&nbsp;<STRONG>Custo Fixo KM Mínima (T2):</STRONG></TD>
														<TD width="77%">&nbsp;<cc6:OnlyDecimalTextBox ID="txt_nr_custo_fixo_km_minima" runat="server" CssClass="texto"
                                                                MaxCaracteristica="5" MaxLength="9" Width="60px"></cc6:OnlyDecimalTextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_nr_custo_fixo_km_minima"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Custo Fixo Km Mínima (T2) para continuar." Font-Bold="True"
                                                                ValidationGroup="vg_salvar" ToolTip="O  Custo Fixo Km Mínima (T2) deve ser preenchido.">[!]</anthem:RequiredFieldValidator></TD>
													</TR>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                        </td>
