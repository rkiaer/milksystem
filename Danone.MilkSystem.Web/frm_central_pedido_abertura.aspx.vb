...
Partial Class frm_central_pedido_abertura
    Inherits Page
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            Dim custofinanceiro As New CustoFinanceiro
            custofinanceiro.nr_ano = DateTime.Parse(Now()).ToString("yyyy")
            Dim dscusto As DataSet = custofinanceiro.getDataUltimoCalculoProjetado
            If dscusto.Tables(0).Rows.Count > 0 Then
                lbl_informativo_4.Text = lbl_informativo_4.Text + " " + DateTime.Parse(dscusto.Tables(0).Rows(0).Item("dt_inicio_execucao").ToString).ToString("dd/MM/yyyy")

            Else
                lbl_informativo_4.Text = lbl_informativo_4.Text + " " + (custofinanceiro.nr_ano - 1).ToString
            End If
    ...
    Private Sub loadGridPropriedades()
        Try
            ...
            If (Me.hf_id_produtor.Value.Equals(String.Empty)) Then
                ...
                lbl_informativo_4.Visible = False
            ...
            Else
                ...
                If Me.lbl_acordo_aquisicao_insumos.Text = "Sim" Then
                    ...
                    Else
                        ...
                        lbl_informativo_4.Visible = True
