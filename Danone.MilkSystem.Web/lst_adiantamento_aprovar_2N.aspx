<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_adiantamento_aprovar_2N.aspx.vb" Inherits="lst_adiantamento_aprovar_2N" %>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Adiantamento&nbsp;2.o Nível</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 14px">
                                    ...
                                    <anthem:Label ID="lbl_nm_tecnico" runat="server" AutoUpdateAfterCallBack="True" CssClass="Texto"
                                        Height="16px" UpdateAfterCallBack="True" Visible="False"></anthem:Label><anthem:CustomValidator ID="cv_tecnico" runat="server" AutoUpdateAfterCallBack="True"
                                        ControlToValidate="txt_cd_tecnico" CssClass="texto" ErrorMessage="Técnico não cadastrado."
                                        Font-Bold="True" ValidationGroup="vg_pesquisar">[!]</anthem:CustomValidator></td>
                            </tr>
                            <tr>
				...
				<TR>
					...
					<TD class="faixafiltro1a" style="HEIGHT: 24px" vAlign="middle" background="img/faixa_filro.gif">
					    <table class="faixafiltro1a" >
					        <td width="25%"style="HEIGHT: 24px">&nbsp;&nbsp;<asp:Image ID="img_aprovar" runat="server" ImageUrl="~/img/salvar.gif" /><anthem:linkbutton id="lk_aprovar" runat="server" AutoUpdateAfterCallBack="True" Enabled="False" ValidationGroup="vg_pesquisar">Aprovar </anthem:linkbutton>&nbsp;<asp:Image
                                ID="Image1" runat="server" ImageUrl="~/img/icone_excluir.gif" /><anthem:LinkButton
					        ...
					        <td width="50%" style="HEIGHT: 24px" align=right><anthem:Label ID="lbl_total_adto" runat="server" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Visible="False">Valor Total Adiantamento R$:</anthem:Label></td>
					        <td width="25%" style="HEIGHT: 24px">&nbsp;<anthem:Label ID="lbl_valor_total_adto" runat="server" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Visible="False"></anthem:Label></TD>
...
<asp:CheckBox id="ck_header" runat="server" __designer:wfdid="w20" AutoPostBack="True" OnCheckedChanged="ck_header_CheckedChanged"></asp:CheckBox> 
                                                    ...
                                                    <itemtemplate>
<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w19" OnCheckedChanged="ck_item_CheckedChanged" AutoPostBack="True" Checked='<%# bind("st_selecao") %>'></asp:CheckBox> 
</itemtemplate>
                                                </asp:TemplateField>
