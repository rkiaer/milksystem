...
Imports System.Data
Imports System.Math
Partial Class frm_exportar_esalq_protocolo_excel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If gridResults.Rows.Count.ToString + 1 < 65536 Then
            ...
            Try
                ...
                Dim dsprotocolo As DataSet = protocolo.getAnaliseEsalqProtocoloExportar()
                ...
                Dim lnomearquivo As String = "MilkSystem_Danone_Protocolos_" & protocolo.dt_referencia.ToString & "_" & Now() & ".xls"
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        'atualiza dados da exportacao
                        Dim protocoloesalq As New AnaliseEsalqProtocolo

                        protocoloesalq.id_estabelecimento = ViewState.Item("id_estabelecimento")
                        protocoloesalq.dt_referencia = ViewState.Item("dt_referencia")
                        protocoloesalq.id_tipo_coleta_analise_esalq = ViewState.Item("id_tipo_coleta")
                        protocoloesalq.st_exportacao = ViewState.Item("st_exportacao").ToString
                        protocoloesalq.dt_coleta_ini = ViewState.Item("dt_ini")
                        protocoloesalq.dt_coleta_fim = ViewState.Item("dt_fim")
                        protocoloesalq.id_modificador = Session("id_login")
                        protocoloesalq.nm_arquivo = lnomearquivo
                        protocoloesalq.updateAnaliseEsalqProtocoloExportacao()
                        ...
                        'seta response para excel
                        Response.ContentType = "application/vnd.ms-excel"
                        Response.AddHeader("content-disposition", "attachment;filename=" & lnomearquivo)
