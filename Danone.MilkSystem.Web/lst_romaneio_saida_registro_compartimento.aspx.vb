...
Partial Class lst_romaneio_saida_registro_compartimento
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_romaneio_saida_registro_compartimento.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_romaneio_saida_registro_compartimento.aspx")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("lst_romsaidacomp", txt_id_romaneio.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_romaneio_saida") = customPage.getFilterValue("lst_romsaidacomp", txt_id_romaneio.ID)
            txt_id_romaneio.Text = ViewState.Item("id_romaneio_saida").ToString()
        Else
            ViewState.Item("id_romaneio_saida") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_romsaidacomp", txt_placa.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("ds_placa") = customPage.getFilterValue("lst_romsaidacomp", txt_placa.ID)
            txt_placa.Text = ViewState.Item("ds_placa").ToString()
        Else
            ViewState.Item("ds_placa") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_romsaidacomp", txt_dt_ini.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_ini") = customPage.getFilterValue("lst_romsaidacomp", txt_dt_ini.ID)
            txt_dt_ini.Text = ViewState.Item("dt_ini").ToString()
        Else
            ViewState.Item("dt_ini") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_romsaidacomp", txt_dt_fim.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_fim") = customPage.getFilterValue("lst_romsaidacomp", txt_dt_fim.ID)
            txt_dt_fim.Text = ViewState.Item("dt_fim").ToString()
        Else
            ViewState.Item("dt_fim") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_romsaidacomp", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("lst_romsaidacomp", "PageIndex").ToString()
        ...
        If (hasFilters) Then
            loadData()
            customPage.clearFilters("lst_romsaidacomp")
        Else
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsromaneio As DataSet = romaneio.getRomaneioSaidaAbertoByFilters()
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("lst_romsaidacomp", txt_id_romaneio.ID, ViewState.Item("id_romaneio_saida").ToString)
            customPage.setFilter("lst_romsaidacomp", txt_placa.ID, ViewState.Item("ds_placa").ToString)
            customPage.setFilter("lst_romsaidacomp", txt_dt_ini.ID, ViewState.Item("dt_ini").ToString)
            customPage.setFilter("lst_romsaidacomp", txt_dt_fim.ID, ViewState.Item("dt_fim").ToString)
            customPage.setFilter("lst_romsaidacomp", "PageIndex", gridResults.PageIndex.ToString())
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "selecionar"
                ...
                Response.Redirect("frm_romaneio_saida_compartimento.aspx?id_romaneio_saida=" + e.CommandArgument.ToString)
