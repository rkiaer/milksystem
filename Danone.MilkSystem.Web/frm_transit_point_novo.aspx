<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_transit_point_novo.aspx.vb" Inherits="frm_transit_point_novo" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>Novo Transit Point</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
										...
										<TR>
											<TD width="76%">
												<TABLE id="Table7"  cellSpacing="0" cellPadding="2" width="100%" border="0">
													<TR>
														<TD class="titmodulo" width="25%" colSpan="2" style="height: 15px"> Dados do Transit Point&nbsp;</TD>
													</TR>
													<TR >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 23px">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="cbo_estabelecimento"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Estabelecimento para continuar."
                                                            ...
                                                            <anthem:GridView ID="gridTransitPointCompartimento" runat="server" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Placa">
                                                                        <itemtemplate>
<anthem:TextBox id="txt_placa" runat="server" UpdateAfterCallBack="True" CssClass="texto" AutoUpdateAfterCallBack="True" Width="64px" MaxLength="7" AutoCallBack="True" __designer:wfdid="w42" OnTextChanged="txt_placa_TextChanged"></anthem:TextBox>&nbsp; <anthem:ImageButton id="bt_lupa_veiculo" runat="server" ImageUrl="~/img/lupa.gif" AutoUpdateAfterCallBack="True" Width="15px" ToolTip="Filtrar Veículos" ImageAlign="AbsBottom" Height="15px" BorderStyle="None" __designer:wfdid="w43" CommandName="Lupa"></anthem:ImageButton>&nbsp;<anthem:RequiredFieldValidator id="RequiredFieldValidator7" runat="server" ValidationGroup="vg_salvar" CssClass="texto" Font-Bold="True" ErrorMessage="Preencha o campo Placa para continuar." ControlToValidate="txt_placa" ToolTip="Placa deve ser preenchida." __designer:wfdid="w44">[!]</anthem:RequiredFieldValidator><anthem:CustomValidator id="cmv_placa" runat="server" ValidationGroup="vg_salvar" CssClass="texto" AutoUpdateAfterCallBack="True" Font-Bold="True" ErrorMessage="Placa não cadastrada." ControlToValidate="txt_placa" ToolTip="Placa Não Cadastrada." __designer:wfdid="w45" OnServerValidate="cmv_placa_ServerValidate">[!]</anthem:CustomValidator> 
</itemtemplate>
...
&nbsp;<cc6:OnlyDecimalTextBox id="txt_nr_total_litros" runat="server" CssClass="texto" Width="80px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" __designer:wfdid="w39"></cc6:OnlyDecimalTextBox>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <itemtemplate>
<anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" OnClientClick="if (confirm('Deseja realmente retirar o registro?' )) return true;else return false;" CommandName="delete" __designer:wfdid="w76"></anthem:ImageButton> 
</itemtemplate>
                                                                        <itemstyle horizontalalign="Center" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="id_veiculo" Visible="False">
                                                                        <itemtemplate>
<asp:Label id="lbl_id_veiculo" runat="server" __designer:wfdid="w46"></asp:Label> 
</itemtemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="id_transportador" Visible="False">
                                                                        <itemtemplate>
<asp:Label id="lbl_id_transportador" runat="server" __designer:wfdid="w46"></asp:Label>
</itemtemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="comp_cheio" Visible="False">
                                                                        <itemtemplate>
<asp:Label id="lbl_comp_cheio" runat="server" __designer:wfdid="w84"></asp:Label> 
</itemtemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </anthem:GridView>
