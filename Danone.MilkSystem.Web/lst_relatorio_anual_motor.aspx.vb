...
Partial Class lst_relatorio_anual_motor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_relatorio_anual_motor.aspx")
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            relatorio.relatorio = "extrato_anual"
    ...
    Protected Sub btn_exportar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_exportar.Click
        ...
        Try
            ...
            relatorio.relatorio = "extrato_anual"
            relatorio.descricao = "Extrato Anual do Produtor"
            'relatorio.origem = System.Configuration.ConfigurationManager.AppSettings("PathFiles").ToString() & "\extrato_pagto_anual.rpt"
            'relatorio.origem = System.Configuration.ConfigurationManager.AppSettings("ApplicationServer").ToString() & "\extrato_qualidade.rpt"
            relatorio.origem = System.Configuration.ConfigurationManager.AppSettings("PathReports").ToString() & "extrato_pagto_anual.rpt"  ' 04/01/2010 - Caminho correto aonde estão todas as páginas do site
           relatorio.conteudo = dt_referencia.Text
            ...
            relatorio.insertRelatorioAnualMotor()   ' coloca relatorio na fila
