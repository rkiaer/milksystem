...
Partial Class lst_calculo_produtor
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_calculo_produtor.aspx?st_incluirlog=N")
    ...
    Private Sub insertCalculoProdutor()
        ...
        Try
            ...
            calculoprodutor.insertCalculoProdutor()
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsCalculoProdutor As DataSet = calculoprodutor.getCalculoProdutorByFilters()
    ...
    Private Function saveCheckBox() As Boolean
        ...
        Try
            ...
            For li = 0 To gridResults.Rows.Count - 1
                ...
                End If
                calculoprodutor.updateCalculoProdutor()
            Next
    ...
    Protected Sub lk_calcular_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_calcular.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                Response.Redirect("frm_calculo_produtor.aspx?id_selecao=" + ViewState.Item("id_selecao").ToString + "&id_estabelecimento=" + ViewState.Item("id_estabelecimento").ToString)
            Else
    ...
    Protected Sub ck_header_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            ' 19/11/2008  -  Seleciona tudo o que o botão Pesquisar trouxe - i
            Dim calculoprodutor As New CalculoProdutor
            calculoprodutor.id_selecao = ViewState.Item("id_selecao")
            ...
            Else
                calculoprodutor.st_selecao = "0"
            End If
            calculoprodutor.updateCalculoProdutorTodos()
            ' 19/11/2008  -  Seleciona tudo o que o botão Pesquisar trouxe - f
