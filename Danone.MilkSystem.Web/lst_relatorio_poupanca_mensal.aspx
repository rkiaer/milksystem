<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_relatorio_poupanca_mensal.aspx.vb" Inherits="lst_relatorio_poupanca_mensal" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Relatório Extrato de Poupança Mensal</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
				...
				<TR>
					...
					<TD id="td1" runat="server"><BR>
						<TABLE class="borda" id="Table4" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cbo_referencia_poupanca"
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="U. Produ&#231;&#227;o" Visible="False">
                                                    <itemtemplate>
<asp:Label id="lbl_id_unid_producao" runat="server" __designer:wfdid="w3"></asp:Label> 
</itemtemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Extrato Poupan&#231;a">
                                                    <itemtemplate>
