<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_transvase.aspx.vb" Inherits="frm_transvase" %>
							...
							<TR>
								<TD class="faixafiltro1a" style="WIDTH: 280px; height: 25px;" vAlign="middle" align="left" width="238" background="img/faixa_filro.gif">
                                    ...
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/ico_fechar_romaneio3.gif" /><asp:LinkButton
                                        ID="lk_fechar_transvase" runat="server" OnClientClick="if (confirm('Após fechar o Transvase, nenhuma informação poderá ser alterada e o Transvase ficará disponível para o processo de abertura de Romaneio. Deseja realmente finalizar o Transvase?' )) return true;else return false;"
                                        ValidationGroup="vg_salvar">Fechar Transvase</asp:LinkButton>&nbsp;</TD>
								<TD class="faixafiltro1a" vAlign="middle" align="right" background="img/faixa_filro.gif" colSpan="4" style="height: 25px">
                                    ...
                                    <anthem:LinkButton ID="lk_transitpont_preromaneio" runat="server" AutoUpdateAfterCallBack="True"
                                        CssClass="texto" Font-Size="X-Small">Transvase X Pré-Romaneios</anthem:LinkButton>&nbsp;&nbsp;</TD>
							</TR>
						</TABLE>
					</TD>
					<TD style="width: 12px">&nbsp;</TD>
				...
				<TR>
					...
					<TD vAlign="top" >
						<TABLE id="Table7" cellSpacing=0 cellPadding=2 width="100%" border=0>
							<TR>
								<TD style="HEIGHT: 15px" class="titmodulo" align="left" colSpan="2">Dados do Transvase</TD>
							</TR>
	                        <tr>
                            ...
                            <tr>
                                <TD class="texto" align="right" width="23%" style="height: 22px">
                                    <STRONG>Número Transvase:</strong>
                                </td>
                                <TD class="texto">
                            ...
                            <tr>
                                <TD class="texto" align="right" width="23%" style="height: 22px">
                                    <STRONG>Situação Transvase:</strong>
                                </td>
                                <TD class="texto">
	                        ...
	                        <tr>
	                            <TD class="texto" align=center colspan="2">
                                    <br />
                                    <br />
                                    <anthem:GridView ID="gridtransvaseCompartimento" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                        CellPadding="4" CssClass="texto" DataKeyNames="id_transvase_compartimento" Font-Names="Verdana"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Det.">
                                                <itemtemplate>
<anthem:ImageButton id="btn_detalhe_item" runat="server" ImageUrl="~/img/icon_preview.gif" ToolTip="Visualizar Grupo de Relacionamento" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" CommandName="compcoletas" __designer:wfdid="w57"></anthem:ImageButton> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="ds_placa" HeaderText="Placa" ReadOnly="True" />
                                            <asp:TemplateField HeaderText="Placa Principal">
                                                <edititemtemplate>
<anthem:CheckBox id="chk_st_principal" runat="server" AutoUpdateAfterCallBack="True" __designer:wfdid="w59"></anthem:CheckBox> 
</edititemtemplate>
                                                <itemtemplate>
<anthem:Image id="img_check" runat="server" ImageUrl="~/img/ico_chk_false.gif" AutoUpdateAfterCallBack="True" __designer:wfdid="w58"></anthem:Image> 
</itemtemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ShowHeader="False">
                                                <edititemtemplate>
<asp:ImageButton id="btn_salvarplaca" runat="server" ImageUrl="~/img/icone_gravar.gif" ValidationGroup="vg_salvarplaca" ToolTip="Gravar Lacre" Text="Update" CommandName="Update" __designer:wfdid="w62" CommandArgument='<%# bind("id_transvase_compartimento") %>'></asp:ImageButton> &nbsp;<asp:ImageButton id="btn_cancelar" runat="server" ImageUrl="~/img/icon_undo.gif" ToolTip="Voltar Alteração" Text="Cancel" CommandName="Cancel" __designer:wfdid="w63"></asp:ImageButton> <asp:ValidationSummary id="ValidationSummary2" runat="server" ValidationGroup="vg_salvarcomp" CssClass="texto" ShowSummary="False" ShowMessageBox="True" __designer:wfdid="w64"></asp:ValidationSummary> 
</edititemtemplate>
                                                <itemtemplate>
<asp:ImageButton id="btn_editar" runat="server" ImageUrl="~/img/icone_editar_grid.gif" ToolTip="Editar Compartimento Transit Point" Text="Edit" CommandName="Edit" __designer:wfdid="w60"></asp:ImageButton> &nbsp;<asp:ImageButton id="btn_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" OnClientClick="if (confirm('Deseja realmente excluir este compartimento/Placa?' )) return true;else return false;" ToolTip="Excluir Placa/Compartimento" Text="Edit" CommandName="Delete" __designer:wfdid="w61"></asp:ImageButton> 
</itemtemplate>
                                                <headerstyle width="10%" />
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="id_veiculo" HeaderText="id_veiculo" ReadOnly="True" Visible="False" />
                                            <asp:TemplateField HeaderText="id_transvase_veiculo" Visible="False">
                                                <edititemtemplate>
<asp:Label id="lbl_id_transvase_veiculo" runat="server" Text='<%# Bind("id_transvase_veiculo") %>' __designer:wfdid="w172"></asp:Label> 
</edititemtemplate>
                                                <itemtemplate>
<asp:Label id="lbl_id_transvase_veiculo" runat="server" Text='<%# Bind("id_transvase_veiculo") %>' __designer:wfdid="w171"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="id_transvase_compartimento" Visible="False">
                                                <edititemtemplate>
<asp:Label id="lbl_id_transvase_compartimento" runat="server" Text='<%# Bind("id_transvase_compartimento") %>' __designer:wfdid="w170"></asp:Label> 
</edititemtemplate>
                                                <itemtemplate>
<asp:Label id="lbl_id_transvase_compartimento" runat="server" Text='<%# Bind("id_transvase_compartimento") %>' __designer:wfdid="w169"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="st_principal" Visible="False">
                                                <edititemtemplate>
<asp:Label id="lbl_st_principal" runat="server" Text='<%# Bind("st_principal") %>' __designer:wfdid="w70"></asp:Label> 
</edititemtemplate>
                                                <itemtemplate>
<asp:Label id="lbl_st_principal" runat="server" Text='<%# Bind("st_principal") %>' __designer:wfdid="w69"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="id_transvase" Visible="False">
                                                <edititemtemplate>
&nbsp;<asp:Label id="lbl_id_transvase" runat="server" Text='<%# Bind("id_transvase") %>' __designer:wfdid="w33"></asp:Label> 
</edititemtemplate>
                                                <itemtemplate>
<asp:Label id="lbl_id_transvase" runat="server" Text='<%# Bind("id_transvase") %>' __designer:wfdid="w31"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ds_placa" Visible="False">
                                                <edititemtemplate>
<asp:Label id="lbl_ds_placa" runat="server" Text='<%# Bind("ds_placa") %>' __designer:wfdid="w74"></asp:Label> 
</edititemtemplate>
                                                <itemtemplate>
<asp:Label id="lbl_ds_placa" runat="server" Text='<%# Bind("ds_placa") %>' __designer:wfdid="w73"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    ...
                                    &nbsp;
                                    <anthem:CustomValidator ID="cv_transvasesalvar" runat="server"
                            ...
                            <tr>
                                <TD class="texto" align=center colspan="2">
                                    ...
                                    <anthem:GridView ID="grdColetas" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                        CellPadding="4" CssClass="texto" DataKeyNames="id_transvase_up" Font-Names="Verdana"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ShowHeader="False" Visible="False">
                                                <edititemtemplate>
<asp:ImageButton id="btn_salvar" runat="server" ImageUrl="~/img/icone_gravar.gif" ValidationGroup="vg_lacre" ToolTip="Gravar Lacre" Text="Update" CommandName="Update" __designer:wfdid="w53" CommandArgument='<%# bind("id_transvase_compartimento") %>'></asp:ImageButton>&nbsp;<asp:ImageButton id="btn_cancelar" runat="server" ImageUrl="~/img/icon_undo.gif" ToolTip="Voltar Alteração" Text="Cancel" CommandName="Cancel" __designer:wfdid="w54"></asp:ImageButton> <asp:ValidationSummary id="ValidationSummary2" runat="server" ValidationGroup="vg_salvarplaca" CssClass="texto" ShowSummary="False" ShowMessageBox="True" __designer:wfdid="w55"></asp:ValidationSummary> 
</edititemtemplate>
                                                <itemtemplate>
<asp:ImageButton id="btn_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" OnClientClick="if (confirm('Deseja realmente excluir este compartimento/Placa?' )) return true;else return false;" ToolTip="Excluir Placa/Compartimento" Text="Edit" CommandName="Delete" __designer:wfdid="w52" CommandArgument='<%# bind("id_transvase_up") %>'></asp:ImageButton> 
</itemtemplate>
                                                <headerstyle width="10%" />
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="id_transvase_up" HeaderText="id_transvase_up"
                            ...
                            <tr>
                                <TD style="HEIGHT: 16px" class="titmodulo" align="left" colSpan="2">
                                    Dados das Amostras de Pré-Romaneios Enviadas no Transvase</td>
                            </tr>
                            <tr>
                                <TD class="texto" align=center colspan="2">
                                    <br />
                                    ...
                                    <anthem:GridView ID="gridAmostras" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                        CellPadding="4" CssClass="texto" DataKeyNames="id_pre_romaneio_transvase_amostras" Font-Names="Verdana"
                                        Font-Size="XX-Small" Height="24px" PageSize="100" UpdateAfterCallBack="True"
                                        Width="90%">
                                        <FooterStyle Font-Names="Verdana" Font-Size="XX-Small" />
                                        <HeaderStyle Font-Names="Verdana" Font-Size="XX-Small" HorizontalAlign="Center" />
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nm_situacao_transvase_amostra" HeaderText="Envio Amostra" />
                                            ...
                                            <asp:TemplateField HeaderText="id_situacao_coleta_amostra" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_id_situacao_coleta_amostra" runat="server" Text='<%# Bind("id_situacao_coleta_amostra") %>' __designer:wfdid="w78"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="id_situacao_transvase_amostra" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_id_situacao_transvase_amostra" runat="server" Text='<%# Bind("id_situacao_transvase_amostra") %>' __designer:wfdid="w77"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="id_transvase_registro" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_id_transvase_registro" runat="server" Text='<%# Bind("id_transvase_registro") %>' __designer:wfdid="w76"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </anthem:GridView>
