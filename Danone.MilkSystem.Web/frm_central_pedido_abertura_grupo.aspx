<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_central_pedido_abertura_grupo.aspx.vb" Inherits="frm_central_pedido_abertura_grupo" %>
...
<head id="Head1" runat="server">
 <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
   <title>Abertura Pedido em Grupo</title>
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td class="faixafiltro1" style="background-image: url(img/tab_dim.gif);">
                    <strong>Central de Compras - Abrir Pedido em Grupo</strong></td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                            ...
                            <td class="faixafiltro1a"  align="right" background="img/faixa_filro.gif">
                                ...
                                <anthem:LinkButton ID="lk_email_parceiro_frete" runat="server" AutoUpdateAfterCallBack="True"
                                    ...
                                    &nbsp;<anthem:LinkButton ID="lk_gerar_pedido" runat="server" AutoUpdateAfterCallBack="True"
                                        Style="vertical-align: bottom" ToolTip="Gerar Pedido" ValidationGroup="vg_pedido" OnClick="lk_gerar_pedido_Click">Finalizar Grupo e Gerar Pedido</anthem:LinkButton>
                                &nbsp;&nbsp;</td>
                        </tr>
                    </table>
                </td>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="left" style="width: 13%; font-size: x-small; height: 24px;" >
                                            &nbsp;<anthem:DropDownList id="cbo_estabelecimento" runat="server" CssClass="texto" AutoPostBack="True" Font-Size="X-Small" AutoUpdateAfterCallBack="True"></anthem:DropDownList><asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ValidationGroup="vg_incluircontrato" CssClass="texto" Font-Bold="True" ErrorMessage="Preencha o campo Estabelecimento para continuar." ControlToValidate="cbo_estabelecimento">[!]</asp:RequiredFieldValidator>&nbsp;</td>
                                        <td align="right" style="width: 5%; font-size: x-small; height: 24px;">
                                            Grupo:
                                        </td>
                                        <td align="left" style="width: 6%; height: 24px; font-size: x-small;">
                                            <anthem:Label ID="lbl_nr_contrato" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" BorderStyle="None" Font-Size="X-Small"></anthem:Label></td>
                                        ...
                                        <td align="left" style="height: 24px; width: 15%; font-size: x-small;">
                                            <anthem:TextBox ID="txt_descricao" runat="server" AutoUpdateAfterCallBack="true"
                                                CssClass="texto" Font-Size="X-Small" MaxLength="100" Width="180px"></anthem:TextBox></td>
                                        <td align="right" style="font-size: x-small; width: 5%; height: 24px">
                                            Referência:</td>
                                        <td align="left" style="font-size: x-small; height: 24px">
                                            &nbsp;<cc4:OnlyDateTextBox ID="txt_dt_inicio" runat="server" DateMask="MonthYear"
                                                Width="72px" CssClass="texto"></cc4:OnlyDateTextBox><asp:RequiredFieldValidator
                                                ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_dt_inicio"
                                                CssClass="texto" ErrorMessage="Preencha o campo Período Inicial para continuar."
                                                Font-Bold="False" ValidationGroup="vg_incluircontrato">[!]</asp:RequiredFieldValidator></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="height: 20px; font-size: x-small;" >
                                            ...
                                            <anthem:DropDownList ID="cbo_fornecedor" runat="server" AutoUpdateAfterCallBack="True"
                                                ...
                                                CssClass="Texto" Font-Size="X-Small" Height="16px" 
                                                UpdateAfterCallBack="True"></anthem:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="cbo_fornecedor"
                                        ...
                                        <td align="center" style="font-size: x-small; width: 12%; height: 20px" >
                                            ...
                                            <anthem:Label ID="lbl_frete_parceiro" runat="server" AutoUpdateAfterCallBack="True"
                                                CssClass="Texto" Height="16px"  UpdateAfterCallBack="True">Não</anthem:Label></td>
                                        ...
                                        <td align="right" style="height: 20px; font-size: x-small; width: 14%;" >
                                            ...
                                            <cc6:OnlyDecimalTextBox ID="txt_nr_qtde_total" runat="server" AutoUpdateAfterCallBack="True"
                                                CssClass="texto" DecimalSymbol="," MaxCaracteristica="10" MaxLength="15" MaxMantissa="4" Width="80px" Font-Size="X-Small" style="text-align: right"></cc6:OnlyDecimalTextBox><asp:RequiredFieldValidator
                                        ...
                                        <td align="center" style="height: 20px; font-size: x-small; width: 18%;" >
                                            Qtde Incluída:<anthem:Label ID="lbl_qtde_incluida" runat="server" AutoUpdateAfterCallBack="True"
                        ...
                        <tr>
                            <td class="texto" align="center" colspan="2">
						        <table width="100%" style="font-size: x-small; border-collapse: collapse;" >
                                    <tr>
                                        <td align="right" style="font-size: x-small; width: 10%;"><span style="color: #ff0000">*</span>Item:</td>
                                        <td align="left" style="font-size: x-small;" colspan="3">
                                            ...
                                            <anthem:DropDownList ID="cbo_item" runat="server" AutoUpdateAfterCallBack="True"
                                                ...
                                                UpdateAfterCallBack="True"></anthem:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cbo_item"
                                            ...
                                            <anthem:Label ID="lbl_nm_categoria" runat="server" AutoUpdateAfterCallBack="True"
                                                CssClass="texto" UpdateAfterCallBack="True"></anthem:Label><anthem:CustomValidator ID="cv_validar_inclusao" runat="server" AutoUpdateAfterCallBack="True" ValidationGroup="vg_incluircontrato">[!]</anthem:CustomValidator></td>
                                        <td align="center" style="font-size: x-small">
                                            ...
                                            <cc6:OnlyDecimalTextBox ID="txt_nr_valor_unitario" runat="server"
                                                ...
                                                UpdateAfterCallBack="True" Width="65px" style="text-align: right"></cc6:OnlyDecimalTextBox><asp:RequiredFieldValidator ID="rqf_valor_unitario" runat="server" ControlToValidate="txt_nr_valor_unitario"
                                                CssClass="texto" ErrorMessage="O valor unitário deve ser informado." Font-Bold="False"
                                        ...
                                        <td align="left" style="font-size: x-small; width: 15%">
                                            ...
                                            <cc6:OnlyDecimalTextBox ID="txt_nr_sacaria" runat="server" AutoUpdateAfterCallBack="True"
                                                ...
                                                UpdateAfterCallBack="True" Width="60px" style="text-align: right"></cc6:OnlyDecimalTextBox><anthem:RequiredFieldValidator ID="rfv_sacaria" runat="server" AutoUpdateAfterCallBack="True"
                                                ControlToValidate="txt_nr_sacaria" ErrorMessage="A sacaria deve ser informada."
                                                ToolTip="A sacaria deve ser informada." ValidationGroup="vg_incluircontrato">[!]</anthem:RequiredFieldValidator></td>
                                    </tr>                        
                                </table>
                            </td>
                        </tr>
            ...
            <tr><td style="height: 2px"></td><td style="height: 2px"></td><td style="height: 2px"></td></tr>
            <tr id="tr_incluir_novo_contrato" runat="server" >
                ...
                <td align="center">
                    ...
                    Text="Incluir Novo Grupo de Pedido" ToolTip="Incluir o novo  grupo de pedido." ValidationGroup="vg_incluircontrato" />
                </td><td></td>
            </tr>
			<tr runat="server" id="tr_dados_produtores" >
			    <td></td>
			    <td style="font-size: x-small">                   
					<table width="100%" >
						<tr runat="server" id="tr_produtor_selecione">
							<td style="HEIGHT: 15px; font-size: x-small;" class="titmodulo" align="left" colspan="2">
											Selecione o Produtor</td>
						</tr>
						<tr runat="server" id="tr_produtor_dados">
							<td class="texto" align="left" style="height: 22px" colspan="2">
								<table width="100%" style="font-size: x-small" >
									<tr>
										...
										<td align="center" style="width: 11%; height: 18px">
											...
											<anthem:Label ID="lbl_acordo_aquisicao_insumos" runat="server" CssClass="texto"
												UpdateAfterCallBack="True" Font-Size="X-Small">Não</anthem:Label></td>
									...
									<tr>
										...
										<td style="height: 19px;" align="left" colspan="2">
											&nbsp;<anthem:Label ID="lbl_dt_ini_contrato" runat="server" CssClass="texto" UpdateAfterCallBack="True" Font-Size="X-Small"></anthem:Label>
											&nbsp;à&nbsp;
											<anthem:Label ID="lbl_dt_fim_contrato_sel" runat="server" CssClass="texto" UpdateAfterCallBack="True" Font-Size="X-Small"></anthem:Label></td>
						...
						<tr runat="server" id="tr_produtor_propriedades">
								...
								<anthem:GridView ID="gridPropriedades" runat="server" AutoGenerateColumns="False"
									...
									<Columns>
										<asp:TemplateField ShowHeader="False">
											<itemtemplate>
										<anthem:ImageButton id="imgselecionar" runat="server" ImageUrl="~/img/ico_triangulo_cinza.gif" AutoUpdateAfterCallBack="True" 
										Text="Select" CommandName="Select" CausesValidation="False"></anthem:ImageButton> 
...
<anthem:Label id="lbl_indexgridmatriz" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True"></anthem:Label> 
                        ...
                        <tr><td colspan="2">
                            &nbsp;</td></tr>
						<tr runat="server" id="tr_produtor_incluir" >
				            <td style=" font-size: x-small;" colspan="2" class="texto" align="center" valign="bottom"  >
                                <table style="border-right: silver 1px solid; border-top: silver 1px solid; font-size: x-small;
                                    ...
                                    width="96%">
                                    <tr>
                                        <td style="border-right: silver 1px solid; width: 16%; height: 32px" align="center" >
                                         Qtde Total Prop.:
                                        <cc6:OnlyDecimalTextBox ID="txt_ip_qtde_total_propriedade" runat="server" AutoUpdateAfterCallBack="True"
                                            ...
                                            MaxLength="15" MaxMantissa="4" Width="70px"></cc6:OnlyDecimalTextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_ip_qtde_total_propriedade"
                                            CssClass="texto" ErrorMessage="Quantidade Total para Propriedade deve ser informada." Font-Bold="False" ValidationGroup="vg_adicionarprop" ToolTip="Qtde total do insumo deve ser informada.">[!]</asp:RequiredFieldValidator></td>
                                        <td align="center" style="border-right: silver 1px solid; width: 15%; height: 32px">
                                            Embalagem:
                                        ...
                                        <td style="width: 24%; border-right: silver 1px solid; height: 32px;" align="center">
                                            Parcelar?
                                            ...
                                            <cc3:OnlyNumbersTextBox ID="txt_ip_nr_parcelas" runat="server" AutoCallBack="True"
                                                ...
                                                Width="30px" style="text-align: center"></cc3:OnlyNumbersTextBox><anthem:RequiredFieldValidator ID="rfv_ip_nr_parcelas"
                                                    runat="server" AutoUpdateAfterCallBack="True" ControlToValidate="txt_ip_nr_parcelas" ErrorMessage="O número de parcelas deve ser informado!"
                                                    ToolTip="O número de parcelas deve ser informado!" ValidationGroup="vg_adicionarprop">[!]</anthem:RequiredFieldValidator><anthem:CompareValidator
                                                        ID="cv_ip_nr_parcelas" runat="server" AutoUpdateAfterCallBack="True" ControlToValidate="txt_ip_nr_parcelas" ErrorMessage="O número de parcelas deve ser maio que zero (0)!"
                                                        Operator="GreaterThan" ToolTip="O número de parcelas deve ser maio que zero (0)!"
                                                        Type="Integer" ValidationGroup="vg_adicionarprop" ValueToCompare="0">[!]</anthem:CompareValidator><anthem:RangeValidator
                                                            ID="rv_ip_parcelas" runat="server" AutoUpdateAfterCallBack="True" ControlToValidate="txt_ip_nr_parcelas"
                                                            Enabled="False" MaximumValue="3" MinimumValue="1" Type="Integer" ValidationGroup="vg_adicionarprop">[!]</anthem:RangeValidator></td>
                                        <td style="width: 14%; border-right: silver 1px solid; height: 32px;">
                                            Tipo Frete:
                                        ...
                                        <td style="height: 32px;" align="center">
                                            <anthem:CustomValidator ID="cv_incluirpropriedade" runat="server" AutoUpdateAfterCallBack="True"
                                                ForeColor="White" ValidationGroup="vg_adicionarprop">[!]</anthem:CustomValidator>
                                            <anthem:Button ID="btn_incluirpropriedade" runat="server" AutoUpdateAfterCallBack="True"
                CssClass="texto" Font-Bold="True" Font-Size="X-Small" ForeColor="#003366" Height="24px"
                Text="Incluir Propriedade" ToolTip="Incluir propriedade selecionada ao contrato" ValidationGroup="vg_adicionarprop" /></td>
                                    </tr>
                                </table>
                            ...
                            <tr >
                                <td class="texto" align="center" colspan="2">
                                    &nbsp;<anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                        ...
                                        ShowHeader="False" UpdateAfterCallBack="True" UseAccessibleHeader="False" Width="99%" DataKeyNames="id_central_contrato_propriedade">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <itemtemplate>
<TABLE style="BACKGROUND-IMAGE: url(img/faixa_filro.gif)" cellSpacing=0 cellPadding=0 width="100%"><TBODY><tr style="BACKGROUND-IMAGE: url(img/avisos_topo_barra3.gif); TEXT-TRANSFORM: uppercase; HEIGHT: 19px" class="faixafiltro1"><td style="FONT-SIZE: x-small; WIDTH: 20%; HEIGHT: 20px; TEXT-ALIGN: left" class="faixafiltro1a"><anthem:Label id="lbl_dspropriedade" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="True" UpdateAfterCallBack="True" Text='<%# bind("ds_propriedade") %>'></anthem:Label></td><td style="FONT-SIZE: x-small; WIDTH: 9%; HEIGHT: 20px; TEXT-ALIGN: center" class="faixafiltro1a" align="center"><anthem:Label id="lbl_dsmatriz" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" Text='<%# bind("ds_matriz") %>'></anthem:Label></td><td style="FONT-SIZE: x-small; WIDTH: 15%; HEIGHT: 20px; TEXT-ALIGN: left" class="faixafiltro1a" align=left><anthem:Label id="lbl_cidade" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True" Text='<%# bind("ds_cidade") %>'></anthem:Label></td><td style="FONT-SIZE: x-small; WIDTH: 12%; HEIGHT: 20px; TEXT-ALIGN: center" class="faixafiltro1a" align="center"><anthem:Label id="lbl_limite" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="True" UpdateAfterCallBack="True"></anthem:Label></td><td style="FONT-SIZE: x-small; HEIGHT: 20px" class="faixafiltro1a" align="center"><anthem:ImageButton id="btn_atualizar_totais" onclick="btn_atualizar_totais_Click" runat="server" ImageUrl="~/img/sincronizar.png" ToolTip="Atualizar Totalizadores" AutoUpdateAfterCallBack="true" BorderStyle="None" ImageAlign="AbsBottom" CommandName="atualizartotais"></anthem:ImageButton> <anthem:Label id="lbl_total_item" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True"></anthem:Label> &nbsp; &nbsp;<anthem:Label id="lbl_total_frete" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True"></anthem:Label> &nbsp;&nbsp; <anthem:Label id="lbl_valor_total" runat="server" AutoUpdateAfterCallBack="True" Font-Bold="False" UpdateAfterCallBack="True"></anthem:Label></td><td style="WIDTH: 2%; HEIGHT: 20px" class="faixafiltro1a" align="center"><anthem:ImageButton id="btn_delete" runat="server" ImageUrl="~/img/menos_red.gif" ToolTip="Excluir Propriedade do Grupo (Atenção: todas as alterações não salvas de outras propriedades serão perdidas.)" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" ImageAlign="Baseline" CommandName="delete" OnClientClick="if (confirm('ATENÇÃO: ao prosseguir com esta ação, todas as alterações realizadas em outras propriedades não salvas serão perdidas. Deseja realmente retirar a propriedade do Grupo? ' )) return true;else return false;" CommandArgument='<%# bind("id_central_contrato_propriedade") %>'></anthem:ImageButton></td></tr></TBODY></TABLE><TABLE style="BORDER-RIGHT: silver 1px solid; BORDER-TOP: silver 1px solid; FONT-SIZE: x-small; BORDER-LEFT: silver 1px solid; BORDER-BOTTOM: silver 1px solid; BORDER-COLLAPSE: collapse" width="100%" border=1><TBODY><tr><td style="WIDTH: 6%; HEIGHT: 19px" align=right><SPAN style="COLOR: red">*</SPAN>Embalagem:</td><td style="WIDTH: 9%; HEIGHT: 19px" align=left>&nbsp;<anthem:DropDownList id="cbo_tipo_medida" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True">
                                                <asp:ListItem Value="G">Granel</asp:ListItem>
                                                <asp:ListItem Value="S">Sacaria</asp:ListItem>
                                                <asp:ListItem Value="O">Outros</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="">[Selecione]</asp:ListItem>
                                            </anthem:DropDownList><asp:RequiredFieldValidator id="rqf_tipo_medida" runat="server" ValidationGroup="vg_salvar_inf" CssClass="texto" ControlToValidate="cbo_tipo_medida" ErrorMessage="O tipo de medida deve ser informado." Font-Bold="False">[!]</asp:RequiredFieldValidator></td><td style="WIDTH: 4%; HEIGHT: 19px" align=right><SPAN style="COLOR: red">*</SPAN>Qtde:</td><td style="WIDTH: 9%; HEIGHT: 19px" align=left>&nbsp;<cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_nr_qtde" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Width="60px" MaxLength="15" MaxMantissa="4" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_qtde") %>'></cc6:OnlyDecimalTextBox><asp:RequiredFieldValidator id="rqf_quantidade" runat="server" ValidationGroup="vg_salvar_inf" CssClass="texto" ControlToValidate="txt_nr_qtde" ErrorMessage="A quantidade deve ser informada." Font-Bold="False">[!]</asp:RequiredFieldValidator><asp:CompareValidator id="CompareValidator1" runat="server" ValidationGroup="vg_salvar_inf" CssClass="texto" ControlToValidate="txt_nr_qtde" ErrorMessage="A quantidade deve ser informada." ValueToCompare="0" Type="Double" Operator="GreaterThan">[!]</asp:CompareValidator></td><td style="WIDTH: 5%; HEIGHT: 19px" align=right><SPAN style="COLOR: #ff0000">*</SPAN>Parcelar?</td><td style="WIDTH: 6%; HEIGHT: 19px" align=left><anthem:DropDownList id="cbo_vai_parcelar" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" AutoCallBack="True">
                                                <asp:ListItem Selected="True" Value="N">N&#227;o</asp:ListItem>
                                                <asp:ListItem Value="D">Danone</asp:ListItem>
                                                <asp:ListItem Value="P">Parceiro</asp:ListItem>
                                            </anthem:DropDownList></td><td style="WIDTH: 11%; HEIGHT: 19px" align="center">Parcelas:<cc3:OnlyNumbersTextBox style="TEXT-ALIGN: center" id="txt_nr_parcelas" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Width="20px" MaxLength="2" Text='<%# bind("nr_parcelas") %>' AutoCallBack="True"></cc3:OnlyNumbersTextBox><anthem:RequiredFieldValidator id="rfv_nr_parcelas" runat="server" ValidationGroup="vg_salvar_inf" ToolTip="O número de parcelas deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_parcelas" ErrorMessage="O número de parcelas deve ser informado!" Enabled="False" Display="Dynamic">[!]</anthem:RequiredFieldValidator><anthem:CompareValidator id="cv_nr_parcelas" runat="server" ValidationGroup="vg_salvar_inf" ToolTip="O número de parcelas deve ser maio que zero (0)!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_parcelas" ErrorMessage="O número de parcelas deve ser maio que zero (0)!" ValueToCompare="0" Type="Integer" Operator="GreaterThan" Enabled="False">[!]</anthem:CompareValidator></td><td style="WIDTH: 6%; HEIGHT: 19px" align=right>Tipo Frete:</td><td style="WIDTH: 6%; HEIGHT: 19px" align=left>&nbsp;<anthem:DropDownList id="cbo_tipo_frete" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" AutoCallBack="True" OnSelectedIndexChanged="cbo_tipo_frete_SelectedIndexChanged">
                                                <asp:ListItem Value="C">CIF</asp:ListItem>
                                                <asp:ListItem Value="D">FOB-D</asp:ListItem>
                                                <asp:ListItem Value="I">FOB-I</asp:ListItem>
                                                <asp:ListItem Selected="True">[Selec.]</asp:ListItem>
                                            </anthem:DropDownList></td><td style="HEIGHT: 19px" align="center">Transp.: <anthem:DropDownList id="cbo_transportador" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Enabled="False"></anthem:DropDownList><anthem:RequiredFieldValidator id="rf_transportador" runat="server" ValidationGroup="vg_salvar_inf" ToolTip="O transportador deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="cbo_transportador" ErrorMessage="Preencha o campo Tranportador Central para continuar." InitialValue="0" Enabled="False">[!]</anthem:RequiredFieldValidator></td><td style="WIDTH: 2%; HEIGHT: 19px" align="center"><anthem:ImageButton id="btn_lupa_frete_valor" onclick="btn_lupa_frete_valor_Click" runat="server" ImageUrl="~/img/lupa_desabilitada.gif" ToolTip="Buscar Valores Frete Transportador" AutoUpdateAfterCallBack="true" BorderStyle="None" Width="15px" Height="15px" ImageAlign="AbsBottom" CommandName="Lupa"></anthem:ImageButton></td><td style="WIDTH: 12%; HEIGHT: 19px" align=right>Vl Frete: <cc6:OnlyDecimalTextBox style="TEXT-ALIGN: right" id="txt_nr_frete" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto" UpdateAfterCallBack="True" Width="65px" MaxLength="13" MaxMantissa="2" MaxCaracteristica="10" DecimalSymbol="," Text='<%# bind("nr_valor_frete") %>' AutoCallBack="True" Enabled="False"></cc6:OnlyDecimalTextBox><anthem:RequiredFieldValidator id="rf_frete" runat="server" ValidationGroup="vg_salvar_inf" ToolTip="O valor de frete deve ser informado!" AutoUpdateAfterCallBack="True" ControlToValidate="txt_nr_frete" ErrorMessage="O valor de frete deve ser informado." Enabled="False" Display="Dynamic">[!]</anthem:RequiredFieldValidator></td></tr><tr><td align=right colspan=12>&nbsp;<anthem:Label id="lbl_inf_frete" runat="server" AutoUpdateAfterCallBack="True" Font-Size="9px" Font-Bold="False" UpdateAfterCallBack="True" ForeColor="Red" Font-Italic="True"></anthem:Label> &nbsp; &nbsp;</td></tr></TBODY></TABLE>
</itemtemplate>
                                                <itemstyle width="100%" />
                                            </asp:TemplateField>
...
&nbsp;<asp:Label id="lbl_id_central_tabela_frete_veiculos" runat="server" Text='<%# bind("id_central_tabela_frete_veiculos") %>'></asp:Label> 
                                            ...
                                            <asp:TemplateField HeaderText="id_veiculo_central_compras" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_id_veiculo_central_compras" runat="server"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
...
<asp:Label id="lbl_id_propriedade_grid" runat="server" Text='<%# Bind("id_propriedade") %>'></asp:Label> 
                                            ...
                                            <asp:TemplateField HeaderText="id_propriedade_matriz" Visible="False">
                                                <itemtemplate>
<asp:Label runat="server" Text='<%# Bind("id_propriedade_matriz") %>' id="lbl_id_propriedade_matriz_grid"></asp:Label>
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="id_produtor" Visible="False">
                                                <itemtemplate>
<asp:Label runat="server" Text='<%# Bind("id_produtor") %>' id="lbl_id_produtor_grid"></asp:Label>
</itemtemplate>
                                            </asp:TemplateField>
...
<asp:Label id="lbl_st_parcelamento" runat="server" Text='<%# Bind("st_tipo_parcelamento") %>'></asp:Label> 
                                            ...
                                            <asp:TemplateField HeaderText="dt_fim_contrato" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_dt_fim_contrato" runat="server"></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="lbl_qtde" Visible="False">
                                                <itemtemplate>
<asp:Label id="lbl_qtde" runat="server" Text='<%# bind("nr_qtde") %>'></asp:Label> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="lbl_ds_tipo_frete" Visible="False">
											<itemtemplate>
<asp:Label id="lbl_ds_tipo_frete" runat="server" Text='<%# bind("ds_tipo_frete") %>'></asp:Label> 
                                    ...
                                    <anthem:GridView ID="gridpedidos" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
                                        CellPadding="3" CssClass="texto" Font-Names="Verdana" Font-Size="X-Small" ForeColor="#333333"
                                        PageSize="100" UpdateAfterCallBack="True" Visible="False" Width="98%">
                                        <FooterStyle BackColor="#507CD1" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                                            ForeColor="White" />
                                        <HeaderStyle Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small" HorizontalAlign="Center" />
                                        <EditRowStyle BackColor="#2461BF" />
...
<anthem:HyperLink id="hl_id_pedido" runat="server" ToolTip="Visualizar Pedido" AutoUpdateAfterCallBack="True" CssClass="textohlink" UpdateAfterCallBack="True" Text='<%# bind("id_central_pedido") %>' Target="_blank" Font-Underline="True"></anthem:HyperLink>
                                            ...
                                            <asp:BoundField DataField="ds_tipofrete" HeaderText="Tipo Frete">
                                                <headerstyle horizontalalign="Center" />
                                                <itemstyle horizontalalign="Center" />
                                            </asp:BoundField>
...
<anthem:HyperLink id="hl_id_pedido_frete" runat="server" ToolTip="Visualizar Pedido de Frete" AutoUpdateAfterCallBack="True" CssClass="textohlink" UpdateAfterCallBack="True" Text='<%# bind("id_central_pedido_frete") %>' Target="_blank" Font-Underline="True"></anthem:HyperLink>
                            ...
                            <tr>
                                <td class="texto" align="center" colspan="2">
                                    ...
                                    <anthem:CustomValidator ID="cv_pedido_aprovacao" runat="server" AutoUpdateAfterCallBack="True"
                                        ForeColor="White" ValidationGroup="vg_pedido" Visible="False">[!]</anthem:CustomValidator></td>
                            </tr>
                        <tr><td colspan="2" style="height: 27px" align="center">
                                <anthem:Button ID="btn_salvar_infpedidos" runat="server" AutoUpdateAfterCallBack="True"
                CssClass="texto" Font-Bold="True" Font-Size="X-Small" ForeColor="#003366" Height="24px"
                Text="Salvar Inf. para Pedidos" ToolTip="Salvar  as informações  para geração dos pedidos das propriedades." ValidationGroup="vg_salvar_inf" /></td></tr>
        					<tr>
							<td class="texto" align="center" colspan="2">
								&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
				...
				<anthem:Panel ID="pnl_frete" runat="server" BackColor="White"  HorizontalAlign="Center" Width="100%" AutoUpdateAfterCallBack="True" Visible="False" GroupingText="Tabela de Frete">
                                          <table width="98%">
                            <tr>
...
<asp:ImageButton id="img_selecionar" onclick="img_selecionar_Click" runat="server" ImageUrl="~/img/icon_ok.gif" CommandName="selecionar"></asp:ImageButton>&nbsp; 
                ...
                <tr>
                    <td align="center" class="texto" colspan="2" style="height: 15px">
                    </td>
                </tr>
		</TABLE>
                </td>
            ...
            <cc7:AlertMessages ID="messageControl" runat="server" AutoUpdateAfterCallBack="True"
                UpdateAfterCallBack="True"></cc7:AlertMessages><asp:ValidationSummary ID="vs_abrir_cotacao" runat="server" ShowMessageBox="True"
                ...
                <asp:ValidationSummary ID="vs_incluircontrato" runat="server" ShowMessageBox="True"
                ShowSummary="False" ValidationGroup="vg_incluircontrato" /><asp:ValidationSummary ID="ValidationSummary3" runat="server" ShowMessageBox="True"
                ShowSummary="False" ValidationGroup="vg_adicionarprop" /><asp:ValidationSummary ID="ValidationSummary2" runat="server" ShowMessageBox="True"
