...
Partial Class lst_romaneio_reajuste_valor
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_romaneio_reajuste_valor.aspx?st_incluirlog=N")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_id_romaneio.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_romaneio") = customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_id_romaneio.ID)
        ...
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_placa.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("ds_placa") = customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_placa.ID)
        ...
        ' 21/01/2009 - Rls15 - i
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_nm_linha.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("nm_linha") = customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_nm_linha.ID)
            txt_nm_linha.Text = ViewState.Item("nm_linha").ToString()
        Else
            ViewState.Item("nm_linha") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_dt_transmissao_ini.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_transmissao_ini") = customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_dt_transmissao_ini.ID)
            txt_dt_transmissao_ini.Text = ViewState.Item("dt_transmissao_ini").ToString()
        Else
            ViewState.Item("dt_transmissao_ini") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_dt_transmissao_fim.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_transmissao_fim") = customPage.getFilterValue("lst_romaneio_reajuste_valor", txt_dt_transmissao_fim.ID)
        ...
        If Not (customPage.getFilterValue("lst_romaneio_reajuste_valor", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("lst_romaneio_reajuste_valor", "PageIndex").ToString()
        ...
        If (hasFilters) Then
            loadData()
            customPage.clearFilters("lst_romaneio_reajuste_valor")
        Else
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsromaneio As DataSet = romaneio.getRomaneioReajuste()  ' 21/01/2009 - Rls15 (procedure alterada para novos filtros)
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("lst_romaneio_reajuste_valor", txt_id_romaneio.ID, ViewState.Item("id_romaneio").ToString)
            customPage.setFilter("lst_romaneio_reajuste_valor", txt_placa.ID, ViewState.Item("ds_placa").ToString)
            '21/01/2009 - Rls15 i
            customPage.setFilter("lst_romaneio_reajuste_valor", txt_nm_linha.ID, ViewState.Item("nm_linha").ToString)
            customPage.setFilter("lst_romaneio_reajuste_valor", txt_dt_transmissao_ini.ID, ViewState.Item("dt_transmissao_ini").ToString)
            customPage.setFilter("lst_romaneio_reajuste_valor", txt_dt_transmissao_fim.ID, ViewState.Item("dt_transmissao_fim").ToString)
            '21/01/2009 - Rls15 f
            customPage.setFilter("lst_romaneio_reajuste_valor", "PageIndex", gridResults.PageIndex.ToString())
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "selecionar"
                ...
                Response.Redirect("frm_romaneio_ajuste_valor.aspx?id_romaneio=" + e.CommandArgument.ToString)
