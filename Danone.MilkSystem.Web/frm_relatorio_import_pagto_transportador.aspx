<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_import_pagto_transportador.aspx.vb" Inherits="frm_relatorio_import_pagto_transportador" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Relatório Importação Pagamentos de Frete ao Transportador</title>
            ...
            <table class="texto" width="100%">
                <tr>
                    ...
                    <td align="center" class="texto" colspan="2" style="font-weight: bold; font-size: small;
                        ...
                        RELATÓRIO DE CONSISTÊNCIAS - IMPORTAÇÃO PAGTOS TRANSPORTADOR</td>
                </tr>
                <tr>
                    ...
                    <td align="center" class="texto" colspan="3">
                                                <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False"  CellPadding="4" CssClass="texto" ForeColor="Black" UpdateAfterCallBack="True" UseAccessibleHeader="False" Width="100%" BackColor="White" Height="8px">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ds_data_emissao" HeaderText="Dt Emiss&#227;o" />
                                                        <asp:BoundField DataField="cd_transportador_sap" HeaderText="C&#243;d.SAP" />
