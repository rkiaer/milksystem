...
Partial Class frm_pre_romaneio_tp_consulta
    Inherits Page

    Private customPage As RK.PageTools.CustomPage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_pre_romaneio_tp_consulta.aspx")
    ...
    Private Sub loadData()
        ...
        Try
            ...
            If romaneio.id_st_romaneio = 9 OrElse romaneio.id_st_romaneio = 11 OrElse romaneio.id_st_romaneio = 12 Then
            ...
            Dim transitpointunidade As New TransitPointUnidade(romaneio.id_transit_point_unidade)
            lbl_transit_point_unidade.Text = transitpointunidade.cd_transit_point_unidade.ToString & " - " & transitpointunidade.nm_transit_point_unidade.ToString
            ...
            Dim dstransitpont As DataSet = romaneio.getPreRomaneioETransitPoint()
    ...
    Protected Sub lk_voltar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_voltar.Click
        Response.Redirect("lst_pre_romaneio_tp_consulta.aspx")
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("frm_pre_consulta", "id_romaneio", ViewState.Item("id_romaneio").ToString)
            customPage.setFilter("frm_pre_consulta", "placa_ativa", ViewState.Item("placa_ativa").ToString)
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("frm_pre_consulta", "id_romaneio").Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_romaneio") = customPage.getFilterValue("frm_pre_consulta", "id_romaneio")
        Else
    ...
    Protected Sub lk_Placas_Comp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_Placas_Comp.Click
        saveFilters()
        Response.Redirect("frm_romaneio_consulta_placa.aspx?id_romaneio=" + ViewState.Item("id_romaneio").ToString + "&tela=frm_pre_romaneio_tp_consulta.aspx")
