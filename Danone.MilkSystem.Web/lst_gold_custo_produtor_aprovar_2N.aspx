<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_gold_custo_produtor_aprovar_2N.aspx.vb" Inherits="lst_gold_custo_produtor_aprovar_2N" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Aprovação Custos Produtor GOLD 2.o Nível</title>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Custos Produtor Gold 2.o Nível</STRONG></TD>
...
&nbsp;<asp:CheckBox id="ck_header" runat="server" AutoPostBack="True" OnCheckedChanged="ck_header_CheckedChanged" __designer:wfdid="w5"></asp:CheckBox> 
                                    ...
                                    <itemtemplate>
&nbsp;<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w14" Checked='<%# bind("st_selecao") %>'></asp:CheckBox> 
</itemtemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Custo Total (R$)">
                                    <itemtemplate>
<asp:HyperLink id="hl_nr_custo_operacional_total" runat="server" ForeColor="Blue" __designer:wfdid="w13" Target="_blank" NavigateUrl='<%# Eval("id_gold_custo_produtor", "~/frm_gold_custo_produtor.aspx?id_gold_custo_produtor={0}") %>' Text='<%# Eval("nr_custo_operacional_total") %>'></asp:HyperLink>
</itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Dieta Total (R$)">
                                    <itemtemplate>
<asp:HyperLink id="hl_nr_custo_dieta_total" runat="server" ForeColor="Blue" __designer:wfdid="w15" Target="_blank" NavigateUrl='<%# Eval("id_gold_custo_produtor", "~/frm_gold_custo_produtor_dieta.aspx?id_gold_custo_produtor={0}") %>' Text='<%# Eval("nr_custo_dieta_total") %>'></asp:HyperLink>
</itemtemplate>
                                </asp:TemplateField>
...
<asp:Label id="lbl_ds_anotacao_aprovador" runat="server" Text='<%# Bind("ds_anotacao_aprovador") %>' __designer:wfdid="w3"></asp:Label> 
                                ...
                                <asp:TemplateField Visible="False">
                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" Text="Button" CausesValidation="False" CommandName="selecionar" CommandArgument='<%# bind("id_gold_custo_produtor") %>' ToolTip="Consulta Informações Custo GOLD" __designer:wfdid="w6"></asp:ImageButton> 
</itemtemplate>
                                </asp:TemplateField>
                                            </Columns>
