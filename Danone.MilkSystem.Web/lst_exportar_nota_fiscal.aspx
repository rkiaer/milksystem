<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_nota_fiscal.aspx.vb" Inherits="lst_exportar_nota_fiscal" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Nota Fiscal</STRONG></TD>
					...
					<TD id="td_pesquisa" runat="server" style="height: 133px"><BR>
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
								...
								<TD style="height: 19px; width: 156px;" align="left">
