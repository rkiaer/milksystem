...
Imports System.Data
Imports System.Math
Partial Class frm_relatorio_usuario_grupo_excel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If gridResults.Rows.Count.ToString + 1 < 65536 Then
            ...
            Try
                ...
                Dim dsUsuario As DataSet = usuario.getRelatorioUsuarioGrupos
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" & "MilkSystem_UsuariosGrupos" & ".xls")
                        Response.Charset = ""
