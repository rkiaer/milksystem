<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_faixa_incentivo_fiscal.aspx.vb" Inherits="lst_faixa_incentivo_fiscal" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>lst_faixa_incentivo_fiscal</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Faixa Incentivo Fiscal&nbsp;</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
				...
				<TR>
					...
					<TD id="td_pesquisa" runat="server"><BR>
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD width="20%" style="height: 8px"></TD>
								<TD style="height: 8px; width: 758px;"></TD>
							</TR>
                            <tr>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="nr_incentivo_fiscal" HeaderText="Incentivo Fiscal"
                                                    SortExpression="nr_incentivo_fiscal" />
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" CommandName="edit" CommandArgument='<%# Bind("id_faixa_incentivo_fiscal") %>' __designer:wfdid="w1"></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" AutoUpdateAfterCallBack="True" ImageUrl="~/img/icone_excluir.gif" CommandName="delete" CommandArgument='<%# Bind("id_faixa_incentivo_fiscal") %>' __designer:wfdid="w2" OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;"></anthem:ImageButton> 
</itemtemplate>
