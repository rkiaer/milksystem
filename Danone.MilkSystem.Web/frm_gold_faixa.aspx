							...
							<TR>
								<TD class="faixafiltro1a" style="WIDTH: 265px" vAlign="middle" align="left" width="265"
									...
									<asp:Image ID="img_salvar_footer" runat="server" ImageUrl="~/img/salvar.gif" /><asp:LinkButton
										ID="lk_concluirFooter" runat="server" ValidationGroup="vg_salvar" OnClientClick="if (confirm('Deseja realmente salvar a Faixa? Após salvar, os únicos dados que poderão ser alterados posteriormente são o Nome da Faixa e a Situação')) return true;else return false;">Salvar</asp:LinkButton></TD>
