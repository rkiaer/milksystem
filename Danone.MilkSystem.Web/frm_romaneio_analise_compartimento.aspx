		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); width: 701px;"><STRONG class="texto">Registrar Análise Compartimento &nbsp;</STRONG></TD>
                            ...
                            <table id="Table2" border="0" cellpadding="1" cellspacing="0" width="100%" class="texto" style="height: 8px">
                                ...
                                <tr>
                                    ...
                                    <TD class="texto" align="right" style="width:20%; height: 22px;" >
                                        <STRONG><span style="color: #ff0000">*</span><strong> </strong>Início da Análise:</strong></td>
                                        ...
                                        <cc2:OnlyNumbersTextBox ID="txt_hr_analise" runat="server" CssClass="texto" MaxLength="2"
                                            Width="24px"></cc2:OnlyNumbersTextBox>:<cc2:OnlyNumbersTextBox ID="txt_mm_analise"
                                                runat="server" CssClass="texto" MaxLength="2" Width="24px"></cc2:OnlyNumbersTextBox><asp:RangeValidator
                                                    ...
                                                    ErrorMessage="Preencha as horas do Início da Análise corretamente para continuar."
                                                        ...
                                                        Font-Bold="True" MaximumValue="59" MinimumValue="00" Type="Integer" ValidationGroup="vg_salvar">[!]</asp:RangeValidator><asp:RequiredFieldValidator
                                                            ...
                                                            Font-Bold="True" ToolTip="As horas devem ser preenchidas." ValidationGroup="vg_salvar">[!]</asp:RequiredFieldValidator><asp:RequiredFieldValidator
                                                                ...
                                                                Font-Bold="True" ToolTip="Os minutos devem ser preenchidos." ValidationGroup="vg_salvar">[!]</asp:RequiredFieldValidator><asp:RequiredFieldValidator
                                                                    ...
                                                                    Font-Bold="True" ToolTip="Início da Análise deve ser preenchido." ValidationGroup="vg_salvar">[!]</asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    ...
                                    <TD style="width:29%; height: 4px;" align="left" class="texto" >
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_nm_analista"
                                            CssClass="texto" ErrorMessage="O nome do Analista que está realizando a análise deve ser preenchido."
                                    ...
                                    <TD align="left" class="texto" style="height: 4px" >
                                        <asp:RequiredFieldValidator
                                                                        ...
                                                                        CssClass="texto" ErrorMessage="Preencha o Início da Análise para continuar."
                                                                        Font-Bold="True" ToolTip="Início da Análise deve ser preenchido." ValidationGroup="vg_registrar">[!]</asp:RequiredFieldValidator><asp:RangeValidator
			                    ...
			                    <TR>
                                    ...
                                    <td align="left" class="texto" style="width: 43%; height: 23px" colspan="3" >
                                        ...
                                        <anthem:RequiredFieldValidator ID="rfv_motivo" runat="server" ControlToValidate="txt_ds_motivo_aprovado_sob_concessao"
                                            CssClass="texto" ErrorMessage="A justificativa da Aprovação Sob Concessão deve ser preenchida." Font-Bold="True" ValidationGroup="vg_registrar" Visible="False" AutoUpdateAfterCallBack="True" ToolTip="Justificativa da Aprovação Sob Concessão deve ser preenchida.">[!]</anthem:RequiredFieldValidator></td>
			                    </TR>
                                <tr>
                                    ...
                                    <td align="center" class="texto" style="height: 22px" colspan="2">
                                        <anthem:ImageButton ID="btn_registrar" runat="server" CssClass="texto" ImageUrl="~/img/bnt_registrar.gif"
                                            ValidationGroup="vg_registrar" OnClientClick="if (confirm('Ao registrar o resultado para o Compartimento, as análises referentes à ele não poderão mais sofrer alterações. Deseja realmente prosseguir?' )) return true;else return false;" AutoUpdateAfterCallBack="True" /></td>
                                    <td align="right" class="texto" style="width: 22%; height: 22px">
                                        <anthem:Image ID="img_novo" runat="server" ImageUrl="~/img/ic_impressao.gif" AutoUpdateAfterCallBack="True" ToolTip="Imprimir Relatório" />
                                        <anthem:HyperLink
                                            ID="hl_imprimir_ciq" runat="server" CssClass="texto" Enabled="False" NavigateUrl="~/frm_relatorio_CIQ.aspx"
                                            Style="text-align: center" Target="_blank" Width="120px" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True">Relatório  CIQ.    Versão para Imprimir</anthem:HyperLink></td>
