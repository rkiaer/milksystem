...
Partial Class lst_coopera_importar
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_coopera_importar.aspx")
    ...
    Private Sub importData()
        ...
        Try
            ...
            ViewState.Item("id_importacao") = importacao.importCoopera()
