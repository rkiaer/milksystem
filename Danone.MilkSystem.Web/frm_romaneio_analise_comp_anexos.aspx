<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_romaneio_analise_comp_anexos.aspx.vb" Inherits="frm_romaneio_analise_comp_anexos" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Romaneio Análises Compartimento - Anexar Documentos</title>
			...
			<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif); width: 98%;">
                        Romaneio Análise dos Compartimentos - Anexar Documentos</TD>
					<TD style="width: 1%">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 1%; " ></TD>
                                                ...
                                                <tr>
                                                    <td align="center" class="texto" colspan="8">
                                                        <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False"
                                                            AutoUpdateAfterCallBack="True" CellPadding="4" CssClass="texto" DataKeyNames="id_romaneio_analise_anexo"
...
&nbsp;&nbsp; 
                                                                    ...
                                                                    <itemtemplate>
&nbsp;<asp:Label id="lbl_nm_documento" runat="server" CssClass="texto" Text='<%# Bind("nm_documento") %>' __designer:wfdid="w75"></asp:Label> 
</itemtemplate>
                                                                </asp:TemplateField>
...
<asp:HyperLink id="hl_download" runat="server" ForeColor="Blue" Font-Underline="True" __designer:wfdid="w58">Clique aqui para fazer o download</asp:HyperLink> 
                                                                ...
                                                                <asp:TemplateField ShowHeader="False">
                                                                    <edititemtemplate>
<asp:ImageButton id="btn_salvar" runat="server" ImageUrl="~/img/icone_gravar.gif" CausesValidation="True" ValidationGroup="vg_grid" Text="Update" CommandName="Update" __designer:wfdid="w78"></asp:ImageButton>&nbsp;<asp:ImageButton id="btn_voltar" runat="server" ImageUrl="~/img/icon_undo.gif" CausesValidation="False" Text="Cancel" CommandName="Cancel" __designer:wfdid="w79"></asp:ImageButton> <asp:ValidationSummary id="validatorSummary" runat="server" ValidationGroup="vg_grid" ShowSummary="False" ShowMessageBox="True" __designer:wfdid="w80"></asp:ValidationSummary> 
</edititemtemplate>
                                                                    <itemtemplate>
<asp:ImageButton id="btn_editar" runat="server" ImageUrl="~/img/icone_editar_grid.gif" CausesValidation="False" Text="Edit" Visible="False" CommandName="Edit" __designer:wfdid="w76"></asp:ImageButton> <anthem:ImageButton id="btn_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" AutoUpdateAfterCallBack="True" CommandName="delete" CommandArgument='<%# Bind("id_romaneio_analise_anexo") %>' OnClientClick="if (confirm('Deseja realmente excluir este registro?' )) return true;else return false;" ImageAlign="Baseline" ToolTip="Excluir Anexo Pedido" __designer:wfdid="w77"></anthem:ImageButton> 
</itemtemplate>
                                                                    <itemstyle horizontalalign="Center" />
                                                                </asp:TemplateField>
...
&nbsp;
                                                                    ...
                                                                    <itemtemplate>
<asp:Label id="lbl_id_analise" runat="server" Text='<%# Bind("id_analise") %>' __designer:wfdid="w60"></asp:Label> 
</itemtemplate>
                                                                </asp:TemplateField>
