<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_romaneio_analise_comp_veiculo.aspx.vb" Inherits="frm_romaneio_analise_comp_veiculo" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Romaneio - Registrar Análise dos Compartimentos do Veículo</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif);"><STRONG>Registrar Análise dos Compartimentos</STRONG></TD>
				...
				<TR>
					<TD style="width: 5px; ">&nbsp;</TD>
					<TD class="texto">
                        <asp:Panel ID="Panel1" runat="server" BackColor="White" Font-Bold="False"  Width="100%" Font-Size="X-Small" CssClass="texto" GroupingText="Dados Romaneio">
						<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%">
                            <tr>
                                <td align="right" class="texto" style="width: 19%; height: 20px"><strong>Nr. Romaneio:</strong></td>
                                ...
                                <td align="right" class="texto" style="height: 20px; width: 18%;">
                                    <strong>Situação Romaneio:</strong></td>
                            ...
                            <tr id="tr_temporota" runat="server">
                                ...
                                <td align="left" style="height: 20px" colspan="3">
                            ...
                            <tr>
                                ...
                                <td align="right" class="texto" >
                                    <strong>Re-Análise:</strong></td>
                                <td align="left" class="texto">
                                    &nbsp;<asp:Label ID="lbl_reanalise" runat="server" CssClass="texto" style="vertical-align: super"></asp:Label><asp:CustomValidator ID="cv_reanalise_obrigatorias"
                                        runat="server" CssClass="texto" ErrorMessage="CustomValidator" ForeColor="White"
                                        ValidationGroup="vg_reanalise">[!]</asp:CustomValidator><anthem:ImageButton ID="btn_reanalise" runat="server" AutoUpdateAfterCallBack="True"
                                        CssClass="texto"  ImageUrl="~/img/btn_gerar_reanalise.gif" OnClientClick="if (confirm('Este processo substitui todas as análises existentes no Romaneio por novas a serem avaliadas. Deseja realmente prosseguir com a Re-Análise?' )) return true;else return false;"
                                        ValidationGroup="vg_reanalise" /></td>
                            </tr>
						</TABLE>
                        </asp:Panel>
					</TD>
                                ...
                                <anthem:GridView ID="grdCompartimentos" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Re-An&#225;lise">
                                            <itemtemplate>
<asp:Image id="img_reanalise" runat="server" ImageUrl="~/img/ico_chk_false.gif" __designer:wfdid="w103"></asp:Image> 
</itemtemplate>
...
&nbsp; 
                                            ...
                                            <itemtemplate>
<anthem:DropDownList id="cbo_registrar_id_st_analise" runat="server" CssClass="texto" AutoUpdateAfterCallBack="True" AutoCallBack="True" Visible="False" __designer:wfdid="w104" OnSelectedIndexChanged="cbo_registrar_id_st_analise_SelectedIndexChanged"></anthem:DropDownList>&nbsp; <asp:Label id="lbl_st_registro" runat="server" CssClass="texto" Text='<%# bind("nm_st_analise") %>' Visible="False" __designer:wfdid="w105"></asp:Label>&nbsp; <anthem:Label id="lbl_labelmotivo" __designer:dtid="1970350606778452" runat="server" CssClass="texto" Font-Bold="True" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Visible="False" __designer:wfdid="w106">Justificativa:</anthem:Label><anthem:TextBox id="txt_ds_motivo_aprovado_sob_concessao" __designer:dtid="1970350606778454" runat="server" CssClass="texto" Width="280px" MaxLength="150" AutoUpdateAfterCallBack="True" Visible="False" __designer:wfdid="w107" Rows="2"></anthem:TextBox> 
</itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="CIQ">
                                            <edititemtemplate>
&nbsp; 
</edititemtemplate>
                                            <itemtemplate>
...
<asp:ImageButton id="btn_registrar_analise_uproducao" runat="server" ImageUrl="~/img/icon_registrar_desabilitado.gif" ToolTip="Registrar Análise Unid. Produção / Produtor" __designer:wfdid="w127" CommandArgument='<%# Bind("id_romaneio_compartimento") %>' Enabled="False" CommandName="Registrar_Analise_UProducao"></asp:ImageButton> 
                                        ...
                                        <asp:TemplateField HeaderText="id_st_analise" Visible="False">
                                            <edititemtemplate>
<asp:Label id="lbl_id_st_analise" runat="server" __designer:wfdid="w130" Text='<%# Bind("id_st_analise") %>'></asp:Label> <asp:Label id="lbl_nm_st_analise" runat="server" __designer:wfdid="w131" Text='<%# Bind("nm_st_analise") %>'></asp:Label> 
</edititemtemplate>
                                            <itemtemplate>
				...
				<TR>
					...
					<TD class="texto">
						...
						<TABLE id="Table5" cellSpacing="0" cellPadding="2" width="100%" class="texto">
                            ...
                            <tr>
                                <td align="right" class="texto" style="height: 10px">
                                </td>
                                <td align="left" style="height: 10px">
                                </td>
                                <td align="right" class="texto" style="height: 10px">
                                </td>
                                <td align="left" class="texto" style="height: 10px">
                                </td>
                            </tr>
                            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                ...
                                                <itemtemplate>
<cc3:OnlyNumbersTextBox id="txt_int_nr_valor" runat="server" CssClass="texto" Width="56px" Text='<%# Bind("nr_valor") %>' Visible="False" __designer:wfdid="w62"></cc3:OnlyNumbersTextBox>&nbsp;<asp:RequiredFieldValidator id="rfv_txt_int_nr_valor" runat="server" ValidationGroup="vg_salvar" ToolTip="Valor obrigatório" CssClass="texto" Font-Bold="False" ErrorMessage="O valor para análise deve ser preenchido!" ControlToValidate="txt_int_nr_valor" Visible="False" __designer:wfdid="w63">!</asp:RequiredFieldValidator><cc6:OnlyDecimalTextBox id="txt_dec_nr_valor" runat="server" CssClass="texto" Width="56px" MaxLength="15" AutoUpdateAfterCallBack="True" Text='<%# Bind("nr_valor") %>' __designer:wfdid="w64" MaxMantissa="2"></cc6:OnlyDecimalTextBox>&nbsp;<asp:RequiredFieldValidator id="rfv_txt_dec_nr_valor" runat="server" ValidationGroup="vg_salvar" ToolTip="Valor obrigatório!" Font-Bold="False" ErrorMessage="O valor para análise deve ser preenchido!" ControlToValidate="txt_dec_nr_valor" Visible="False" __designer:wfdid="w65">!</asp:RequiredFieldValidator><anthem:DropDownList id="cbo_nr_valor" runat="server" CssClass="texto" Visible="False" __designer:wfdid="w66"></anthem:DropDownList>&nbsp;<asp:RequiredFieldValidator id="rfv_cbo_nr_valor" runat="server" ValidationGroup="vg_salvar" ToolTip="Valor obrigatório" Font-Bold="False" ErrorMessage="O valor da análise deve ser preenchido." ControlToValidate="cbo_nr_valor" Visible="False" __designer:wfdid="w67">!</asp:RequiredFieldValidator><asp:Label id="lbl_nr_valor" runat="server" Text='<%# Bind("nr_valor") %>' Visible="False" __designer:wfdid="w68"></asp:Label> <asp:Label id="lbl_nm_valor" runat="server" Text='<%# Bind("nm_analise_logica") %>' Visible="False" __designer:wfdid="w69"></asp:Label> 
</itemtemplate>
                                                <itemstyle width="20%" />
                                            </asp:TemplateField>
...
&nbsp; 
                                                ...
                                                <itemtemplate>
<asp:Label id="lbl_ds_comentario" runat="server" CssClass="texto" Width="248px" Text='<%# bind("ds_comentario") %>' Visible="False" __designer:wfdid="w70"></asp:Label>&nbsp; <anthem:TextBox id="txt_ds_comentario" runat="server" CssClass="texto" Width="248px" MaxLength="50" Visible="False" __designer:wfdid="w71"></anthem:TextBox>&nbsp; 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Situa&#231;&#227;o">
                                                <edititemtemplate>
...
<asp:Label id="lbl_id_st_analise_compartimento" runat="server" __designer:wfdid="w76" Text='<%# Bind("id_st_analise_compartimento") %>'></asp:Label>
                            ...
                            <anthem:Label ID="lbl_analise_anexo" runat="server" AutoUpdateAfterCallBack="True"
                                Font-Bold="False" Font-Italic="True" ForeColor="Red" Text="* ANÁLISE OBRIGA ANEXAR DOCUMENTO COMO COMPROVANTE"
                                UpdateAfterCallBack="True" Visible="False"></anthem:Label><anthem:Label ID="lbl_analise_fora" runat="server" AutoUpdateAfterCallBack="True"
                                Font-Bold="True" Font-Italic="True" ForeColor="Red" Text="* ANÁLISE DIGITADA FORA DA FAIXA REFERENCIAL. SE DIGITAÇÃO CORRETA PROSSIGA COM SALVAR."
                                UpdateAfterCallBack="True" Visible="False" BackColor="Yellow"></anthem:Label>         
                            <asp:CustomValidator ID="cv_verificar_resultado" runat="server" CssClass="texto"
                                ErrorMessage="CustomValidator" ForeColor="White" ValidationGroup="vg_salvar">[!]</asp:CustomValidator></asp:Panel>
					</TD>
				    <TD style="width: 16px" ></TD>
				</TR>
				<TR>
				    <TD  style="width: 5px; height: 30px;"></TD>
					<TD style="height: 30px;" class="texto">
