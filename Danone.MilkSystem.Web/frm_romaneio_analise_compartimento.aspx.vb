...
Partial Class frm_romaneio_analise_compartimento
    ...
    '            lk_registrar_analise.Text = "Registrar Análise de Compartimento Negativa"
    ...
    '            lk_registrar_analise.Text = "Registrar Análise de Compartimento Positiva"
    ...
    Protected Sub btn_email_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_email.Click
        If Page.IsValid = True Then
            Try
                ...
                Dim lAssunto As String = "RELATÓRIO CIQ " & ViewState.Item("id_romaneio_compartimento").ToString
                'Dim lCorpo As String = "Existe uma ocorrência relatada através do Relatório CIQ, que pode ser visualizado pelo link http://localhost:56946/Danone.MilkSystem.Web/frm_relatorio_CIQ.aspx?id_romaneio_compartimento=" & ViewState.Item("id_romaneio_compartimento").ToString & " ."
                Dim lCorpo As String = "Existe uma ocorrência relatada através do Relatório CIQ, que pode ser visualizado pelo link " & ViewState.Item("caminho_servidor") & "/frm_relatorio_CIQ.aspx?id_romaneio_compartimento=" & ViewState.Item("id_romaneio_compartimento").ToString & " ."
