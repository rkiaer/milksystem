...
Partial Class frm_romaneio_saida_analise_comp_anexos
    Inherits Page

    Private customPage As RK.PageTools.CustomPage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_romaneio_saida_analise_comp_anexos.aspx")
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            If Not (Request("id") Is Nothing) Then
                ...
                Dim dsanalise As DataSet = companalise.getRomaneioSaidaAnaliseCompartimentoDistinct
    ...
    Private Sub loadData()
        Try
            ...
            If dsromaneio.Tables(0).Rows.Count > 0 Then
                With dsromaneio.Tables(0).Rows(0)
                    If Not IsDBNull(.Item("id_cooperativa")) AndAlso .Item("id_cooperativa") > 0 Then
                        ...
                        Dim ds_analise As DataSet = romaneio.getRomaneioSaidaAnaliseCompartimentoDistinct
                    ...
                    lbl_id_romaneio.Text = .Item("id_romaneio_saida").ToString
                    Me.lbl_nm_st_romaneio.Text = .Item("nm_situacao_romaneio_saida").ToString
            ...
            Dim dsdocumentos As DataSet = anexo.getRomaneioSaidaAnaliseAnexo()
            ...
            Select Case CInt(ViewState.Item("id_situacao_romaneio_saida"))
                Case 3, 4, 5
    ...
    And e.Row.RowType <> DataControlRowType.Pager) Then
            ...
            If CLng(ViewState.Item("analise102coop")) > 0 Then 'se é cooperativa e tem analise 102 que obriga docto
                If lbl_cd_analise.Text = "102" AndAlso CInt(ViewState.Item("id_situacao_romaneio_saida")) = 9 Then 'se o grid é analise 102
    ...
    Private Sub AnexarDocumento(ByVal pext As String, ByVal inputStream As Stream, ByVal contentlength As Integer, ByVal contentType As String, ByVal filename As String)
        Try
            ...
            sqlcmd.CommandText = "ms_insertRomaneioSaidaAnaliseAnexo"
            sqlcmd.Connection = con

            Dim sqlparam As New SqlParameter("@id_romaneio_saida", SqlDbType.Int)
            sqlparam.Value = Convert.ToInt32(ViewState.Item("id_romaneio_saida").ToString)
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "delete"
                deleteRomaneioSaidaAnaliseAnexo(Convert.ToInt32(e.CommandArgument.ToString()))

        End Select

    End Sub
    Private Sub deleteRomaneioSaidaAnaliseAnexo(ByVal id_romaneio_analise_anexo As Integer)
        Try
            Dim romaneioanexo As New RomaneioSaidaAnaliseAnexo

            romaneioanexo.id_romaneio_saida_analise_anexo = id_romaneio_analise_anexo
            romaneioanexo.id_modificador = Convert.ToInt32(Me.Session("id_login"))
            romaneioanexo.deleteRomaneioSaidaAnaliseAnexo()
