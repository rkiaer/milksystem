<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_calculo_produtor.aspx.vb" Inherits="lst_calculo_produtor" %>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Cálculo ao Produtor</STRONG></TD>
                            ...
                            <tr>
                                ...
                                <TD style="HEIGHT: 20px">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="cbo_estabelecimento" ErrorMessage="O estabelecimento deve ser informado!" Operator="NotEqual"
                                         Type="Integer" ValueToCompare="0" Display="Dynamic" ValidationGroup="gv_estabel">[!]</asp:CompareValidator></td>
                            </tr>
			                <tr>
					...
					<TD>
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <headertemplate>
<asp:CheckBox id="ck_header" runat="server" __designer:wfdid="w21" OnCheckedChanged="ck_header_CheckedChanged" AutoPostBack="True"></asp:CheckBox> 
</headertemplate>
                                    <itemtemplate>
<asp:CheckBox id="ck_item" runat="server" Checked='<%# bind("st_selecao") %>' __designer:wfdid="w31"></asp:CheckBox> 
</itemtemplate>
                                </asp:TemplateField>
