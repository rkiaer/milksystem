...
Partial Class lst_importar_pedido
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_importar_pedido.aspx")
    ...
    Private Sub loadData()
        Try
            ...
            Dim dsimportacaolog As DataSet = importacao.getImportacaoPedidoByFilters()
            ...
            Me.hl_imprimir.NavigateUrl = String.Format("frm_relatorio_import_pedido.aspx?id_importacao={0}", ViewState.Item("id_importacao").ToString)
    ...
    Private Sub importData()
        ...
        Try
            ...
            ViewState.Item("id_importacao") = importacao.importPedido
