...
Partial Class lst_exportar_descontos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_exportar_descontos.aspx")
    ...
    Private Sub exportData()
        ...
        Try
            ...
            fichafinanceira.exportDescontosProdutor()
