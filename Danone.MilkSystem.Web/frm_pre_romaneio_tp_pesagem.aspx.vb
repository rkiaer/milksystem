...
Partial Class frm_pre_romaneio_tp_pesagem
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_pre_romaneio_tp_pesagem.aspx")
        If Not Page.IsPostBack Then
            'fran 07/2022 transvase
            If Not Request("id") Is Nothing Then
                ViewState.Item("menu") = "transvase"
                lbl_titulo.Text = "Atualizar Pesagem Pré-Romaneio para Transvase"
                lbl_unidade.Visible = False
                lbl_transit_point_unidade.Visible = False
            Else
                ViewState.Item("menu") = "transitpoint"
                lbl_titulo.Text = "Atualizar Pesagem Pré-Romaneio para Transit Point"
    ...
    Private Sub updatePesagemFinal()
        If Page.IsValid Then
            Try
                ...
                romaneio.updateRomaneioPesagemFinal()  ' 
    ...
    Private Sub updatePesagemInicial()
        If Page.IsValid Then
            Try
                ...
                romaneio.id_romaneio = Convert.ToInt32(ViewState.Item("id_romaneio"))
                romaneio.id_modificador = Session("id_login")
                romaneio.updateRomaneioPesagemInicial()  ' 
    ...
    Protected Sub lk_voltar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_voltar.Click
        'Response.Redirect("lst_pre_romaneio_tp_pesagem.aspx")
        'fran 07/2022
        If ViewState.Item("menu") = "transitpoint" Then
            Response.Redirect("lst_pre_romaneio_tp_pesagem.aspx")

        Else
            Response.Redirect("lst_pre_romaneio_tp_pesagem.aspx?id=2")
