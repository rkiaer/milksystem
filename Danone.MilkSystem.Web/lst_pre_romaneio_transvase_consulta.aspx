<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_pre_romaneio_transvase_consulta.aspx.vb" Inherits="lst_pre_romaneio_transvase_consulta" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Consultar Pré-Romaneios para Transvase</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;"><STRONG>Consultar Pré-Romaneio para Transvase</STRONG></TD>
