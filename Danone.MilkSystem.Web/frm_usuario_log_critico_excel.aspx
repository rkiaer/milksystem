<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_usuario_log_critico_excel.aspx.vb" Inherits="frm_usuario_log_critico_excel" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Usuário - LOG Críticos</title>
</head>
    ...
    <div>
        <anthem:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nm_erro" HeaderText="Erro" >
                </asp:BoundField>
            </Columns>
