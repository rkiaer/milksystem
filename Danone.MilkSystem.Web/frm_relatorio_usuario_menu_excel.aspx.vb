...
Imports System.Data
Imports System.Math
Partial Class frm_relatorio_usuario_menu_excel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If gridResults.Rows.Count.ToString + 1 < 65536 Then
            ...
            Try
                ...
                Dim usuario As New UsuarioGrupo
                ...
                End If
                usuario.id_grupo = Convert.ToInt32(ViewState.Item("id_grupo").ToString())
                usuario.id_menu = Convert.ToInt32(ViewState.Item("id_menu").ToString())
                usuario.id_menu_item = Convert.ToInt32(ViewState.Item("id_menu_item").ToString())

                Dim dsUsuario As DataSet = usuario.getRelatorioUsuarioGruposMenus
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" & "MilkSystem_UsuariosMenus" & ".xls")
                        Response.Charset = ""
