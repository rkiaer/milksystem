...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Romaneio Saída Análises Compartimento - Anexar Documentos</title>
			...
			<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif); width: 98%;">
                        Romaneio Saída - Análise dos Compartimentos - Anexar Documentos</TD>
					<TD style="width: 1%">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 1%; " ></TD>
				...
				<tr runat="server" id="tr_interrupcao" >
				    ...
				    <td class="texto">
						<TABLE id="Table8" cellSpacing="0" cellPadding="2" width="100%" class="texto">
							<TR>
								<TD class="titmodulo"  colSpan="6" style="height: 10px"> Dados do Romaneio de Saída</TD>
							</TR>
                            <tr>
