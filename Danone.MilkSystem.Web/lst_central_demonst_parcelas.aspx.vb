...
Partial Class lst_central_demonst_parcelas
    Inherits Page
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_central_demonst_parcelas.aspx?st_incluirlog=N")
    ...
    Protected Sub gridResults_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridResults.RowDataBound
        ...
        If (e.Row.RowType <> DataControlRowType.Header _
           ...
           And e.Row.RowType <> DataControlRowType.Pager) Then
            ...
            Dim img_calculo As Anthem.Image = CType(e.Row.FindControl("img_calculo"), Anthem.Image)
            ...
            Else
                ...
                If lbl_calculo.Text.Equals(String.Empty) Then
                    img_calculo.ImageUrl = "~/img/ico_chk_false.gif"
                Else
                    img_calculo.ImageUrl = "~/img/ico_chk_true.gif"
                End If
    ...
    Protected Sub cv_exportar_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cv_exportar.ServerValidate
        Try
            ...
            If txt_dt_pagto.Text.Equals(String.Empty) And txt_dt_referencia.Text.Equals(String.Empty) Then
                args.IsValid = False
                lmsg = "O campo 'Data de Pagamento' ou o campo 'Mês/Ano Referência Pagamento' deve ser informado!"
            End If

            If (Not txt_dt_pagto.Text.Equals(String.Empty)) And (Not txt_dt_referencia.Text.Equals(String.Empty)) Then
                args.IsValid = False
