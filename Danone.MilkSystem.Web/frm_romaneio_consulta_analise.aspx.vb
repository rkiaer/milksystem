...
Partial Class frm_romaneio_consulta_analise
    Inherits Page
    ...
    Private Sub loadData()
        ...
        Try
            ...
            If romaneio.id_transit_point_unidade > 0 Then
                lbl_titulo.Text = "Consulta do Pré-Romaneio para Transit Point - Análises do Compartimento"
            ...
            If romaneio_compartimento.st_reanalise = "S" Then
                ...
                If (dsreanalisecomp.Tables(0).Rows.Count > 0) Then
                    ...
                    Dim comand2 As CommandField = CType(gridreanalise.Columns.Item(8), CommandField)
                    comand2.ShowEditButton = False
    ...
    Protected Sub lk_voltar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_voltar.Click
        Response.Redirect("frm_romaneio_consulta_placa.aspx")
    ...
    Protected Sub lk_Analise_Uproducao_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_Analise_Uproducao.Click
        Response.Redirect("frm_romaneio_consulta_analise_uproducao.aspx?id_romaneio_compartimento=" + ViewState.Item("id_romaneio_compartimento").ToString)
    End Sub
End Class
