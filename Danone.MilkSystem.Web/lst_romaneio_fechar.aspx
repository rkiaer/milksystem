<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_romaneio_fechar.aspx.vb" Inherits="lst_romaneio_fechar" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;"><STRONG>Romaneio Fechar</STRONG></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    ...
                                    <cc3:OnlyDateTextBox ID="txt_dt_transmissao_ini" runat="server" CssClass="texto"
                                        Width="96px"></cc3:OnlyDateTextBox>&nbsp; à &nbsp;<cc3:OnlyDateTextBox ID="txt_dt_transmissao_fim"
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" Text="Button" CommandArgument='<%# bind("id_romaneio") %>' __designer:wfdid="w210" CommandName="selecionar" CausesValidation="False"></asp:ImageButton> 
</itemtemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </anthem:GridView>
