<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_romaneio_saida_pesagem_balanca.aspx.vb" Inherits="frm_romaneio_saida_pesagem_balanca" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>Romaneio Saida - Pesagem</title>
					    ...
					    <TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
						    <TR>
								...
								<TD class="texto" valign="top" >
                                    <asp:Panel ID="Panel2" runat="server" BackColor="White" CssClass="texto" Font-Bold="False"
                                        Font-Size="X-Small" GroupingText="Dados do Romaneio de Saída" HorizontalAlign="Center" Width="100%">
                                        <table id="Table3" border="0" cellpadding="1" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="texto" style="width: 18%; height: 20px">
                                                    <strong><span style="color: #000000"> Tipo Leite:</span></strong></td>
                                                <td align="left" style="width: 33%; height: 20px">
                                                    &nbsp;<asp:Label ID="lbl_tipoleite" runat="server" CssClass="texto"></asp:Label>
                                                    &nbsp;</td>
                                            </tr>
                                            <tr >
                                                <td align="right" class="texto" style="width: 20%; height: 20px">
                                                    <strong class="texto">&nbsp;Destino:</strong></td>
                                                <td align="left" style="height: 20px">
                                                    &nbsp;<asp:Label ID="lbl_destino" runat="server"  CssClass="texto"></asp:Label></td>
                                                <td align="right" class="texto" style="width: 18%; height: 20px">
                                                    <strong class="texto">Volume (lts):&nbsp;</strong></td>
                                                <td align="left" style="width: 33%; height: 20px">
                                                    &nbsp;<asp:Label ID="lbl_volume_estimado" runat="server" CssClass="texto"></asp:Label></td>
                                            </tr>
						    ...
						    <TR id="tr_pnl_pesagem_inicial" runat="server">
								...
								<TD style="height: 21px"  ></TD>
                                    ...
                                    <tr id="tr_pnl_pesagem_intermediaria" visible="false" runat="server">
                                    <td style="width: 1px"></td>
                                    <td class="texto">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3" style="height: 20px">
                                                    ...
                                                    <anthem:Label ID="lbl_aguarde_intermediaria" runat="server" AutoUpdateAfterCallBack="True"
                                                        CssClass="aguardenormal" UpdateAfterCallBack="True" >Aguarde... Buscando peso da balança..</anthem:Label></td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="texto" style="width: 20%; height: 20px">
							...
							<TR>
								...
								<TD class="texto">
									<TABLE id="Table11"  cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="faixafiltro1a" style="WIDTH: 265px" vAlign="middle" align="left" 
												background="img/faixa_filro.gif">
