<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lupa_fornecedor.aspx.vb" Inherits="lupa_fornecedor" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Seleção de Parceiros da Central de Compras</title>
		...
		<form id="Form1" runat="server">
			<table id="Table1"  cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					...
					<td class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><StrONG>Seleção de Parceiros Central Compras&nbsp;</StrONG></td>
