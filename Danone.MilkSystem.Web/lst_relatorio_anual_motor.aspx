<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_relatorio_anual_motor.aspx.vb" Inherits="lst_relatorio_anual_motor" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		...
		<meta http-equiv="refresh" content="30; URL=lst_relatorio_anual_motor.aspx">
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Relatório Extrato Mensal do Produtor&nbsp;Motor</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    ...
                                    <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="dt_referencia"
                                        CssClass="texto" ErrorMessage="O Ano de Referência deve ser informado." Font-Bold="True" AutoUpdateAfterCallBack="True">[!]</anthem:RequiredFieldValidator></td>
                            </tr>
                            <tr>
