<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_Grupo_Itens.aspx.vb" Inherits="frm_Grupo_Itens" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>Grupo de Itens</STRONG></TD>
					<TD>&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px" ></TD>
											...
											<TD width="76%">
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;<anthem:TextBox ID="txt_cd_grupo_itens" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" Width="10%" MaxLength="10"></anthem:TextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_cd_grupo_itens"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;<anthem:TextBox ID="txt_nm_grupo_itens" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" Width="25%" MaxLength="30"></anthem:TextBox>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_nm_grupo_itens"
                                                ...
                                                <table id="Table9" border="0" cellpadding="1" cellspacing="1" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <anthem:CustomValidator ID="cv_itens_desativados" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto">[!]</anthem:CustomValidator></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
