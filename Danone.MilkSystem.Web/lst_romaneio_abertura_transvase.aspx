<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_romaneio_abertura_transvase.aspx.vb" Inherits="lst_romaneio_abertura_transvase" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Abertura de Romaneio de Transvase</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Abrir Romaneio &nbsp;de Transvase</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
				...
				<TR>
					...
					<TD class="faixafiltro1a" style="HEIGHT: 24px" vAlign="middle" background="img/faixa_filro.gif">
						&nbsp;&nbsp;<strong>Selecione o Transvase para abrir o Romaneio:</strong></TD>
				...
				<TR>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" AutoUpdateAfterCallBack="True" Width="100%" UpdateAfterCallBack="True" DataKeyNames="id_transvase">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Abrir Romaneio">
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ToolTip="Abrir Romaneio" ImageUrl="~/img/abrir_romaneio.gif" CommandArgument='<%# Bind("id_transvase") %>' CommandName="selecionar" __designer:wfdid="w140"></anthem:ImageButton>&nbsp; 
</itemtemplate>
