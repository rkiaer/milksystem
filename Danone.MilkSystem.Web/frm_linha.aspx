<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_linha.aspx.vb" Inherits="frm_linha" %>
...
<script type="text/javascript"> 
    ...
    
    {
		...
		<form id="Form1" method="post" runat="server">
				...
				<TR>
					...
					<TD vAlign="top" align="center" background="images/faixa_filro.gif">
						<TABLE id="Table2" height="23" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD class="faixafiltro1a" vAlign="middle" align="left" width="238"
								...
								<TD class="faixafiltro1a" vAlign="middle" align="right" background="img/faixa_filro.gif"
									colSpan="4">
                                    <anthem:LinkButton ID="lk_linha_pedagio" runat="server" AutoUpdateAfterCallBack="True"
                                        Enabled="False" ToolTip="Pedágio por Eixo para Rota">Pedágio por Eixo</anthem:LinkButton>
                                    &nbsp; &nbsp;&nbsp;</TD>
							</TR>
						</TABLE>
						</TD>
												...
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%">
													...
													<TR id="CodigoTecnico" runat="server">
														<TD class="texto" align="right" width="23%"><STRONG>
                                                            <anthem:Label ID="lbl_cd_linha" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto"
                                                                UpdateAfterCallBack="True">Código:</anthem:Label></STRONG></TD>
														<TD width="77%">&nbsp;<anthem:TextBox ID="txt_cd_linha" runat="server" AutoUpdateAfterCallBack="True"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;<anthem:TextBox ID="txt_nm_linha" runat="server" AutoUpdateAfterCallBack="True" CssClass="texto"
                                                                Width="39%" MaxLength="50" Enabled="False"></anthem:TextBox>&nbsp;
                                                            <asp:LinkButton ID="lk_linha_detalhe" runat="server" Font-Size="Smaller" Visible="False">Detalhe</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                    ...
                                                    <tr>
                                                        <td align="right" style="height: 8px" width="20%">
                                                        </td>
                                                        <td style="height: 8px">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <span class="obrigatorio" style="color: #000000">Periodicidade da Coleta :</span></td>
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_periodicidade_coleta" runat="server"
                                                                CssClass="texto" Width="69px">
                                                                <asp:ListItem Selected="True" Value="2">24 hs</asp:ListItem>
                                                                <asp:ListItem Value="4">48 hs</asp:ListItem>
                                                            </anthem:DropDownList></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <span class="obrigatorio" style="color: #000000">Rota Transbordo :</span></td>
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_rota_transbordo" runat="server"
                                                                CssClass="texto" Width="69px">
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <span class="obrigatorio" style="color: #000000">Rota Transit Point:</span></td>
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_transit_point" runat="server"
                                                                CssClass="texto" Width="69px">
                                                                <asp:ListItem Value="1">Sim</asp:ListItem>
                                                                <asp:ListItem Value="2" Selected="True">N&#227;o</asp:ListItem>
                                                            </anthem:DropDownList></td>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <span class="obrigatorio" style="color: #000000">Rota Transvase:</span></td>
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_transvase" runat="server"
                                                                CssClass="texto" Width="69px">
                                                                <asp:ListItem Value="1">Sim</asp:ListItem>
                                                                <asp:ListItem Value="2" Selected="True">N&#227;o</asp:ListItem>
                                                            </anthem:DropDownList></td>
													...
													<TR id="tr_dados_sitema" runat="server">
														<TD colSpan="2">
															<TABLE id="Table9" cellSpacing="1" cellPadding="1" width="100%" border="0">
                                                                <tr>
                                                                    <td align="right" class="texto" width="23%">
                                                                        <span class="obrigatorio" style="color: #000000">Valor Pedágio por Eixo:</span></td>
                                                                    <td>
                                                                        &nbsp;<anthem:Label ID="lbl_valor_pedagio" runat="server" AutoUpdateAfterCallBack="True"
			...
			<anthem:ValidationSummary id="validatorSummary" runat="server" ShowMessageBox="True" ShowSummary="False" AutoUpdateAfterCallBack="True" ValidationGroup="vg_salvar"></anthem:ValidationSummary>
            <cc7:AlertMessages ID="messageControl" runat="server" AutoUpdateAfterCallBack="True"
                UpdateAfterCallBack="True"></cc7:AlertMessages></form>
            <!--<anthem:HiddenField ID="hf_id_veiculo" runat="server" AutoUpdateAfterCallBack="true" Visible="False" />-->                
	</body>
</HTML>
