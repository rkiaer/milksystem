<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lupa_produtor.aspx.vb" Inherits="lupa_produtor" %>
		...
		<form id="Form1" runat="server">
			<table id="Table1"  cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					...
					<td class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><StrONG>Seleção de Produtores&nbsp;</StrONG></td>
