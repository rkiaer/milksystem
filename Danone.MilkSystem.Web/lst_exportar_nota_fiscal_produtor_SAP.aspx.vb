...
Partial Class lst_exportar_nota_fiscal_produtor_SAP
    ...
    Protected Sub btn_exportar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_exportar.Click
        ...
        Try
            ...
            'Fran 30/05/2012 chamado 1556 i alteraçao nome arquivo THEMIS - 502 é o final da rotina no SAP BR1MM05500
            'lnomearquivo = "\MilkSystem_NotaFiscal_Produtor_" & Now() & Session.SessionID & ".txt"
            lnomearquivo = "\MilkSystem_NotaFiscal_Produtor_" & Now() & "500" & ".txt"
