...
Imports System.Data
Imports System.Math
Partial Class frm_pre_romaneio_controle_leite_excel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not (Request("dt_inicio") Is Nothing) Then
                ...
                dsromaneios = romaneio.getRomaneioControleLeitePreRomaneio
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" & "MilkSystem_ControleLeitePreRomaneio" & ".xls")
                        Response.Charset = ""
