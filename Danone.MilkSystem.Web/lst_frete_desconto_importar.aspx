<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_frete_desconto_importar.aspx.vb" Inherits="lst_frete_desconto_importar" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Importar Descontos Frete</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Importar Descontos Frete</STRONG></TD>
				...
				<TR>
					...
					<TD vAlign="middle" style="height: 19px" align="right">&nbsp;<anthem:ImageButton ID="btn_exportar" runat="server" Enabled="False" ImageUrl="~/img/bnt_exportar_desabilitado.gif"
                            ToolTip="Exportar Resultados da Importação" AutoUpdateAfterCallBack="True" ValidationGroup="vb_exportar" />&nbsp;</TD>
