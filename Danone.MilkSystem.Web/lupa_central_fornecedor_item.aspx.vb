...
Partial Class lupa_central_fornecedor_item
    Inherits Page
    ...
    Protected Sub btn_pesquisa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_pesquisa.Click
        ...
        ViewState("nm_linha") = txt_nm_parceiro.Text.Trim
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        If ViewState.Item("param_id_transit_point") = "0" Then
            Response.Redirect("lupa_central_fornecedor_item.aspx")
        Else
            Response.Redirect("lupa_central_fornecedor_item.aspx?id=" + ViewState.Item("param_id_transit_point").ToString)
        End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            If Not (Request("id") Is Nothing) Then
                ...
                ViewState.Item("param_id_transit_point") = Request("id")
                loadDetails()
            End If
    ...
    Private Sub loadDetails()
        ...
        Try
            Dim transitPoint As New TransitPoint(ViewState.Item("param_id_transit_point"))

            lbl_ds_estabelecimento.Text = transitPoint.ds_estabelecimento.ToString
            ViewState.Item("id_estabelecimento") = transitPoint.id_estabelecimento.ToString
            ViewState.Item("id_transit_point_unidade") = transitPoint.id_transit_point_unidade.ToString
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsPreRomaneioTP As DataSet = romaneio.getPreRomaneioDisponivelTransitPoint

            If (dsPreRomaneioTP.Tables(0).Rows.Count > 0) Then
                gridResults.Visible = True
                gridResults.DataSource = Helper.getDataView(dsPreRomaneioTP.Tables(0), ViewState.Item("sortExpression"))
    ...
    Private Sub salvarLinhaSelecionada(ByVal pid_romaneio As String)
        ...
        Try
            ...
            customPage.setFilter("lupa_tp_preromaneio", "id_romaneio", pid_romaneio.ToString)
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "selecionar"
                Dim lid As String = e.CommandArgument.ToString
                Dim js As New System.Text.StringBuilder
                js.Append("<script>")
                ...
                Page.ClientScript.RegisterHiddenField("txtDataHidden", lid)

                salvarLinhaSelecionada(lid)
