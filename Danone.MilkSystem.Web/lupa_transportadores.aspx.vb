...
Partial Class lupa_transportadores
    Inherits Page
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        If ViewState.Item("param_id_estabelecimento") = "0" Then
            If ViewState.Item("param_tipo") = "0" Then
                Response.Redirect("lupa_transportadores.aspx")
            Else
                Response.Redirect("lupa_transportadores.aspx?tipo=A") 'fran chamado 1548
            End If
        Else
            Response.Redirect("lupa_transportadores.aspx?id=" + ViewState.Item("param_id_estabelecimento").ToString)
        End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Not (Request("tipo") Is Nothing) Then
                'PEga o valor do tipo de produtor para saber se é agropecuaria
                ViewState.Item("param_tipo") = Request("tipo")
            Else
                ViewState.Item("param_tipo") = "0"
            End If
    ...
    Private Sub loadData()
        ...
        Try
            ...
            'fran 15/05/2012i chamado 1548
            If ViewState.Item("param_tipo") = "A" Then 'se agropecuaria
                produtor.st_emite_nota_fiscal = "S" 'pega todos os produtores que não emitem nota (agropecuaria)
            End If
