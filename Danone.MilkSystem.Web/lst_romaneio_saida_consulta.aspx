<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_romaneio_saida_consulta.aspx.vb" Inherits="lst_romaneio_saida_consulta" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;"><STRONG>Romaneio Saída - Consulta</STRONG></TD>
					...
					<TD id="td_pesquisa" runat="server" class="texto"><BR>
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0" style="height: 80px"  >
                            ...
                            <tr>
                                ...
                                <TD style="HEIGHT: 21px">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_placa" runat="server" CssClass="texto" MaxLength="7" Width="88px" AutoUpdateAfterCallBack="true"></anthem:TextBox>&nbsp;
                                    <anthem:ImageButton
				...
				<TR>
					...
					<TD>
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="id_romaneio_saida" HeaderText="Romaneio" SortExpression="id_romaneio" />
                                                ...
                                                <asp:BoundField DataField="dt_hora_entrada" HeaderText="Abertura"  />
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" Text="Button" CommandArgument='<%# bind("id_romaneio_saida") %>' CommandName="selecionar" CausesValidation="False" __designer:wfdid="w1"></asp:ImageButton> 
</itemtemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </anthem:GridView>
