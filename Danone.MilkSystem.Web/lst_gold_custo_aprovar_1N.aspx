<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_gold_custo_aprovar_1N.aspx.vb" Inherits="lst_gold_custo_aprovar_1N" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Aprovação Custos GOLD 1.o Nível</title>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Custos Gold 1.o Nível</STRONG></TD>
				...
				<TR>
					...
					<TD class="faixafiltro1a" style="HEIGHT: 24px; width: 1014px;" vAlign="middle" background="img/faixa_filro.gif">
                        ...
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/icone_excluir.gif" /><anthem:LinkButton
                            ...
                            ValidationGroup="vg_pesquisar">Reprovar</anthem:LinkButton>&nbsp;&nbsp;<asp:Image id="img_novo" runat="server" ImageUrl="~/img/ico_email.gif"></asp:Image><anthem:LinkButton ID="lk_email" runat="server" ValidationGroup="vg_pesquisar" OnClientClick="if (confirm('Uma notificação de que existem Custos GOLD aprovados em 1.o Nivel será enviada aos aprovadores para aprovação 2.o Nível. Deseja realmente prosseguir?' )) return true;else return false;" CssClass="texto" Enabled="False" AutoUpdateAfterCallBack="True">Notificar Aprovadores</anthem:LinkButton></TD>
...
&nbsp;<asp:CheckBox id="ck_header" runat="server" AutoPostBack="True" OnCheckedChanged="ck_header_CheckedChanged" __designer:wfdid="w5"></asp:CheckBox> 
                                    ...
                                    <itemtemplate>
&nbsp;<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w9" Checked='<%# bind("st_selecao") %>'></asp:CheckBox> 
</itemtemplate>
                                </asp:TemplateField>
...
<asp:Label id="lbl_ds_anotacao_aprovador" runat="server" Text='<%# Bind("ds_anotacao_aprovador") %>' __designer:wfdid="w22"></asp:Label> 
                                ...
                                <asp:TemplateField HeaderText="Custos">
                                    <itemtemplate>
<asp:HyperLink id="hl_custo" runat="server" ForeColor="Blue" Text="Visualizar" __designer:wfdid="w10" Target="_blank" NavigateUrl="~/frm_gold_custo.aspx"></asp:HyperLink>
</itemtemplate>
                                </asp:TemplateField>
