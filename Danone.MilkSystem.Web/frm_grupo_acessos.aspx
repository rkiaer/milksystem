<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_grupo_acessos.aspx.vb" Inherits="frm_grupo_acessos" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif)"><STRONG>Acessos do Grupo</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px" ></TD>
										...
										<TR>
											<TD width="76%">
												<TABLE id="Table7" cellSpacing="0" cellPadding="2" width="100%" border="0">
													...
													<TR  runat="server">
														<TD class="texto" align="right" width="23%"><STRONG>Grupo:</STRONG></TD>
														<TD width="77%">&nbsp;<asp:Label ID="lbl_nm_grupo" runat="server" CssClass="texto" Width="39%"></asp:Label>
                                                            </TD>
													</TR>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="texto" width="23%">
                                                            <strong><span style="color: #ff0000">* </span>Tipo do Acesso:</strong></td>
                                                        <td>
                                                            &nbsp;<anthem:DropDownList ID="cbo_tipo_acesso" runat="server" AutoUpdateAfterCallBack="True"
                                                                CssClass="texto" Width="20%">
                                                            </anthem:DropDownList>
                                                            <anthem:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cbo_tipo_acesso"
                                                                CssClass="texto" ErrorMessage="Preencha o campo Tipo de Acesso para continuar."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;<asp:TreeView ID="TreeMenu" runat="server" AutoGenerateDataBindings="False" CssClass="texto" ShowCheckBoxes="All">
