...
Partial Class lst_gold_custo_aprovar_1N
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_gold_custo_aprovar_1N.aspx")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_gold_custo_aprovar_1N.aspx")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("gold_custo_aprovar_1N", cbo_estabelecimento.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_estabelecimento") = customPage.getFilterValue("gold_custo_aprovar_1N", cbo_estabelecimento.ID)
        ...
        If Not (customPage.getFilterValue("gold_custo_aprovar_1N", txt_dt_referencia_inicial.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_referencia_inicial") = customPage.getFilterValue("gold_custo_aprovar_1N", txt_dt_referencia_inicial.ID)
        ...
        If Not (customPage.getFilterValue("gold_custo_aprovar_1N", txt_dt_referencia_final.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_referencia_final") = customPage.getFilterValue("gold_custo_aprovar_1N", txt_dt_referencia_final.ID)
            txt_dt_referencia_final.Text = ViewState.Item("dt_referencia_final").ToString()
        Else
            ViewState.Item("dt_referencia_final") = String.Empty
        End If

        If Not (customPage.getFilterValue("gold_custo_aprovar_1N", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("gold_custo_aprovar_1N", "PageIndex").ToString()
            gridResults.PageIndex = Convert.ToInt32(ViewState.Item("PageIndex").ToString())
        End If

        If (hasFilters) Then
            loadData()
            customPage.clearFilters("gold_custo_aprovar_1N")
        End If
    ...
    Private Sub loadData()
        ...
        Try
            ...
            End If
            goldcusto.id_situacao = 1

            Me.lk_aprovar.Enabled = True
            Me.lk_reprovar.Enabled = True
            Me.lk_email.Enabled = True

            Dim dsGoldCusto As DataSet = goldcusto.getGoldCusto1NByFilters()
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("gold_custo_aprovar_1N", cbo_estabelecimento.ID, ViewState.Item("id_estabelecimento").ToString)
            customPage.setFilter("gold_custo_aprovar_1N", txt_dt_referencia_inicial.ID, ViewState.Item("dt_referencia_inicial").ToString)
            customPage.setFilter("gold_custo_aprovar_1N", txt_dt_referencia_final.ID, ViewState.Item("dt_referencia_final").ToString)
            customPage.setFilter("gold_custo_aprovar_1N", "PageIndex", gridResults.PageIndex.ToString())
    ...
    Protected Sub lk_aprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_aprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                'Dados para o Update
                goldcusto.st_aprovado = "4"   '  Aprovado 1.o Nível
    ...
    Protected Sub ck_header_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            End If
            goldcusto.updateGoldCustoTodos1N()
        ...
        Try
            If Page.IsValid = True Then
                Try
                    ...
                    Dim lAssunto As String = "Aprovação 2.o Nível de Custos GOLD "
                    Dim lCorpo As String = "Existem margens/bonificações de custo efetivo, volume, crescimento e eficiência da dieta para Custos GOLD pendentes para aprovação 2.o Nível."

                    ' 11 - Custos Gold 2o. Nível
                    If notificacao.enviaMensagemEmail(11, lAssunto, lCorpo, MailPriority.High, , , Convert.ToInt32(ViewState.Item("id_estabelecimento"))) = True Then
