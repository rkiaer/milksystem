<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_pre_romaneio_tp_consulta.aspx.vb" Inherits="lst_pre_romaneio_tp_consulta" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Consultar Pré-Romaneios para Transit Point</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;"><STRONG>Consultar Pré-Romaneio para Transit Point</STRONG></TD>
                        ...
                        <table id="Table3" cellpadding="1" cellspacing="0" class="borda" style="height: 80px"
                            ...
                            <tr>
                                ...
                                <td align="right" style="width: 20%; color: #333333; height: 5px">
                                    <span style="color: #333333">*</span>Unidade Transit Point:</td>
                                <td style="height: 26px">
                                    &nbsp;
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" Text="Button" CommandArgument='<%# bind("id_romaneio") %>' CommandName="selecionar" CausesValidation="False" __designer:wfdid="w65"></asp:ImageButton> 
</itemtemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </anthem:GridView>
