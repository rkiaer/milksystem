<%@ Page Language="VB" AutoEventWireup="true" CodeFile="lst_romaneio_saida_fechar.aspx.vb" Inherits="lst_romaneio_saida_fechar" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Romaneio Saída - Fechar</title>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0" topmargin="0" >
                            ...
                            <tr>
                                ...
                                <td style="height: 23px">
                                 ...
                                 <td align="right">&nbsp;Data Abertura:</td>
                                 <td>
                                    &nbsp;
                                    <cc2:OnlyDateTextBox ID="txt_dt_inicio" runat="server" Columns="7" CssClass="texto"
                                        DateMask="DayMonthYear" Width="85px"></cc2:OnlyDateTextBox></td>
                            </tr>
                            <tr>
                                <td align="right" style="height: 23px;">
                                    &nbsp;Transportador:</td>
					...
					<TD class="texto">
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="dt_hora_entrada" HeaderText="Dt Abertura" DataFormatString="{0:dd/MM/yyyy hh:mm}" >
                                    <headerstyle horizontalalign="Center" />
                                    <itemstyle horizontalalign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="NF">
                                    <itemtemplate>
<asp:HyperLink id="hl_download" runat="server" Text='<%# bind("nr_nota_fiscal") %>' ForeColor="Blue" __designer:wfdid="w261" Font-Underline="True"></asp:HyperLink> 
</itemtemplate>
                                    <headerstyle horizontalalign="Center" />
                                    <itemstyle horizontalalign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="CTE">
                                    <itemtemplate>
<asp:HyperLink id="hl_download_cte" runat="server" Text='<%# bind("nr_nota_fiscal_cte") %>' ForeColor="Blue" __designer:wfdid="w256" Font-Underline="True"></asp:HyperLink> 
</itemtemplate>
                                    <headerstyle horizontalalign="Center" />
                                    <itemstyle horizontalalign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="False" HeaderText="Fechar">
                                    <itemtemplate>
<anthem:ImageButton id="img_fechar" runat="server" AutoUpdateAfterCallBack="True" ToolTip="Finalizar Romaneio de Saída" ImageUrl="~/img/ico_fechar_romaneio.gif" UpdateAfterCallBack="True" __designer:wfdid="w262" OnClientClick="if (confirm('Deseja realmente FECHAR ROMANEIO SAÍDA?' )) return true;else return false;" CommandName="fechar" CommandArgument='<%# bind("id_romaneio_saida") %>'></anthem:ImageButton> 
</itemtemplate>
