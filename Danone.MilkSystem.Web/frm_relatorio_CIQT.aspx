<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_CIQT.aspx.vb" Inherits="frm_relatorio_CIQT" %>
        ...
        <div id="tudorel" style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid; vertical-align: middle; text-align: center;">
            ...
            <table width="100%" cellpadding="1" cellspacing="0" >
                <tr>
                    ...
                    <td align="center" class="textosmallbold" colspan="2" style="border-right: gray 1px solid; border-top: gray 1px solid; font-size: 14px; height: 23px">
                        COMUNICACÃO DE INCIDENTE DE QUALIDADE AO TRANSPORTADOR</td>
                </tr>
                <tr>
                ...
                <tr>
                   <td align="center" colspan="2" style="border-top-width: 1px; border-right: gray 1px solid; border-left-width: 1px; border-left-color: gray; border-bottom-width: 1px; border-bottom-color: gray; border-top-color: gray; height: 23px" class="textosmallbold">
                       CIQT Nr:
                       <asp:Label ID="lbl_nr_ciqt" runat="server" CssClass="textosmallbold" Font-Italic="True"  ></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center" colspan="3" style="font-size: 11px; height: 14px" class="textosmall">Não conformidade com: <span class="obrigatorio">
                ...
                <table border="0" width="100%" cellspacing="0">
                    <tr>
                        ...
                        <td align="center" class="textosmall" style="width: 60%; height: 20px; border-right: gray 1px solid; border-top: gray 1px solid; border-left: gray 1px solid;"
                            width="40%">
                            <strong>Nome da Transportadora</strong></td>
                    </tr>
                    <tr>
                        ...
                        <td align="center" class="textosmall" rowspan="2" style="border-right: gray 1px solid; border-left: gray 1px solid; width: 60%;" width="40%">
                            <asp:Label ID="lbl_transportador" runat="server" CssClass="textosmallbold" Font-Italic="True"></asp:Label>&nbsp;
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
            ...
            <table width="100%" class="textosmall" >
                ...
                <tr>
                    ...
                    <td align="center" class="textosmall" style="width: 138px" ><strong>Nr Compartimento </strong></td>
                 ...
                 <tr>
                    ...
                    <td align="center" class="textosmall" style="width: 138px" >
                        <asp:Label ID="lbl_nr_compartimento" runat="server" CssClass="textosmall" Font-Italic="True"></asp:Label></td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td align="center" style="height: 22px; width: 138px;" class="textosmall" ><strong>
                        <asp:Label ID="lbl_rota_nota" runat="server" CssClass="textosmall" Font-Italic="False">Rota</asp:Label>
                    </strong></td>
...
<asp:Label id="lbl_cd_analise" runat="server" Text='<%# Bind("cd_analise") %>' __designer:wfdid="w6"></asp:Label>
            ...
            <table width="98%" >
                <tr>
                    <td align="left" Font-Italic="True" class="textosmall"><b>
                        ...
                        <br />
                        <br />
                        </b><strong>Humberto Carvalho</strong><br />
            ...
            <table width="100%">
                ...
                <tr>
                 ...
                 <tr>
                    <td align="center" style="height: 14px" class="textosmall"  ></td>
                    <td align="center" style="height: 14px" class="textosmall"  ></td>
                </tr>
                 <tr>
