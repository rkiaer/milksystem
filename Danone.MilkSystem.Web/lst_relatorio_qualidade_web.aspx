<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_relatorio_qualidade_web.aspx.vb" Inherits="lst_relatorio_qualidade_web" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Relatório Extrato Mensal do Produtor&nbsp;- WEB</STRONG></TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
					<TD style="width: 9px"></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    ...
                                    <anthem:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_dt_referencia"
                                        CssClass="texto" ErrorMessage="O Mes/Ano de Referência deve ser informado." Font-Bold="True" AutoUpdateAfterCallBack="True" ValidationGroup="vg_pesquisar">[!]</anthem:RequiredFieldValidator></td>
                            </tr>
                            <tr>
...
<asp:Label id="lbl_id_unid_producao" runat="server" __designer:wfdid="w3" Text='<%# Bind("id_unid_producao") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Extrato Pagamento">
                                                    <itemtemplate>
