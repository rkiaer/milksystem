<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_adto_SAP.aspx.vb" Inherits="lst_exportar_adto_SAP" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Adiantamento SAP</STRONG></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <TD style="HEIGHT: 12px; ">
 								...
 								<TD style="height: 12px" align="right">
                                     <anthem:CheckBox ID="ck_adtos_exportados" runat="server" Text="Adiantamentos/Antecipação já exportados" /></TD>
								<TD style="height: 12px"></TD>
                            </tr>
                            <tr>
                                <td align="right" style="height: 19px" >
                                ...
                                <TD  style="height: 12px; " align="right">
                                    <anthem:RadioButtonList ID="opt_tipo_exportacao" runat="server" AutoUpdateAfterCallBack="True"
                                        CssClass="texto" RepeatDirection="Horizontal">
                                        <Items>
                                            <asp:ListItem Selected="True" Value="S">Adiantamento</asp:ListItem>
                                            <asp:ListItem Value="N">Antecipa&#231;&#227;o</asp:ListItem>
                                        </Items>
