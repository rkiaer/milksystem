<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_romaneio_analises_uproducao.aspx.vb" Inherits="lst_romaneio_analises_uproducao" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>lst_romaneio_analises_uproducao</title>
					...
					<TD vAlign="bottom" style="width: 100%; height: 4px;" class="texto">
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowSorting="True"
                            ...
                            <Columns>
                                <asp:TemplateField  >
                                    <itemtemplate>
&nbsp; <TABLE style="WIDTH: 100%; HEIGHT: 8px" class="texto" cellSpacing=0 border=0><TBODY><TR style="BACKGROUND-COLOR: #9bc5ff"><TD style="WIDTH: 3%; HEIGHT: 5px" colSpan=1></TD><TD style="WIDTH: 60%; HEIGHT: 5px" colSpan=5><asp:Label id="Label1" runat="server" Width="40%" __designer:wfdid="w18" Text="Análise do Compartimento" Font-Bold="True"></asp:Label> <asp:Label id="lbl_ds_compartimento" runat="server" __designer:wfdid="w19" Text='<%# Bind("ds_compartimento") %>'></asp:Label> </TD><TD style="WIDTH: 20%; HEIGHT: 5px" align=center>Placa <asp:Label id="lbl_ds_placa_compartimento" runat="server" __designer:wfdid="w20" Text='<%# Bind("ds_placa") %>'></asp:Label> </TD><TD style="WIDTH: 10%; HEIGHT: 5px" align=center><asp:Label id="lbl_nm_st_compartimento" runat="server" __designer:wfdid="w21" Text='<%# Bind("nm_st_analise") %>'></asp:Label></TD><TD style="WIDTH: 5%; HEIGHT: 5px">&nbsp;<asp:ImageButton id="btn_RegistrarAnaliseCompartimento" runat="server" ImageUrl="~/img/icon_registrar.gif" Width="24px" __designer:wfdid="w22" CommandName="Registrar_Analise_Compartimento" CommandArgument='<%# Bind("id_romaneio_compartimento") %>' ToolTip="Registrar Análise do Compartimento" Visible="False"></asp:ImageButton><asp:Label id="lbl_id_romaneio_compartimento" runat="server" __designer:wfdid="w23" Text='<%# Bind("id_romaneio_compartimento") %>' Visible="False"></asp:Label></TD></TR><TR><TD style="WIDTH: 3%; HEIGHT: 7px" colSpan=2></TD><TD style="WIDTH: 97%; HEIGHT: 7px" colSpan=7><asp:GridView id="gridAnalisesUproducao" runat="server" CssClass="texto" DataKeyNames="id_romaneio_uproducao" Width="100%" CellPadding="0" AutoGenerateColumns="False" __designer:wfdid="w38"><Columns>
<asp:TemplateField><ItemTemplate>
<asp:Label id="Label2" runat="server" __designer:wfdid="w25" Text="Análise Unid. Produção" Font-Bold="True"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
