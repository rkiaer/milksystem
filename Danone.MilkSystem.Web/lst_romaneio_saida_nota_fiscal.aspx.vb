...
Partial Class lst_romaneio_saida_nota_fiscal
    Inherits Page
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_romaneio_saida_nota_fiscal.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_romaneio_saida_nota_fiscal.aspx")
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            Dim situacao As New SituacaoRomaneioSaidaNota
            cbo_situacao.DataSource = situacao.getSituacaoRomaneioSaidaNotaByFilters
            cbo_situacao.DataTextField = "nm_situacao_romaneio_saida_nota"
            cbo_situacao.DataValueField = "id_situacao_romaneio_saida_nota"
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("rsnf", txt_dt_fim.ID).Equals(String.Empty)) Then
            hasFilters = True
    ...
    Private Sub loadData()
        ...
        Try
            ...
            romaneio.id_situacao_romaneio_saida_nota = cbo_situacao.SelectedValue


            Dim dsRomaneios As DataSet = romaneio.getRomaneioSaidaNota()
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "edit"
                saveFilters()
                Response.Redirect("frm_romaneio_saida_nota_fiscal.aspx?id_romaneio_saida=" + e.CommandArgument.ToString())
