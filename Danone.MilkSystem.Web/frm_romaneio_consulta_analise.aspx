<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_romaneio_consulta_analise.aspx.vb" Inherits="frm_romaneio_consulta_analise" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Consulta do Romaneio - Análises</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>
                        <asp:Label ID="lbl_titulo" runat="server" Text="Consulta do Romaneio - Análises do Compartimento"></asp:Label></STRONG></TD>
						...
						<TABLE id="Table3" height="23" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD class="faixafiltro1a" vAlign="middle" align="right" background="img/faixa_filro.gif"
                                    ...
                                    <asp:LinkButton ID="lk_Analise_Uproducao" runat="server" BorderStyle="None" CausesValidation="False">Análises Unid. Produção</asp:LinkButton>&nbsp;&nbsp;</TD>
							</TR>
						</TABLE>
						</TD>
			    ...
			    <TR>
					...
					<TD class="texto"  >
                                                <asp:Panel ID="pnl_romaneio" runat="server" BackColor="White" Font-Bold="False" GroupingText="Dados Romaneio"  Width="100%" Font-Size="XX-Small"  CssClass="texto">
...
<asp:Panel ID="Panel5" runat="server" BackColor="White" Font-Bold="False" GroupingText="Registro das Análises"  Width="100%" Font-Size="XX-Small"  CssClass="texto"  HorizontalAlign="Left">
    <br />
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowSorting="True"
                                            ...
                                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" Width="100%" DataKeyNames="id_analise_compartimento" CssClass="texto" GridLines="None" PageSize="6">
        ...
        ForeColor="Red" Text="* Análise Informativa"></asp:Label></asp:Panel>
                ...
                <tr id="tr_reanalise" visible="false" runat="server">
                    <TD style="width: 1px; ">
                        &nbsp;</td>
                    <TD  valign="top" class="texto">
<asp:Panel ID="Panel4" runat="server" BackColor="White" Font-Bold="False" GroupingText="Registro das Re-Análises"  Width="100%" Font-Size="XX-Small"  CssClass="texto" HorizontalAlign="Left">
    <br />
                        <anthem:GridView ID="gridreanalise" runat="server" AllowSorting="True"
                                            AutoGenerateColumns="False" CellPadding="1" UpdateAfterCallBack="True" AutoUpdateAfterCallBack="True"
                            ...
                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small" HorizontalAlign="Left" ForeColor="White" Height="20px" />
                            <EditRowStyle BackColor="#6193E0" />
