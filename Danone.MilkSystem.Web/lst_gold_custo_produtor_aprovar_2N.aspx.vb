...
Partial Class lst_gold_custo_produtor_aprovar_2N
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_gold_custo_produtor_aprovar_2N.aspx")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_gold_custo_produtor_aprovar_2N.aspx")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("gold_custo_produtor_aprovar_2N", cbo_estabelecimento.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_estabelecimento") = customPage.getFilterValue("gold_custo_produtor_aprovar_2N", cbo_estabelecimento.ID)
        ...
        If Not (customPage.getFilterValue("gold_custo_produtor_aprovar_2N", txt_dt_referencia_inicial.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_referencia_inicial") = customPage.getFilterValue("gold_custo_produtor_aprovar_2N", txt_dt_referencia_inicial.ID)
        ...
        If Not (customPage.getFilterValue("gold_custo_produtor_aprovar_2N", txt_dt_referencia_final.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_referencia_final") = customPage.getFilterValue("gold_custo_produtor_aprovar_2N", txt_dt_referencia_final.ID)
            txt_dt_referencia_final.Text = ViewState.Item("dt_referencia_final").ToString()
        Else
            ViewState.Item("dt_referencia_final") = String.Empty
        End If

        If Not (customPage.getFilterValue("gold_custo_produtor_aprovar_2N", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("gold_custo_produtor_aprovar_2N", "PageIndex").ToString()
            gridResults.PageIndex = Convert.ToInt32(ViewState.Item("PageIndex").ToString())
        End If

        If (hasFilters) Then
            loadData()
            customPage.clearFilters("gold_custo_produtor_aprovar_2N")
        End If
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsGoldCustoProdutor As DataSet = goldcustoprodutor.getGoldCustoProdutor2NByFilters()
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("gold_custo_produtor_aprovar_2N", cbo_estabelecimento.ID, ViewState.Item("id_estabelecimento").ToString)
            customPage.setFilter("gold_custo_produtor_aprovar_2N", txt_dt_referencia_inicial.ID, ViewState.Item("dt_referencia_inicial").ToString)
            customPage.setFilter("gold_custo_produtor_aprovar_2N", txt_dt_referencia_final.ID, ViewState.Item("dt_referencia_final").ToString)
            customPage.setFilter("gold_custo_produtor_aprovar_2N", "PageIndex", gridResults.PageIndex.ToString())
    ...
    Protected Sub gridResults_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridResults.RowDataBound
        If (e.Row.RowType <> DataControlRowType.Header _
            ...
            Dim hl_nr_custo_operacional_total As HyperLink = CType(e.Row.FindControl("hl_nr_custo_operacional_total"), HyperLink)
            Dim hl_nr_custo_dieta_total As HyperLink = CType(e.Row.FindControl("hl_nr_custo_dieta_total"), HyperLink)

            hl_nr_custo_operacional_total.NavigateUrl = String.Format("frm_gold_custo_produtor.aspx?id_gold_custo_produtor={0}", gridResults.DataKeys.Item(e.Row.RowIndex).Value()) & String.Format("&acao={0}", "C")
    ...
    Protected Sub lk_aprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_aprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                'Dados para o Update
                goldcustoprodutor.st_aprovado = "2"   '  Aprovado 2.o Nível
    ...
    Protected Sub ck_header_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            End If
            goldcustoprodutor.updateGoldCustoProdutorTodos2N()
