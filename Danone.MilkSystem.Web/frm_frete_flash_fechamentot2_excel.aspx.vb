...
Imports System.Data
Imports System.Math
Partial Class frm_frete_flash_fechamentot2_excel
                ...
                Case "F"
                    ...
                    If gridResults.Rows.Count.ToString + 1 < 65536 Then
                        If gridResults.Rows.Count > 0 Then
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=" & "FreteT2_FlashFechamento_" & DateTime.Parse(ViewState.Item("dt_referencia").ToString).ToString("MMMyyyy").ToUpper & "_" & DateTime.Parse(Now()).ToString("ddMMyyyyhhmmss") & ".xls")
                ...
                Case "R"
                    ...
                    If gridDivergencia.Rows.Count.ToString + 1 < 65536 Then
                        If gridDivergencia.Rows.Count > 0 Then
                            ...
                            Response.ContentType = "application/vnd.ms-excel"
                            'Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                            Response.AddHeader("content-disposition", "attachment;filename=" & "FreteT2_FlashRomaneios_Divergencias_" & DateTime.Parse(ViewState.Item("dt_referencia").ToString).ToString("MMMyyyy").ToUpper & "_" & DateTime.Parse(Now()).ToString("ddMMyyyyhhmmss") & ".xls")
                            Response.Charset = ""
                            EnableViewState = False
                            Controls.Add(frm)
                ...
                Case "RC"
                    ...
                    If gridDivergencia.Rows.Count.ToString + 1 < 65536 Then
                        If gridDivergencia.Rows.Count > 0 Then
                            ...
                            Response.ContentType = "application/vnd.ms-excel"
                            'Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                            Response.AddHeader("content-disposition", "attachment;filename=" & "FreteT2_FlashRomaneios_Calculados_" & DateTime.Parse(ViewState.Item("dt_referencia").ToString).ToString("MMMyyyy").ToUpper & "_" & DateTime.Parse(Now()).ToString("ddMMyyyyhhmmss") & ".xls")
                            Response.Charset = ""
                            EnableViewState = False
                            Controls.Add(frm)
                            frm.Controls.Add(gridDivergencia)
