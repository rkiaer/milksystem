...
Imports System.Data
Imports System.Math
Partial Class frm_usuario_log_critico_excel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not (Request("dt_inicio") Is Nothing) Then
                ...
                Dim dsusuariolog As DataSet = usuariolog.getUsuarioLogCriticos
                ...
                If gridResults.Rows.Count.ToString + 1 < 65536 Then
                    If gridResults.Rows.Count > 0 Then
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" & "MilkSystem_LOG_Criticos" & ".xls")
                        Response.Charset = ""
