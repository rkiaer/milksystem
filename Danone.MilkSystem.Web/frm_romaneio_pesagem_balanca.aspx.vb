...
Partial Class frm_romaneio_pesagem_balanca
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_romaneio_pesagem_balanca.aspx")
        ...
        If Page.IsValid Then
            Try
                ...
                If (romaneio.id_st_romaneio <> 4) Or (romaneio.id_st_romaneio = 4 And romaneio.id_registro_exportacao_batch = 1) Then
                    ...
                    usuariolog.ds_nm_processo = "Atualizar Pesagem Balança - Pesagem Final"
        ...
        If Page.IsValid Then
            Try
                ...
                If (romaneio.id_st_romaneio <> 4) Or (romaneio.id_st_romaneio = 4 And romaneio.id_registro_exportacao_batch = 1) Then
                    ...
                    usuariolog.id_tipo_log = 3 'alteracao
                    usuariolog.id_menu_item = 129
                    usuariolog.ds_nm_processo = "Atualizar Pesagem Balança - Pesagem Inicial"
                    usuariolog.id_nr_processo = ViewState.Item("id_romaneio").ToString
                    usuariolog.nm_nr_processo = ViewState.Item("id_romaneio").ToString
    ...
    Protected Sub lk_voltar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_voltar.Click
        Response.Redirect("lst_romaneio_pesagem_balanca.aspx")
