<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_preco_negociado_aprovar_2N.aspx.vb" Inherits="lst_preco_negociado_aprovar_2N" %>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Preço Negociado 2.o Nível</STRONG></TD>
				...
				<TR>
					...
					<TD vAlign="middle" style="height: 19px; ">&nbsp;<table class="texto" style="width: 100%">
                        <tr>
...
&nbsp;<asp:CheckBox id="ck_header" runat="server" __designer:wfdid="w41" AutoPostBack="True" OnCheckedChanged="ck_header_CheckedChanged"></asp:CheckBox>
                                    ...
                                    <itemtemplate>
&nbsp;<asp:CheckBox id="ck_item" runat="server" __designer:wfdid="w40" Checked='<%# bind("st_selecao") %>'></asp:CheckBox>
</itemtemplate>
                                </asp:TemplateField>
