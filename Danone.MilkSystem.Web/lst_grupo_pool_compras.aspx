<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_grupo_pool_compras.aspx.vb" Inherits="lst_grupo_pool_compras" %>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td style="height: 20px">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_cd_grupo_pool_compras" runat="server" CssClass="caixaTexto" Width="224px" MaxLength="10"></anthem:TextBox></td>
                            </tr>
							<TR>
								<TD width="20%" align="right" style="height: 20px">&nbsp;Nome:</TD>
								<TD style="height: 20px">&nbsp;&nbsp;<anthem:textbox id="txt_nm_grupo_pool_compras" runat="server" cssclass="caixaTexto"
				...
				<TR>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="cd_grupo_pool_compras" HeaderText="C&#243;digo" SortExpression="cd_grupo_pool_compras" >
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nm_grupo_pool_compras" HeaderText="Nome" SortExpression="nm_grupo_pool_compras" >
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" CommandArgument='<%# Bind("id_grupo_pool_compras") %>' CommandName="edit" __designer:wfdid="w3"></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" AutoUpdateAfterCallBack="True" CommandArgument='<%# Bind("id_grupo_pool_compras") %>' CommandName="delete" __designer:wfdid="w4" OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;"></anthem:ImageButton> 
</itemtemplate>
