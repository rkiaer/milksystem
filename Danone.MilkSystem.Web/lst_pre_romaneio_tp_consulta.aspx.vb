...
Partial Class lst_pre_romaneio_tp_consulta
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_pre_romaneio_tp_consulta.aspx?limpar=S")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_pre_romaneio_tp_consulta.aspx")
    ...
    Private Sub loadFilters()
        ...
        If Not (customPage.getFilterValue("lst_pre_consulta", txt_id_romaneio.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_romaneio") = customPage.getFilterValue("lst_pre_consulta", txt_id_romaneio.ID)
            txt_id_romaneio.Text = ViewState.Item("id_romaneio").ToString()
        Else
            ViewState.Item("id_romaneio") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_pre_consulta", txt_nr_caderneta.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("nr_caderneta") = customPage.getFilterValue("lst_pre_consulta", txt_nr_caderneta.ID)
            txt_nr_caderneta.Text = ViewState.Item("nr_caderneta").ToString()
        Else
            ViewState.Item("nr_caderneta") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_pre_consulta", txt_nm_linha.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("nm_linha") = customPage.getFilterValue("lst_pre_consulta", txt_nm_linha.ID)
            txt_nm_linha.Text = ViewState.Item("nm_linha").ToString()
        Else
            ViewState.Item("nm_linha") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_pre_consulta", txt_placa.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("ds_placa") = customPage.getFilterValue("lst_pre_consulta", txt_placa.ID)
            txt_placa.Text = ViewState.Item("ds_placa").ToString()
        Else
            ViewState.Item("ds_placa") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_pre_consulta", cbo_situacao.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_st_romaneio") = customPage.getFilterValue("lst_pre_consulta", cbo_situacao.ID)
            cbo_situacao.Text = ViewState.Item("id_st_romaneio").ToString()
        Else
            ViewState.Item("id_st_romaneio") = String.Empty
        End If
        If Not (customPage.getFilterValue("lst_pre_consulta", cbo_estabelecimento.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_estabelecimento") = customPage.getFilterValue("lst_pre_consulta", cbo_estabelecimento.ID)
        ...
        Else
            ...
            'ViewState.Item("id_transit_point_unidade") = customPage.getFilterValue("lst_pre_consulta", cbo_transit_point.ID)
            'cbo_transit_point.Text = ViewState.Item("id_transit_point_unidade").ToString()
        End If
        If Not (customPage.getFilterValue("lst_pre_consulta", cbo_transit_point.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_transit_point_unidade") = customPage.getFilterValue("lst_pre_consulta", cbo_transit_point.ID)
            Dim transit As New TransitPointUnidade
        ...
        If Not (customPage.getFilterValue("lst_pre_consulta", txt_dt_hora_entrada_ini.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_hora_entrada_ini") = customPage.getFilterValue("lst_pre_consulta", txt_dt_hora_entrada_ini.ID)
            txt_dt_hora_entrada_ini.Text = ViewState.Item("dt_hora_entrada_ini").ToString()
        Else
            ViewState.Item("dt_hora_entrada_ini") = String.Empty
        End If

        If Not (customPage.getFilterValue("lst_pre_consulta", txt_dt_hora_entrada_fim.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("dt_hora_entrada_fim") = customPage.getFilterValue("lst_pre_consulta", txt_dt_hora_entrada_fim.ID)
        ...
        If Not (customPage.getFilterValue("lst_pre_consulta", "PageIndex").Equals(String.Empty)) Then
            ViewState.Item("PageIndex") = customPage.getFilterValue("lst_pre_consulta", "PageIndex").ToString()
        ...
        If (hasFilters) Then
            loadData()
            customPage.clearFilters("lst_pre_consulta")
        Else
    ...
    Private Sub loadData()
        ...
        Try
            ...
            dsromaneio = romaneio.getPreRomaneioSelecionar
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("lst_pre_consulta", txt_id_romaneio.ID, ViewState.Item("id_romaneio").ToString)
            customPage.setFilter("lst_pre_consulta", txt_nr_caderneta.ID, ViewState.Item("nr_caderneta").ToString)
            customPage.setFilter("lst_pre_consulta", txt_placa.ID, ViewState.Item("ds_placa").ToString)
            customPage.setFilter("lst_pre_consulta", cbo_situacao.ID, ViewState.Item("id_st_romaneio").ToString)
            customPage.setFilter("lst_pre_consulta", txt_nm_linha.ID, ViewState.Item("nm_linha").ToString)
            customPage.setFilter("lst_pre_consulta", cbo_estabelecimento.ID, ViewState.Item("id_estabelecimento").ToString)
            customPage.setFilter("lst_pre_consulta", cbo_transit_point.ID, ViewState.Item("id_transit_point_unidade").ToString)
            customPage.setFilter("lst_pre_consulta", "PageIndex", gridResults.PageIndex.ToString())

            customPage.setFilter("lst_pre_consulta", txt_dt_hora_entrada_ini.ID, ViewState.Item("dt_hora_entrada_ini").ToString)
            customPage.setFilter("lst_pre_consulta", txt_dt_hora_entrada_fim.ID, ViewState.Item("dt_hora_entrada_fim").ToString)
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            ...
            Case "selecionar"
                ...
                Response.Redirect("frm_pre_romaneio_tp_consulta.aspx?id_romaneio=" + e.CommandArgument.ToString)
