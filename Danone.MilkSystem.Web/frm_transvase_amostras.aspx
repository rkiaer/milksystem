<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_transvase_amostras.aspx.vb" Inherits="frm_transvase_amostras" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Transvase - Amostras da Coleta</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 28px;"><STRONG>Transvase - Envio de Amostras de Coletas no Transvase para Recepção
                ...
                <tr>
                        ...
                        <TABLE class="borda" id="Table3" cellSpacing="0" cellPadding="0" width="95%" style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none"   >
                            ...
                            <tr>
                                <td align="right" style="height: 22px; width: 17%;" >
                                    Número do Transvase:</td>
                                <td style=" width:15%; height: 22px;">
                                    &nbsp;<anthem:Label ID="lbl_id_transvase" runat="server"></anthem:Label></td>
                                <td style="width:13%; height: 22px;" align="right">
                                    Estabelecimento:</td>
                                <td style=" width:20%; height: 22px;">
                                    &nbsp;<anthem:Label ID="lbl_nm_estabelecimento" runat="server"></anthem:Label></td>
                                <td style="width: 15%; height: 22px;" align="right">
                                    Situação Transvase:
                                </td>
                                <td style=" width:20%; height: 22px;">
                                    &nbsp;<anthem:Label ID="lbl_nm_situacao_transvase" runat="server" UpdateAfterCallBack="True"></anthem:Label></td>
                            </tr>
                            <tr>
                                ...
                                <td align="right" style="height: 22px">
                                    Total Volume Transvase:</td>
                                <td style="height: 22px">
                                    &nbsp;<anthem:Label ID="lbl_nr_total_litros_transvase" runat="server" AutoUpdateAfterCallBack="True"
                    ...
                    <TD style="HEIGHT: 19px" class="titmodulo" align="left" >
                        Amostras de Coletas dos Pré-Romaneios &nbsp;do Transvase:</td>
                    <TD style="height: 19px; width: 10px;">
                    </td>
                </tr>
                ...
                <TR id="tr_detalhes" runat="server">
					...
					<TD valign="top">
                        <br />
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small" AutoUpdateAfterCallBack="True" Width="100%" UpdateAfterCallBack="True" DataKeyNames="id_pre_romaneio_transvase_amostras" PageSize="100" CellPadding="4">
...
<asp:Label id="lbl_situacao_coleta_amostra" runat="server" __designer:wfdid="w22"></asp:Label> 
                                ...
                                <asp:BoundField DataField="nm_situacao_transvase_amostra" HeaderText="Envio" />
                                <asp:BoundField HeaderText="Motivo Descarte no TVASE." DataField="nm_motivo_descarte_romaneio_amostra" />
...
&nbsp; 
                                    ...
                                    <itemtemplate>
<asp:Label id="lbl_id_situacao_transvase_amostra" runat="server" Text='<%# Bind("id_situacao_transvase_amostra") %>' __designer:wfdid="w9"></asp:Label> 
</itemtemplate>
                                </asp:TemplateField>
...
<asp:Label id="lbl_id_motivo_descarte_tp_amostra" runat="server" Text='<%# Bind("id_motivo_descarte_tp_amostra") %>' __designer:wfdid="w10"></asp:Label> 
                                ...
                                <asp:TemplateField HeaderText="id_transvase_registro" Visible="False">
                                    <itemtemplate>
<asp:Label id="lbl_id_transvase_registro" runat="server" Text='<%# Bind("id_transvase_registro") %>' __designer:wfdid="w27"></asp:Label>
</itemtemplate>
                                </asp:TemplateField>
...
<asp:Label id="lbl_id_coleta" runat="server" Text='<%# Bind("id_coleta") %>' __designer:wfdid="w53"></asp:Label>
                        ...
                        <br />
                            ...
                            Text="Aguardar Próx. Transvase" ToolTip="Aguardar Próximo Transvase  para envio da amostra." ValidationGroup="vg_aguardar" Visible="False" />
                                         </td>
                                </tr>
                            </table>
                ...
                <tr>
                    ...
                    <TD style="HEIGHT: 19px" class="titmodulo" align="left" >
                        Amostras de Coletas de Pré-Romaneios não Enviadas (de Outros Transvases)</td>
                    <TD style="height: 19px; width: 10px;">
                    </td>
                </tr>
...
&nbsp; 
                                    ...
                                    <itemtemplate>
<asp:Label id="lbl_id_situacao_transvase_amostra_oa" runat="server" Text='<%# Bind("id_situacao_transvase_amostra") %>'></asp:Label> 
</itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="id_motivo_descarte_tp_amostra" Visible="False">
                                    <edititemtemplate>
...
<asp:Label id="lbl_id_motivo_descarte_tp_amostra_oa" runat="server" Text='<%# Bind("id_motivo_descarte_tp_amostra") %>'></asp:Label> 
                                ...
                                <asp:TemplateField HeaderText="id_transvase_registro" Visible="False">
                                    <itemtemplate>
<asp:Label id="lbl_id_transvase_registro_oa" runat="server" Text='<%# Bind("id_transvase_registro") %>'></asp:Label>
</itemtemplate>
                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="id_coleta" Visible="False">
                                    <itemtemplate>
