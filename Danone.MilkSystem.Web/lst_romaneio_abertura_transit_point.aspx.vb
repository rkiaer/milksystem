...
Partial Class lst_romaneio_abertura_transit_point
    Inherits Page
    ...
    Protected Sub btn_pesquisa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_pesquisa.Click
        ...
        ViewState.Item("id_transit_point") = txt_id_transit_point.Text.Trim()
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_romaneio_abertura_transit_point.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_romaneio_abertura_transit_point.aspx")
    ...
    Private Sub loadFilters()
        ...
        End If
        If Not (customPage.getFilterValue("romaneiotp", cbo_transit_point.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_transit_point_unidade") = customPage.getFilterValue("romaneiotp", cbo_transit_point.ID)
            cbo_transit_point.SelectedValue = ViewState.Item("id_transit_point_unidade").ToString()
        Else
        ...
        If Not (customPage.getFilterValue("romaneiotp", txt_id_transit_point.ID).Equals(String.Empty)) Then
            hasFilters = True
            ViewState.Item("id_transit_point") = customPage.getFilterValue("romaneiotp", txt_id_transit_point.ID)
    ...
    Private Sub loadData()
        ...
        Try
            ...
            If Not (ViewState.Item("id_estabelecimento").ToString.Equals(String.Empty)) Then
                transitpoint.id_estabelecimento = ViewState.Item("id_estabelecimento").ToString()
            End If
            If Not (ViewState.Item("id_transit_point_unidade").ToString.Equals(String.Empty)) Then
                transitpoint.id_transit_point_unidade = ViewState.Item("id_transit_point_unidade").ToString()
            End If
            transitpoint.ds_placa = ViewState.Item("ds_placa").ToString()
            transitpoint.nm_linha = ViewState.Item("nm_linha").ToString
            transitpoint.dt_ini = ViewState.Item("dt_ini").ToString
            transitpoint.dt_fim = ViewState.Item("dt_fim").ToString

            Dim dstransit As DataSet = transitpoint.getTransitPointAberturaRomaneio()
    ...
    Private Sub saveFilters()
        ...
        Try
            ...
            customPage.setFilter("romaneiotp", txt_id_transit_point.ID, ViewState.Item("id_transit_point").ToString)
            ...
            customPage.setFilter("romaneiotp", cbo_transit_point.ID, ViewState.Item("id_transit_point_unidade").ToString)
            'Fran 29/12/2008 i
    ...
    Protected Sub gridResults_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName.ToString().ToLower()
            Case "selecionar"
                ...
                id_romaneio = abrirRomaneioTransitPoint(Convert.ToInt32(e.CommandArgument.ToString))
                If id_romaneio > 0 Then

                    Response.Redirect("frm_romaneio_mensagem.aspx?id_romaneio=" + id_romaneio.ToString + "&id_transit_point=" + e.CommandArgument.ToString)
    ...
    Private Function abrirRomaneioTransitPoint(ByVal id_transit_point As Int32) As Int32
        If Page.IsValid = True Then

            Try

                Dim transitpoint As New TransitPoint(id_transit_point)
                Dim romaneio As New Romaneio()

                romaneio.id_transit_point = Convert.ToInt32(id_transit_point)
                romaneio.id_modificador = Session("id_login")
                romaneio.id_estabelecimento = transitpoint.id_estabelecimento
                ...
                Return Convert.ToInt32(romaneio.abrirRomaneioTransitPoint())
