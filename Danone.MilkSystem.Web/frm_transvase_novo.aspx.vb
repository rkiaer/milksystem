...
Partial Class frm_transvase_novo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "frm_transvase_novo.aspx")
    ...
    Private Sub updateData()
        If Page.IsValid = True Then
            ...
            Try
                ...
                transvase.id_estabelecimento = Convert.ToInt32(cbo_estabelecimento.SelectedValue)
                transvase.id_linha = cbo_rotas.SelectedValue
                transvase.id_motorista = cbo_motorista.SelectedValue
                transvase.id_transportador = Convert.ToInt32(hf_id_pessoa.Value)
                ...
                For Each row In gridTransitPointCompartimento.Rows
                    If row.Visible = True Then
                        ...
                        If chk.Checked = True Then
                            transvase.ds_placa = txt_placa.Text.ToString
                            transvase.tpc_st_placa_principal.Add("S")
                        Else
                            transvase.tpc_st_placa_principal.Add("N")
                        End If

                        transvase.tpc_id_veiculo.Add(lbl_id_veiculo.Text.ToString)
                        transvase.tpc_id_compartimento.Add(Convert.ToInt32(cbo_compartimento.SelectedValue))

                    End If
                Next

                transvase.id_transvase = transvase.abrirTransvase
                ...
                Dim lmsg As String
                lmsg = "O TRANSVASE foi aberto com sucesso! O número que é a identificação necessária para acompanhamento deste processo é " & transvase.id_transvase.ToString & "."
                Response.Redirect("frm_mensagem.aspx?msg=" + lmsg + "&tela=frm_transvase.aspx?id_transvase=" + transvase.id_transvase.ToString)
    ...
    Protected Sub cbo_estabelecimento_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_estabelecimento.SelectedIndexChanged
        ...
        Else
            cbo_rotas.Items.Clear()
            cbo_rotas.Enabled = False
        End If
    End Sub
