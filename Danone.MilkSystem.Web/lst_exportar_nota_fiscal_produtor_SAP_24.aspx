<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_nota_fiscal_produtor_SAP_24.aspx.vb" Inherits="lst_exportar_nota_fiscal_produtor_SAP_24" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>lst_exportar_nota_fiscal_produtor_SAP_24</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportar Nota Fiscal Produtor SAP - Crédito de ICMS</STRONG></TD>
