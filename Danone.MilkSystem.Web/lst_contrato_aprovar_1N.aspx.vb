...
Partial Class lst_contrato_aprovar_1N
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_contrato_aprovar_1N.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_contrato_aprovar_1N.aspx")
    ...
    Protected Sub lk_aprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_aprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                contrato.updateContratoAprovarSelecionados1Nivel()
                'FRAN 08/12/2020 i incluir log 
                Dim usuariolog As New UsuarioLog
                usuariolog.id_usuario = Session("id_login")
                usuariolog.ds_id_session = Session.SessionID.ToString()
    ...
    Protected Sub lk_reprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_reprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                ...
                contrato.id_estabelecimento = ViewState.Item("id_estabelecimento").ToString
                contrato.id_modificador = Session("id_login")
                contrato.updateContratoNaoAprovarSelecionados1Nivel()
                'FRAN 08/12/2020 i incluir log 
                Dim usuariolog As New UsuarioLog
                usuariolog.id_usuario = Session("id_login")
                usuariolog.ds_id_session = Session.SessionID.ToString()
        ...
        Try
            If Page.IsValid = True Then
                Try
                    ...
                    Dim lAssunto As String = "Aprovação 2.o Nível de Contrato"
                    Dim lCorpo As String = "Existem Contratos aprovados em 1.o Nível pendentes para aprovação 2.o Nível."
                    ...
                    If notificacao.enviaMensagemEmail(18, lAssunto, lCorpo, MailPriority.High) = True Then
