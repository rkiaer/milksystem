...
Partial Class lupa_transit_point_pre_romaneio
    Inherits Page
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        If ViewState.Item("param_id_transit_point") = "0" Then
            Response.Redirect("lupa_transit_point_pre_romaneio.aspx")
        Else
            Response.Redirect("lupa_transit_point_pre_romaneio.aspx?id=" + ViewState.Item("param_id_transit_point").ToString)
        End If
    ...
    Private Sub loadDetails()
        ...
        Try
            ...
            lbl_ds_transit_point_unidade.Text = transitpoint.ds_transit_point_unidade.ToString
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsromaneio As DataSet = romaneio.getPreRomaneioDisponivelTransitPoint
