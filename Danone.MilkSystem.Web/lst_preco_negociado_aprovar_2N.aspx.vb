...
Imports System.Data
Imports System.Math
Partial Class lst_preco_negociado_aprovar_2N
    ...
    Protected Sub btn_limparFiltros_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limparFiltros.Click
        ...
        Response.Redirect("lst_preco_negociado_aprovar_2N.aspx?st_incluirlog=N")

    End Sub

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        customPage = MenuTools.getInitialContext(HttpContext.Current, "lst_preco_negociado_aprovar_2N.aspx")
    ...
    Private Sub loadData()
        ...
        Try
            ...
            Dim dsPrecoNegociado As DataSet = preconegociado.getPrecoNegociado2NByFilters()
    ...
    Protected Sub lk_aprovar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lk_aprovar.Click
        Try
            ...
            If saveCheckBox() = True Then
                preconegociado.id_estabelecimento = ViewState.Item("id_estabelecimento")  ' 15/09/2008
    ...
    Protected Sub ck_header_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            End If
            preconegociado.updatePrecoNegociadoTodos2N()
