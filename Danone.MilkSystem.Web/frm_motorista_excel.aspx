<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_motorista_excel.aspx.vb" Inherits="frm_motorista_excel" %>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <div>
        <asp:GridView ID="gridResults" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                <asp:BoundField DataField="nm_motorista" HeaderText="Nome" />
                <asp:BoundField DataField="cd_cnh" HeaderText="CNH" />
                <asp:BoundField DataField="st_categoria_cnh" HeaderText="Categoria"  />
                <asp:BoundField DataField="dt_validade_cnh" HeaderText="Validade"  />
                <asp:BoundField DataField="nm_situacao" HeaderText="Situa&#231;&#227;o" />
                 <asp:BoundField DataField="ds_treinamento_esalq" HeaderText="Treinamento Esalq"  />
            </Columns>
