<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_central_pedido.aspx.vb" Inherits="lst_central_pedido" %>
		...
		<form id="form1" method="post" runat="server" >
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); width: 98%;"><STRONG>Pedido</STRONG></TD>
					<TD style="width: 1%">&nbsp;</TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD style="HEIGHT: 2px" vAlign="middle" background="img/faixa_filro.gif" align="right" class="faixafiltro1a">
                        <anthem:LinkButton ID="lk_grupo_produtores" runat="server" AutoUpdateAfterCallBack="True"
                            Visible="False">Grupo de Produtores</anthem:LinkButton></TD>
					<TD style="width: 1%;">&nbsp;</TD>
				</TR>
				<TR>
					...
					<TD>
                        ...
                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <PagerStyle BackColor="#2461BF" Font-Names="Verdana" Font-Size="XX-Small"
                                HorizontalAlign="Center" ForeColor="White" Wrap="True" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="id_central_pedido_origem" HeaderText="Pedido Origem" />
                                ...
                                <asp:BoundField HeaderText="Item" DataField="cd_item" SortExpression="cd_item" />
                                <asp:BoundField HeaderText="Descri&#231;&#227;o" DataField="nm_item" SortExpression="nm_item" />
                                <asp:BoundField HeaderText="Qtde" DataField="nr_quantidade" SortExpression="nr_quantidade" Visible="False" />
                                <asp:BoundField HeaderText="Vl Unit." DataField="nr_valor_unitario" SortExpression="nr_valor_unitario" Visible="False" />
                                <asp:BoundField HeaderText="Valor Total" DataField="nr_valor_total" />
                                <asp:TemplateField HeaderText="Entrega" SortExpression="dt_entrega">
                                    <itemtemplate>
<asp:Label id="lbl_entrega" runat="server" __designer:wfdid="w6"></asp:Label> 
</itemtemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Situa&#231;&#227;o" DataField="nm_situacao_pedido" SortExpression="nm_situacao_pedido" />
                                <asp:TemplateField>
                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ToolTip="Editar" ImageUrl="~/img/icone_editar.gif" __designer:wfdid="w12" CommandArgument='<%# Bind("id_central_pedido") %>' CommandName="edit"></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" Visible="False" AutoUpdateAfterCallBack="True" ToolTip="Desativar" ImageUrl="~/img/icone_excluir.gif" UpdateAfterCallBack="True" __designer:wfdid="w59" CommandArgument='<%# Bind("id_central_pedido") %>' CommandName="delete" OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;"></anthem:ImageButton> 
</itemtemplate>
                                    <headerstyle width="3%" />
                                ...
                                <asp:TemplateField HeaderText="id_central_pedido_item" Visible="False">
                                    <itemtemplate>
<asp:Label id="id_central_pedido_item" runat="server" __designer:wfdid="w4" Text='<%# Bind("id_central_pedido_item") %>'></asp:Label> 
</itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="nr_frete" Visible="False">
                                    <itemtemplate>
<asp:Label id="nr_frete" runat="server" __designer:wfdid="w2" Text='<%# Bind("nr_frete") %>'></asp:Label>
</itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="id_grupo" Visible="False">
                                    <itemtemplate>
<asp:Label id="id_grupo" runat="server" __designer:wfdid="w7" Text='<%# Bind("id_grupo_fornecedor") %>'></asp:Label>
</itemtemplate>
                                </asp:TemplateField>
                                            </Columns>
