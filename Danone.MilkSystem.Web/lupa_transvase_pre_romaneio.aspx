<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lupa_transvase_pre_romaneio.aspx.vb" Inherits="lupa_transvase_pre_romaneio" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Seleção de Pré-Romaneios para Transvase</title>
		...
		<form id="Form1" runat="server">
			<table id="Table1"  cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					...
					<td class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><StrONG>Seleção de Pré-Romaneios Disponíveis para Transvase</StrONG></td>
