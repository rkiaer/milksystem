<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_frete_tabela_frete_aprovar_1N.aspx.vb" Inherits="lst_frete_tabela_frete_aprovar_1N" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>Aprovar Tabela de Frete 1o Nível</title>
		...
		<form id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Aprovar Tabela de Frete 1.o Nível</STRONG></TD>
					<TD style="width: 5px">&nbsp;</TD>
				</TR>
				<TR>
					...
					<TD style="HEIGHT: 22px; " vAlign="middle" background="img/faixa_filro.gif" align="right" class="faixafiltro1a">
                        ...
                        &nbsp;<asp:Image ID="Image3" runat="server" ImageUrl="~/img/icone_excluir.gif" /><anthem:LinkButton ID="lk_reprovar" runat="server" AutoUpdateAfterCallBack="True" Enabled="False" ValidationGroup="vg_pesquisar">Reprovar</anthem:LinkButton>&nbsp;&nbsp;&nbsp;
                        &nbsp;<asp:Image id="Image4" runat="server" ImageUrl="~/img/ico_email.gif"></asp:Image><anthem:LinkButton ID="lk_email" runat="server" ValidationGroup="vg_pesquisar" OnClientClick="if (confirm('Uma notificação de que existem contratos aprovados em 1.o Nivel será enviada aos aprovadores para aprovação 2.o Nível. Deseja realmente prosseguir?' )) return true;else return false;" AutoUpdateAfterCallBack="True">Notificar Aprovadores</anthem:LinkButton>&nbsp;&nbsp;&nbsp;</TD>
					<TD style="HEIGHT: 22px; width: 5px;">&nbsp;</TD>
				</TR>
				<TR>
