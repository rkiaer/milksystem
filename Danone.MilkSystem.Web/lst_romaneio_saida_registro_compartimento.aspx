<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_romaneio_saida_registro_compartimento.aspx.vb" Inherits="lst_romaneio_saida_registro_compartimento" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
		<title>lst_romaneio_saida_registro_compartimento</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 25px;"><STRONG> Romaneio Saída - Registro de Compartimentos</STRONG></TD>
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    ...
                                    <cc3:OnlyDateTextBox ID="txt_dt_ini" runat="server" CssClass="texto"
                                        Width="96px"></cc3:OnlyDateTextBox>&nbsp; à &nbsp;<cc3:OnlyDateTextBox ID="txt_dt_fim"
                                            runat="server" CssClass="texto" Width="96px"></cc3:OnlyDateTextBox>
                                </td>
                            </tr>
							<TR>
				...
				<TR>
					<TD style="height: 6px; width: 9px;" class="texto"></TD>
					<TD vAlign="middle" style="height: 6px" class="texto">&nbsp;</TD>
					<TD style="height: 6px" class="texto"></TD>
				</TR>
				...
				<TR>
					...
					<TD align="center" class="texto">
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" AutoUpdateAfterCallBack="True" Width="98%" UpdateAfterCallBack="True" PageSize="7" DataKeyNames="id_romaneio_saida">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    <itemtemplate>
<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="~/img/icone_editar.gif" Text="Button" CommandArgument='<%# bind("id_romaneio_saida") %>' __designer:wfdid="w147" CommandName="selecionar" CausesValidation="False"></asp:ImageButton> 
</itemtemplate>
