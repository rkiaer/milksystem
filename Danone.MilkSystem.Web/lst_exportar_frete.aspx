<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_exportar_frete.aspx.vb" Inherits="lst_exportar_frete" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Exportação Frete</STRONG></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
                                <td align="right" style="height: 22px" >
                                    <strong><span style="color: #ff0000">*</span></strong>Período Fechamento Romaneio:</td>
								...
								<TD style="height: 22px;" align="left" colspan="2">
                                    <anthem:CheckBox ID="chk_romaneios_exportados" runat="server" Text="Incluir Romaneios já exportados" />&nbsp;</TD>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2" style="height: 18px" class="texto" valign="bottom">
                                    <asp:RadioButtonList ID="opt_tipo" runat="server" CssClass="texto" RepeatDirection="Horizontal" Height="17px" Width="224px" >
					...
					<TD vAlign="middle" style="height: 19px">&nbsp;<table id="Table3" border="0" cellpadding="0" cellspacing="0" class="texto" width="100%">
                                                                    ...
                                                                    <table id="Table13" border="0" cellpadding="2" cellspacing="0" class="texto" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" class="texto" style="width: 28%; height: 20px">
                                                                                &nbsp;<anthem:Label ID="lbl_id_exportacao_frete_execucao" runat="server" AutoUpdateAfterCallBack="True"
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" AutoUpdateAfterCallBack="True" Width="100%" UpdateAfterCallBack="True" PageSize="15" Visible="False">
                                ...
                                HorizontalAlign="Center" ForeColor="White" />
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:BoundField DataField="id_exportacao_frete_execucao_itens" HeaderText="Item Exec." />
                                                                                        <asp:BoundField DataField="cd_transportadora" HeaderText="Transportadora" SortExpression="cd_transportadora" />
                                <asp:BoundField DataField="id_romaneio" HeaderText="Romaneio" SortExpression="id_romaneio" ReadOnly="True" >
                                    <itemstyle wrap="False" />
                                </asp:BoundField>
                                                                                        <asp:BoundField DataField="ds_placa_principal" HeaderText="Placa Princ." />
                                <asp:BoundField DataField="ds_placa_frete" HeaderText="Placa Frete" ReadOnly="True"
                                    SortExpression="ds_placa_frete">
                                    <itemstyle wrap="False" />
                                </asp:BoundField>
                                                                                        <asp:BoundField DataField="cd_cooperativa" HeaderText="Coop." SortExpression="cd_cooperativa" />
                                                                                        <asp:BoundField DataField="nr_caderneta" HeaderText="Caderneta" SortExpression="nr_caderneta" />
                                                                                        <asp:BoundField DataField="st_transit_point" HeaderText="Transit" />
                                                                                        <asp:BoundField DataField="st_transbordo" HeaderText="Transb." />
                                                                                        <asp:BoundField HeaderText="Pr&#233;-Rom TP" DataField="st_pre_romaneio_transit_point" />
                                                                                        <asp:BoundField DataField="st_pre_romaneio_transbordo" HeaderText="Pr&#233;-Rom Transb." />
                                                                                        <asp:TemplateField HeaderText="Arq. Download">
                                                                                            <itemtemplate>
<asp:HyperLink id="hl_download" runat="server" Text='<%# bind("nm_arquivo") %>' ToolTip="Clique aqui para download do arquivo" __designer:wfdid="w56"></asp:HyperLink> 
</itemtemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Arq2. Download">
                                                                                            <itemtemplate>
<asp:HyperLink id="hl_download2" runat="server" Text='<%# bind("nm_arquivo2") %>' ToolTip="Clique aqui para download do arquivo" __designer:wfdid="w57"></asp:HyperLink>
</itemtemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:BoundField DataField="st_exportacao_frete_execucao_itens" HeaderText="Status"
                                                                                            SortExpression="st_exportacao_frete_execucao_itens" />
                                                                                    </Columns>
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" AutoUpdateAfterCallBack="True" Width="100%" UpdateAfterCallBack="True" PageSize="7" Visible="False">
                                ...
                                HorizontalAlign="Center" ForeColor="White" />
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="id_exportacao_frete_execucao_erro" HeaderText="id_exportacao_frete_execucao_erro"
                                                                                            Visible="False" />
                                                                                    </Columns>
                                                                                    <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                                                    <RowStyle BackColor="#EFF3FB" />
