<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_tecnico.aspx.vb" Inherits="lst_tecnico" %>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td style="height: 20px">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_cd_tecnico" runat="server" CssClass="caixaTexto" Width="224px" MaxLength="10"></anthem:TextBox></td>
                            </tr>
                            <tr>
                                <td align="right" style="height: 20px" width="20%">
                                    &nbsp;Nome:</td>
                                <td style="height: 20px">
                                    &nbsp;
                                    <anthem:TextBox ID="txt_nm_tecnico" runat="server" CssClass="caixaTexto" Width="224px" MaxLength="60"></anthem:TextBox></td>
                            </tr>
							<TR>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" __designer:wfdid="w16" CommandName="edit" CommandArgument='<%# Bind("id_tecnico") %>'></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" __designer:wfdid="w17" AutoUpdateAfterCallBack="True" CommandName="delete" CommandArgument='<%# Bind("id_tecnico") %>' OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;"></anthem:ImageButton>
</itemtemplate>
