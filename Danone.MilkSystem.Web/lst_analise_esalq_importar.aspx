<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_analise_esalq_importar.aspx.vb" Inherits="lst_analise_esalq_importar" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif); height: 27px;"><STRONG>Importar Análises Externas Propriedade</STRONG></TD>
						...
						<TABLE class="borda" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
                            ...
                            <tr>
								...
								<TD style="height: 20px; " align="right">
                                    <anthem:Label ID="lbl_totalimportadas" runat="server" Text="Total de linhas importadas:" ></anthem:Label></TD>
								<TD style="height: 20px">
							...
							<TR>
								...
								<TD align="right" colspan="2" >&nbsp;&nbsp;<anthem:imagebutton id="btn_importar" runat="server" imageurl="~/img/bnt_importar.gif" ></anthem:imagebutton>
                                    &nbsp;</TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					...
					<TD class="faixafiltro1a" style="HEIGHT: 24px" vAlign="middle" background="img/faixa_filro.gif">
                        ...
                        <anthem:HyperLink ID="hl_imprimir" runat="server" CssClass="texto" NavigateUrl="~/frm_relatorio_analise_esalq.aspx"
                            Target="_blank" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Enabled="False">Relatório Consistências</anthem:HyperLink></TD>
