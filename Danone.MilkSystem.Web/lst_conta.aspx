<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lst_conta.aspx.vb" Inherits="lst_conta" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="faixafiltro1" style="background-image: url(img/tab_dim.gif)"><STRONG>Conta </STRONG>
					</TD>
					<TD width="10">&nbsp;</TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD>
                                        ...
                                        <anthem:GridView ID="gridResults" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="cd_conta" HeaderText="C&#243;digo" SortExpression="cd_conta" >
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nm_conta" HeaderText="Nome" SortExpression="nm_conta" >
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField>
                                                    <itemtemplate>
<anthem:ImageButton id="img_editar" runat="server" ImageUrl="~/img/icone_editar.gif" CommandArgument='<%# Bind("id_conta") %>' CommandName="edit" __designer:wfdid="w5"></anthem:ImageButton> <anthem:ImageButton id="img_delete" runat="server" ImageUrl="~/img/icone_excluir.gif" AutoUpdateAfterCallBack="True" CommandArgument='<%# Bind("id_conta") %>' CommandName="delete" OnClientClick="if (confirm('Deseja realmente desativar o registro?' )) return true;else return false;" __designer:wfdid="w6"></anthem:ImageButton> 
</itemtemplate>
