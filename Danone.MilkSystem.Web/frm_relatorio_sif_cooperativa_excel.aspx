<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_relatorio_sif_cooperativa_excel.aspx.vb" Inherits="frm_relatorio_sif_cooperativa_excel" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title>REPORT SIF - Analítico Cooperativa</title>
</head>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form id="form1" runat="server">
    <div>
        <anthem:GridView ID="gridResultsCoop" runat="server" AutoUpdateAfterCallBack="True"
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
            CellPadding="3" Font-Names="Verdana" Font-Size="XX-Small" PageSize="15" UpdateAfterCallBack="True">
