<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_pre_romaneio_tp_consulta.aspx.vb" Inherits="frm_pre_romaneio_tp_consulta" %>
	    ...
	    <form id="Form1" method="post" runat="server">
		    <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" class="texto" width="100%" >
				<TR>
					...
					<TD class="faixafiltro1" 	style="background-image: url(img/tab_dim.gif);"><STRONG>Consulta do Pré-Romaneio para Transit Point</STRONG></TD>
					<TD>&nbsp;</TD>
				</TR>
				<TR>
					...
					<TD vAlign="top" >
					    <TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0" class="texto">
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" BackColor="White" CssClass="texto" Font-Bold="False" GroupingText="Dados" HorizontalAlign="Center" Width="100%">
                                        <table id="Table3" border="0" cellpadding="1" cellspacing="0" width="99%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="texto" style="width: 19%; height: 20px">
                                                    <strong>Unidade de Transit Point:</strong></td>
                                                <td align="left" style="width: 31%; height: 20px">
                                                    &nbsp;<asp:Label ID="lbl_transit_point_unidade" runat="server" CssClass="texto"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="texto" style="width: 21%; height: 20px">
                            ...
                            <tr  id="tr_pnl_transit_point" runat="server">
                                ...
                                <TD class="texto"  >
                                    <asp:Panel ID="Panel3" runat="server" BackColor="White" CssClass="texto" Font-Bold="False" GroupingText="Transit Points Envolvidos" HorizontalAlign="Center"
                                        Width="100%">
                                                ...
                                                <td align="center" class="texto" >
                                                    <br />
                                                        ...
                                                        <anthem:GridView ID="gridTransitPoint" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundField DataField="id_transit_point" HeaderText="Transit Point" ReadOnly="True">
                                                                ...
                                                                <asp:BoundField DataField="id_romaneio_tp" HeaderText="Romaneio Transit Point" ReadOnly="True">
                                                                    <headerstyle horizontalalign="Center" />
                                                                    <itemstyle horizontalalign="Center" />
                                                                </asp:BoundField>
                                                            </Columns>
