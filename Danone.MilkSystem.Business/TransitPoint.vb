...
<Serializable()> Public Class TransitPoint
    ...
    Private _ds_transit_point_unidade As String
    ...
    'Private _transit_point_compartimento As Transit_Point_Compartimento
    Private _data_inicio As String
    Private _data_fim As String
    Private _id_pre_romaneio_transit_point As Int32 'criada  em ms_romaneio para guardar o pre_romaneio de romaneios criados por rejeicao
    ...
    Public Property nm_transit_point_unidade() As String
        ...
        End Set
    End Property
    Public Property ds_transit_point_unidade() As String
        Get
            Return _ds_transit_point_unidade
        End Get
        Set(ByVal value As String)
            _ds_transit_point_unidade = value
        End Set
    End Property
    ...
    Public Sub New(ByVal id As Int32)
        ...
        Me._id_transit_point = id
        loadTransitPoint()

    End Sub

    Public Function getTransitPointAberturaRomaneio() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointAberturaRomaneio", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointByFilters() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPoint", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointPreRomaneio() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointPreRomaneio", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointSelecionar() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointSelecionar", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPoint() As DataSet
    ...
    End Function
    Public Function getTransitPointCompartimentoProdutores() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointCompartimentoProdutores", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointPreRomaneioAmostrasNaoEnviadas() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointPreRomaneioAmostrasNaoEnviadas", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointPreRomaneioAmostras() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointPreRomaneioAmostras", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointAmostras() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointAmostras", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Public Function getTransitPointAmostrasSemRegistro() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointAmostrasSemRegistro", parameters, "ms_transit_point")
            Return dataSet

        End Using

    End Function
    Private Sub loadTransitPoint()

        Dim dataSet As DataSet = getTransitPoint()
        ParametersEngine.persistObjectValues(dataSet.Tables(0).Rows(0), Me)

    End Sub
    Public Function insertTransitPoint() As Int32

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_insertTransitPoint", parameters, ExecuteType.Insert), Int32)
    ...
    Public Function abrirRomaneio()
        ...
        Try
            ...
            'Inclui romaneio
            Me.id_transit_point = CType(transacao.ExecuteScalar("ms_insertRomaneio", parameters, ExecuteType.Insert), Int32)
        ...
        End Try
    End Function
    Public Function abrirTransitPoint()
        ...
        Try
            ...
            Me.id_transit_point = CType(transacao.ExecuteScalar("ms_insertTransitPoint", parameters, ExecuteType.Insert), Int32)

            parameters = ParametersEngine.getParametersFromObject(Me)
            Dim tpcomp As New TransitPointCompartimento
            Dim tpveiculo As New TransitPointVeiculo
            'Pega os parametros para romaneio_compartimento
            tpveiculo.id_transit_point = Me.id_transit_point
            tpveiculo.id_modificador = Me.id_modificador
            tpcomp.id_transit_point = Me.id_transit_point
            ...
            For i As Integer = 0 To tpc_id_veiculo.Count - 1
                ...
                tpcomp.id_transit_point_veiculo = CType(transacao.ExecuteScalar("ms_insertTransitPointVeiculo", param_veiculo, ExecuteType.Insert), Int32)
                ...
                transacao.Execute("ms_insertTransitPointCompartimento", param_comp, ExecuteType.Insert)
        ...
        End Try
    End Function
    Public Function TransitPointAbrir() As Int32
        ...
        Try
            ...
            For i = 0 To Me.tpc_id_veiculo.Count - 1
                ...
                'Pega os parametros para transit compartimento
                'Dim param_comp As List(Of Parameters) = ParametersEngine.getParametersFromObject(tpcomp)
                'lsaux = CType(transacao.ExecuteScalar("ms_insertTransitPointCompartimento", param_comp, ExecuteType.Insert), Int32)

                tpcomp.insertTransitPointCompartimento()
    ...
    '                Me.id_transit_point_compartimento = dsrow.Item("id_transit_point_compartimento")
    ...
    '    End Try
    'End Sub
    Public Sub updateTransitPoint()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_updateTransitPoint", parameters, ExecuteType.Update)

        End Using

    End Sub
    Public Sub updateTransitPointFechar()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_updateTransitPointFechar", parameters, ExecuteType.Update)

        End Using

    End Sub
    Public Sub updateTransitPointSituacao()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_updateTransitPointSituacao", parameters, ExecuteType.Update)
    ...
    End Function
    Public Function getTransitPointConsVolumeCompartimento() As Integer
        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_getTransitPointConsVolumeCompartimento", parameters, ExecuteType.Select), Integer)

        End Using

    End Function
    Public Function getTransitPointConsPlacas() As Integer
        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_getTransitPointConsPlacas", parameters, ExecuteType.Select), Integer)

        End Using

    End Function
    Public Function getTransitPointConsPlacasPrincipal() As Int64
        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_getTransitPointConsPlacasPrincipal", parameters, ExecuteType.Select), Int64)

        End Using

    End Function
    Public Function getTransitPointConsPlacasTransportador() As Int64
        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_getTransitPointConsPlacasTransportador", parameters, ExecuteType.Select), Int64)
