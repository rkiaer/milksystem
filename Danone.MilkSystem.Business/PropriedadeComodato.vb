...
<Serializable()> Public Class PropriedadeComodato

    Private _id_propriedadecomodato As Int32
    ...
    Private _cd_comodato As String
    ...
    Public Property id_propriedadecomodato() As Int32

        Get
            Return _id_propriedadecomodato
        End Get

        Set(ByVal value As Int32)
            _id_propriedadecomodato = value
        End Set
    End Property
    ...
    Public Sub New(ByVal id As Int32)
        ...
        Me._id_propriedadecomodato = id
        loadPropriedadeComodato()

    End Sub

    Public Function getPropriedadeComodatoByFilters() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getPropriedadeComodato", parameters, "ms_propriedade_comodato")
            Return dataSet
    ...
    Private Sub loadPropriedadeComodato()

        Dim dataSet As DataSet = getPropriedadeComodatoByFilters()
        ParametersEngine.persistObjectValues(dataSet.Tables(0).Rows(0), Me)

    End Sub


    Public Function insertPropriedadeComodato() As Int32

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_insertPropriedadeComodato", parameters, ExecuteType.Insert), Int32)
    ...
    Public Sub updatePropriedadeComodato()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_updatePropriedadeComodato", parameters, ExecuteType.Update)

        End Using

    End Sub

    Public Sub deletePropriedadeComodato()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_deletePropriedadeComodato", parameters, ExecuteType.Delete)
