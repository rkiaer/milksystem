...
<Serializable()> Public Class TransitPointUProducao

    Private _id_transit_point_up As Int32
    ...
    Public Property id_transit_point_up() As Int32
        Get
            Return _id_transit_point_up
        End Get
        Set(ByVal value As Int32)
            _id_transit_point_up = value
        End Set
    End Property
    ...
    Public Sub New(ByVal id As Int32)
        ...
        Me.id_transit_point_up = id
        loadTransitPointUP()

    End Sub
    Public Function getTransitPointUPByFilters() As DataSet
        ...
        Using data As New DataAccess
            ...
            data.Fill(dataSet, "ms_getTransitPointUP", parameters, "ms_transit_point_up")
            Return dataSet
    ...
    Private Sub loadTransitPointUP()

        Dim dataSet As DataSet = getTransitPointUPByFilters()
        ParametersEngine.persistObjectValues(dataSet.Tables(0).Rows(0), Me)

    End Sub

    Public Sub updateTransitPointUP()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_updateTransitPointUP", parameters, ExecuteType.Update)

        End Using

    End Sub
    Public Sub updateTransitPointPreRomaneioVolumeRetirar()
        Try
            Using data As New DataAccess

                Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
                data.Execute("ms_updateTransitPointPreRomaneioVolumeRetirar", parameters, ExecuteType.Update)
    ...
    End Sub
    Public Sub updateTransitPointPreRomaneioVolumeAdicionar()
        Try
            Using data As New DataAccess

                Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
                data.Execute("ms_updateTransitPointPreRomaneioVolumeAdicionar", parameters, ExecuteType.Update)
    ...
    End Sub
    Public Function getTransitPointUPSomaVolume() As Integer

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_getTransitPointUPSomaVolume", parameters, ExecuteType.Select), Integer)

        End Using
    End Function
    Public Function insertTransitPointUP() As Int32

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_insertTransitPointUP", parameters, ExecuteType.Insert), Int32)
