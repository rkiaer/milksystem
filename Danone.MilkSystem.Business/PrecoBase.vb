...
<Serializable()> Public Class PrecoBase
    ...
    Public Function getPrecoBaseByFilters() As DataSet
    ...
    Private Sub loadPrecoBase()
        Dim dataSet As DataSet = getPrecoBaseByFilters()
