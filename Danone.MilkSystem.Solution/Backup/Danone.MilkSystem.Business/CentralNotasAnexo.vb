...
<Serializable()> Public Class CentralNotasAnexo
    Private _id_central_notas_importacao_anexo As Int32
    ...
    Public Property id_central_notas_importacao_anexo() As Int32
        Get
            Return _id_central_notas_importacao_anexo
        End Get
        Set(ByVal value As Int32)
            _id_central_notas_importacao_anexo = value
        End Set
    End Property
    ...
    Public Sub New(ByVal id As Int32)
        Me.id_central_notas_importacao_anexo = id
        loadCentralNotasAnexo()
    End Sub
    ...
    Public Function getCentroNotasImportacaoAnexo() As DataSet

        Using data As New DataAccess
            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)

            Dim dataSet As New DataSet
            data.Fill(dataSet, "ms_getCentralNotasImportacaoAnexo", parameters, "ms_central_notas_importacao_anexo")
            Return dataSet

        End Using

    End Function
    Private Sub loadCentralNotasAnexo()

        Dim dataSet As DataSet = getCentroNotasImportacaoAnexo()
        ParametersEngine.persistObjectValues(dataSet.Tables(0).Rows(0), Me)

    End Sub


    Public Sub deleteCentralNotasAnexo()

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            data.Execute("ms_deleteCentralNotasAnexo", parameters, ExecuteType.Delete)

        End Using


    End Sub
    Public Function insertCentralNotasAnexo() As Int32

        Using data As New DataAccess

            Dim parameters As List(Of Parameters) = ParametersEngine.getParametersFromObject(Me)
            Return CType(data.ExecuteScalar("ms_insertCentralNotasAnexo", parameters, ExecuteType.Insert), Int32)
